...
.PARAMETER Total
Total Number of Application sets.
.OUTPUTS

PrimeraApplicationSetsList<PSCustomObject>
#>

function Initialize-PrimeraApplicationSetsList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PrimeraApplicationSetsList' | Write-Debug
...
Convert from JSON to PrimeraApplicationSetsList<PSCustomObject>
...
PrimeraApplicationSetsList<PSCustomObject>
#>
function ConvertFrom-JsonToPrimeraApplicationSetsList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PrimeraApplicationSetsList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PrimeraApplicationSetsList
