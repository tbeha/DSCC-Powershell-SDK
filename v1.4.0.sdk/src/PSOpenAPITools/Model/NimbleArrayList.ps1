...
NimbleArrayList<PSCustomObject>
#>

function Initialize-NimbleArrayList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => NimbleArrayList' | Write-Debug
...
Convert from JSON to NimbleArrayList<PSCustomObject>
...
NimbleArrayList<PSCustomObject>
#>
function ConvertFrom-JsonToNimbleArrayList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => NimbleArrayList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NimbleArrayList
