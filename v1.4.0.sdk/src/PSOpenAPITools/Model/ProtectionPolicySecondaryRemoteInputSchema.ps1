...
ProtectionPolicySecondaryRemoteInputSchema<PSCustomObject>
#>

function Initialize-ProtectionPolicySecondaryRemoteInputSchema {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ProtectionPolicySecondaryRemoteInputSchema' | Write-Debug
...
Convert from JSON to ProtectionPolicySecondaryRemoteInputSchema<PSCustomObject>
...
ProtectionPolicySecondaryRemoteInputSchema<PSCustomObject>
#>
function ConvertFrom-JsonToProtectionPolicySecondaryRemoteInputSchema {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ProtectionPolicySecondaryRemoteInputSchema' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ProtectionPolicySecondaryRemoteInputSchema
