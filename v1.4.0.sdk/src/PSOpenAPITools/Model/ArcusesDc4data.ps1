...
ArcusesDc4data<PSCustomObject>
#>

function Initialize-ArcusesDc4data {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ArcusesDc4data' | Write-Debug
...
Convert from JSON to ArcusesDc4data<PSCustomObject>
...
ArcusesDc4data<PSCustomObject>
#>
function ConvertFrom-JsonToArcusesDc4data {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ArcusesDc4data' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ArcusesDc4data
