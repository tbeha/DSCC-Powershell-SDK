...
ArcusVolumesList<PSCustomObject>
#>

function Initialize-ArcusVolumesList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ArcusVolumesList' | Write-Debug
...
Convert from JSON to ArcusVolumesList<PSCustomObject>
...
ArcusVolumesList<PSCustomObject>
#>
function ConvertFrom-JsonToArcusVolumesList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ArcusVolumesList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ArcusVolumesList
