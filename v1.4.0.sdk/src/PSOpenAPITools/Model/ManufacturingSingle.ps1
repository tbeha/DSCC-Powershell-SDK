...
ManufacturingSingle<PSCustomObject>
#>

function Initialize-ManufacturingSingle {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ManufacturingSingle' | Write-Debug
...
Convert from JSON to ManufacturingSingle<PSCustomObject>
...
ManufacturingSingle<PSCustomObject>
#>
function ConvertFrom-JsonToManufacturingSingle {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ManufacturingSingle' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ManufacturingSingle
