...
ArcusInventoryHistory<PSCustomObject>
#>

function Initialize-ArcusInventoryHistory {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ArcusInventoryHistory' | Write-Debug
...
Convert from JSON to ArcusInventoryHistory<PSCustomObject>
...
ArcusInventoryHistory<PSCustomObject>
#>
function ConvertFrom-JsonToArcusInventoryHistory {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ArcusInventoryHistory' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ArcusInventoryHistory
