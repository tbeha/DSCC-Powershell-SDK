...
EnclosurePowersSummaryList<PSCustomObject>
#>

function Initialize-EnclosurePowersSummaryList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => EnclosurePowersSummaryList' | Write-Debug
...
Convert from JSON to EnclosurePowersSummaryList<PSCustomObject>
...
EnclosurePowersSummaryList<PSCustomObject>
#>
function ConvertFrom-JsonToEnclosurePowersSummaryList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => EnclosurePowersSummaryList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in EnclosurePowersSummaryList
