...
PrimeraReplicationPartner<PSCustomObject>
#>

function Initialize-PrimeraReplicationPartner {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PrimeraReplicationPartner' | Write-Debug
...
Convert from JSON to PrimeraReplicationPartner<PSCustomObject>
...
PrimeraReplicationPartner<PSCustomObject>
#>
function ConvertFrom-JsonToPrimeraReplicationPartner {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PrimeraReplicationPartner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PrimeraReplicationPartner
