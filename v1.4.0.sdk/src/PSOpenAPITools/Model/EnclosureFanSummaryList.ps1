...
EnclosureFanSummaryList<PSCustomObject>
#>

function Initialize-EnclosureFanSummaryList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => EnclosureFanSummaryList' | Write-Debug
...
Convert from JSON to EnclosureFanSummaryList<PSCustomObject>
...
EnclosureFanSummaryList<PSCustomObject>
#>
function ConvertFrom-JsonToEnclosureFanSummaryList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => EnclosureFanSummaryList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in EnclosureFanSummaryList
