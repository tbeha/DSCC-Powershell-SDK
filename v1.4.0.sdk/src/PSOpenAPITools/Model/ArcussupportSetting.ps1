...
ArcussupportSetting<PSCustomObject>
#>

function Initialize-ArcussupportSetting {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ArcussupportSetting' | Write-Debug
...
Convert from JSON to ArcussupportSetting<PSCustomObject>
...
ArcussupportSetting<PSCustomObject>
#>
function ConvertFrom-JsonToArcussupportSetting {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ArcussupportSetting' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ArcussupportSetting
        $AllProperties = ("associatedLinks", "connectToHPE", "consoleUri", "customerId", "emailNotifications", "enterpriseServerURL", "generation", "id", "miniInsploreEnabled", "remoteAccess", "requestUri", "resourceUri", "type")
