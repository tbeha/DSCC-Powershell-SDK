...
ArcusmetricHistoryDataSingleValue<PSCustomObject>
#>

function Initialize-ArcusmetricHistoryDataSingleValue {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ArcusmetricHistoryDataSingleValue' | Write-Debug
...
Convert from JSON to ArcusmetricHistoryDataSingleValue<PSCustomObject>
...
ArcusmetricHistoryDataSingleValue<PSCustomObject>
#>
function ConvertFrom-JsonToArcusmetricHistoryDataSingleValue {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ArcusmetricHistoryDataSingleValue' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ArcusmetricHistoryDataSingleValue
