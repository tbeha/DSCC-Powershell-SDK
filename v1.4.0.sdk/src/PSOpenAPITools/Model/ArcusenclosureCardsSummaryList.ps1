...
ArcusenclosureCardsSummaryList<PSCustomObject>
#>

function Initialize-ArcusenclosureCardsSummaryList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ArcusenclosureCardsSummaryList' | Write-Debug
...
Convert from JSON to ArcusenclosureCardsSummaryList<PSCustomObject>
...
ArcusenclosureCardsSummaryList<PSCustomObject>
#>
function ConvertFrom-JsonToArcusenclosureCardsSummaryList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ArcusenclosureCardsSummaryList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ArcusenclosureCardsSummaryList
