...
ArcusvolumePerformanceHistory<PSCustomObject>
#>

function Initialize-ArcusvolumePerformanceHistory {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ArcusvolumePerformanceHistory' | Write-Debug
...
Convert from JSON to ArcusvolumePerformanceHistory<PSCustomObject>
...
ArcusvolumePerformanceHistory<PSCustomObject>
#>
function ConvertFrom-JsonToArcusvolumePerformanceHistory {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ArcusvolumePerformanceHistory' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ArcusvolumePerformanceHistory
