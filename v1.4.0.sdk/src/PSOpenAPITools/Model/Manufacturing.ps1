...
Manufacturing<PSCustomObject>
#>

function Initialize-Manufacturing {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => Manufacturing' | Write-Debug
...
Convert from JSON to Manufacturing<PSCustomObject>
...
Manufacturing<PSCustomObject>
#>
function ConvertFrom-JsonToManufacturing {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => Manufacturing' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Manufacturing
