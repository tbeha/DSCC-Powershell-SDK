...
function Initialize-TaskList {
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => TaskList' | Write-Debug
...
Convert from JSON to TaskList<PSCustomObject>
...
function ConvertFrom-JsonToTaskList {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => TaskList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
