...
ArcusReplicationPartnerDetails<PSCustomObject>
#>

function Initialize-ArcusReplicationPartnerDetails {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ArcusReplicationPartnerDetails' | Write-Debug
...
Convert from JSON to ArcusReplicationPartnerDetails<PSCustomObject>
...
ArcusReplicationPartnerDetails<PSCustomObject>
#>
function ConvertFrom-JsonToArcusReplicationPartnerDetails {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ArcusReplicationPartnerDetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ArcusReplicationPartnerDetails
