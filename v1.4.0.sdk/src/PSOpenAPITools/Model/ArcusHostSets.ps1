...
ArcusHostSets<PSCustomObject>
#>

function Initialize-ArcusHostSets {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ArcusHostSets' | Write-Debug
...
Convert from JSON to ArcusHostSets<PSCustomObject>
...
ArcusHostSets<PSCustomObject>
#>
function ConvertFrom-JsonToArcusHostSets {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ArcusHostSets' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ArcusHostSets
