...
PrimeraHostList<PSCustomObject>
#>

function Initialize-PrimeraHostList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PrimeraHostList' | Write-Debug
...
Convert from JSON to PrimeraHostList<PSCustomObject>
...
PrimeraHostList<PSCustomObject>
#>
function ConvertFrom-JsonToPrimeraHostList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PrimeraHostList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PrimeraHostList
