...
SnmpConfigParams<PSCustomObject>
#>

function Initialize-SnmpConfigParams {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => SnmpConfigParams' | Write-Debug
...
Convert from JSON to SnmpConfigParams<PSCustomObject>
...
SnmpConfigParams<PSCustomObject>
#>
function ConvertFrom-JsonToSnmpConfigParams {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => SnmpConfigParams' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in SnmpConfigParams
