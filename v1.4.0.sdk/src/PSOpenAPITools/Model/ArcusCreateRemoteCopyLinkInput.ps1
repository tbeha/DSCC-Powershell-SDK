...
ArcusCreateRemoteCopyLinkInput<PSCustomObject>
#>

function Initialize-ArcusCreateRemoteCopyLinkInput {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ArcusCreateRemoteCopyLinkInput' | Write-Debug
...
Convert from JSON to ArcusCreateRemoteCopyLinkInput<PSCustomObject>
...
ArcusCreateRemoteCopyLinkInput<PSCustomObject>
#>
function ConvertFrom-JsonToArcusCreateRemoteCopyLinkInput {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ArcusCreateRemoteCopyLinkInput' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ArcusCreateRemoteCopyLinkInput
