...
PrimeraRemoteInfo<PSCustomObject>
#>

function Initialize-PrimeraRemoteInfo {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PrimeraRemoteInfo' | Write-Debug
...
Convert from JSON to PrimeraRemoteInfo<PSCustomObject>
...
PrimeraRemoteInfo<PSCustomObject>
#>
function ConvertFrom-JsonToPrimeraRemoteInfo {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PrimeraRemoteInfo' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PrimeraRemoteInfo
