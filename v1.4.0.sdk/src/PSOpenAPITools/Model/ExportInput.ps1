...
ExportInput<PSCustomObject>
#>

function Initialize-ExportInput {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ExportInput' | Write-Debug
...
Convert from JSON to ExportInput<PSCustomObject>
...
ExportInput<PSCustomObject>
#>
function ConvertFrom-JsonToExportInput {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ExportInput' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ExportInput
