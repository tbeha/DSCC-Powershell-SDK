...
ArcusvCenterSettingsInput<PSCustomObject>
#>

function Initialize-ArcusvCenterSettingsInput {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ArcusvCenterSettingsInput' | Write-Debug
...
Convert from JSON to ArcusvCenterSettingsInput<PSCustomObject>
...
ArcusvCenterSettingsInput<PSCustomObject>
#>
function ConvertFrom-JsonToArcusvCenterSettingsInput {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ArcusvCenterSettingsInput' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ArcusvCenterSettingsInput
