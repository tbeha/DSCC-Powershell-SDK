...
DiskCapacity<PSCustomObject>
#>

function Initialize-DiskCapacity {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => DiskCapacity' | Write-Debug
...
Convert from JSON to DiskCapacity<PSCustomObject>
...
DiskCapacity<PSCustomObject>
#>
function ConvertFrom-JsonToDiskCapacity {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => DiskCapacity' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in DiskCapacity
