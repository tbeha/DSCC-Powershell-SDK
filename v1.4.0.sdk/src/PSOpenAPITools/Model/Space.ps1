...
function Initialize-Space {
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => Space' | Write-Debug
...
Space<PSCustomObject>
#>
function ConvertFrom-JsonToSpace {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => Space' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Space
