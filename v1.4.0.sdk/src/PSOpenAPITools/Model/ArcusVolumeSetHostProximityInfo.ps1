...
ArcusVolumeSetHostProximityInfo<PSCustomObject>
#>

function Initialize-ArcusVolumeSetHostProximityInfo {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ArcusVolumeSetHostProximityInfo' | Write-Debug
...
Convert from JSON to ArcusVolumeSetHostProximityInfo<PSCustomObject>
...
ArcusVolumeSetHostProximityInfo<PSCustomObject>
#>
function ConvertFrom-JsonToArcusVolumeSetHostProximityInfo {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ArcusVolumeSetHostProximityInfo' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ArcusVolumeSetHostProximityInfo
