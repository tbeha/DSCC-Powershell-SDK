...
NimblePoolDetails<PSCustomObject>
#>

function Initialize-NimblePoolDetails {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => NimblePoolDetails' | Write-Debug
...
Convert from JSON to NimblePoolDetails<PSCustomObject>
...
NimblePoolDetails<PSCustomObject>
#>
function ConvertFrom-JsonToNimblePoolDetails {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => NimblePoolDetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NimblePoolDetails
        $AllProperties = ("all_flash", "array_count", "array_list", "associated_links", "cache_capacity", "capacity", "clone_ratio", "compression_ratio", "consoleUri", "creation_time", "customerId", "data_reduction_ratio", "dedupe_all_volumes", "dedupe_capable", "dedupe_capacity_bytes", "dedupe_ratio", "dedupe_usage_bytes", "description", "folder_list", "free_space", "full_name", "generation", "is_default", "last_modified", "pinnable_cache_capacity", "pinned_cache_capacity", "pinned_vol_list", "resourceUri", "savings", "savings_clone", "savings_compression", "savings_data_reduction", "savings_dedupe", "savings_ratio", "savings_vol_thin_provisioning", "search_name", "snap_count", "snapcoll_count", "type", "unassigned_array_list", "unused_reserve", "usage", "usage_valid", "vol_count", "vol_list", "vol_thin_provisioning_ratio")
