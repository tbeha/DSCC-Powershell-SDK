...
ReplicationPartnerCommonFields<PSCustomObject>
#>

function Initialize-ReplicationPartnerCommonFields {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ReplicationPartnerCommonFields' | Write-Debug
...
Convert from JSON to ReplicationPartnerCommonFields<PSCustomObject>
...
ReplicationPartnerCommonFields<PSCustomObject>
#>
function ConvertFrom-JsonToReplicationPartnerCommonFields {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ReplicationPartnerCommonFields' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ReplicationPartnerCommonFields
