...
NimbleArrayDetailsWithRequestUri<PSCustomObject>
#>

function Initialize-NimbleArrayDetailsWithRequestUri {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => NimbleArrayDetailsWithRequestUri' | Write-Debug
...
Convert from JSON to NimbleArrayDetailsWithRequestUri<PSCustomObject>
...
NimbleArrayDetailsWithRequestUri<PSCustomObject>
#>
function ConvertFrom-JsonToNimbleArrayDetailsWithRequestUri {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
