...
Host Update or Delete progress status. Possible status are: Update_In_Progress,Update_Success,Update_Failed,Delete_In_Progress,Delete_Failed,Not_Applicable.
.PARAMETER Fqdn
...
function ConvertFrom-JsonToHostDetails {
    ...
    Process {
        ...
        $AllProperties = ("associatedLinks", "associatedSystems", "comment", "consoleUri", "contact", "customerId", "editStatus", "fqdn", "generation", "hostGroups", "id", "initiators", "ipAddress", "location", "markedForDelete", "model", "name", "operatingSystem", "persona", "protocol", "requestUri", "subnet", "systems", "type", "userCreated")
