...
TasksNotFound<PSCustomObject>
#>

function Initialize-TasksNotFound {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => TasksNotFound' | Write-Debug
...
Convert from JSON to TasksNotFound<PSCustomObject>
...
TasksNotFound<PSCustomObject>
#>
function ConvertFrom-JsonToTasksNotFound {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => TasksNotFound' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in TasksNotFound
