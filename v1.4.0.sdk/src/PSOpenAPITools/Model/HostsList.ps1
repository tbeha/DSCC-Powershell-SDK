...
HostsList<PSCustomObject>
#>

function Initialize-HostsList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => HostsList' | Write-Debug
...
Convert from JSON to HostsList<PSCustomObject>
...
HostsList<PSCustomObject>
#>
function ConvertFrom-JsonToHostsList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => HostsList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in HostsList
