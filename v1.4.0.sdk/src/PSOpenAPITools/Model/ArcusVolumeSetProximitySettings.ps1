...
ArcusVolumeSetProximitySettings<PSCustomObject>
#>

function Initialize-ArcusVolumeSetProximitySettings {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ArcusVolumeSetProximitySettings' | Write-Debug
...
Convert from JSON to ArcusVolumeSetProximitySettings<PSCustomObject>
...
ArcusVolumeSetProximitySettings<PSCustomObject>
#>
function ConvertFrom-JsonToArcusVolumeSetProximitySettings {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ArcusVolumeSetProximitySettings' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ArcusVolumeSetProximitySettings
