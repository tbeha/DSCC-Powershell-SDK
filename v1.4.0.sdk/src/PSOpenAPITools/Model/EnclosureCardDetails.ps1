...
EnclosureCardDetails<PSCustomObject>
#>

function Initialize-EnclosureCardDetails {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => EnclosureCardDetails' | Write-Debug
...
Convert from JSON to EnclosureCardDetails<PSCustomObject>
...
EnclosureCardDetails<PSCustomObject>
#>
function ConvertFrom-JsonToEnclosureCardDetails {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => EnclosureCardDetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in EnclosureCardDetails
        $AllProperties = ("associatedLinks", "consoleUri", "customerId", "dc4data", "dcsdata", "displayname", "domain", "elementStatusCode", "enclosureCardId", "enclosureDeviceId", "enclosureId", "enclosureName", "enclosureType", "failIndicator", "generation", "id", "locateEnabled", "loopA", "loopB", "manufacturing", "name", "requestUri", "resourceUri", "safeToRemove", "systemId", "type")
