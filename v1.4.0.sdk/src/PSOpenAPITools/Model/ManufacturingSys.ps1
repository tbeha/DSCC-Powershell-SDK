...
ManufacturingSys<PSCustomObject>
#>

function Initialize-ManufacturingSys {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ManufacturingSys' | Write-Debug
...
Convert from JSON to ManufacturingSys<PSCustomObject>
...
ManufacturingSys<PSCustomObject>
#>
function ConvertFrom-JsonToManufacturingSys {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ManufacturingSys' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ManufacturingSys
