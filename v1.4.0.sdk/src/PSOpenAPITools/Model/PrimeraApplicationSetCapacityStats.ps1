...
PrimeraApplicationSetCapacityStats<PSCustomObject>
#>

function Initialize-PrimeraApplicationSetCapacityStats {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PrimeraApplicationSetCapacityStats' | Write-Debug
...
Convert from JSON to PrimeraApplicationSetCapacityStats<PSCustomObject>
...
PrimeraApplicationSetCapacityStats<PSCustomObject>
#>
function ConvertFrom-JsonToPrimeraApplicationSetCapacityStats {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PrimeraApplicationSetCapacityStats' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PrimeraApplicationSetCapacityStats
