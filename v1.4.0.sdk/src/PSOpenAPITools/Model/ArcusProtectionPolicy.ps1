...
ArcusProtectionPolicy<PSCustomObject>
#>

function Initialize-ArcusProtectionPolicy {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ArcusProtectionPolicy' | Write-Debug
...
Convert from JSON to ArcusProtectionPolicy<PSCustomObject>
...
ArcusProtectionPolicy<PSCustomObject>
#>
function ConvertFrom-JsonToArcusProtectionPolicy {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ArcusProtectionPolicy' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ArcusProtectionPolicy
