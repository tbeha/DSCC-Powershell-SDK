...
ArcusHostList<PSCustomObject>
#>

function Initialize-ArcusHostList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ArcusHostList' | Write-Debug
...
Convert from JSON to ArcusHostList<PSCustomObject>
...
ArcusHostList<PSCustomObject>
#>
function ConvertFrom-JsonToArcusHostList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ArcusHostList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ArcusHostList
