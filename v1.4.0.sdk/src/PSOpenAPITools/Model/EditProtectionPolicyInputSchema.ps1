...
EditProtectionPolicyInputSchema<PSCustomObject>
#>

function Initialize-EditProtectionPolicyInputSchema {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => EditProtectionPolicyInputSchema' | Write-Debug
...
Convert from JSON to EditProtectionPolicyInputSchema<PSCustomObject>
...
EditProtectionPolicyInputSchema<PSCustomObject>
#>
function ConvertFrom-JsonToEditProtectionPolicyInputSchema {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => EditProtectionPolicyInputSchema' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in EditProtectionPolicyInputSchema
