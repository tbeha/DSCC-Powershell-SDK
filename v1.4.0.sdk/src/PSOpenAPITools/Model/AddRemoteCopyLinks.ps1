...
AddRemoteCopyLinks<PSCustomObject>
#>

function Initialize-AddRemoteCopyLinks {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => AddRemoteCopyLinks' | Write-Debug
...
Convert from JSON to AddRemoteCopyLinks<PSCustomObject>
...
AddRemoteCopyLinks<PSCustomObject>
#>
function ConvertFrom-JsonToAddRemoteCopyLinks {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => AddRemoteCopyLinks' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in AddRemoteCopyLinks
