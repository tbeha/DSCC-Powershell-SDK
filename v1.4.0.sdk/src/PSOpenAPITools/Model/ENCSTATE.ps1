...
ENCSTATE<PSCustomObject>
#>

function Initialize-ENCSTATE {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ENCSTATE' | Write-Debug
...
Convert from JSON to ENCSTATE<PSCustomObject>
...
ENCSTATE<PSCustomObject>
#>
function ConvertFrom-JsonToENCSTATE {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ENCSTATE' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ENCSTATE
