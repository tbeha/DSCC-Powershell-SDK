...
WitnessCommon<PSCustomObject>
#>

function Initialize-WitnessCommon {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => WitnessCommon' | Write-Debug
...
Convert from JSON to WitnessCommon<PSCustomObject>
...
WitnessCommon<PSCustomObject>
#>
function ConvertFrom-JsonToWitnessCommon {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => WitnessCommon' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in WitnessCommon
