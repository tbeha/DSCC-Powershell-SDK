...
VlunsListSingle<PSCustomObject>
#>

function Initialize-VlunsListSingle {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => VlunsListSingle' | Write-Debug
...
Convert from JSON to VlunsListSingle<PSCustomObject>
...
VlunsListSingle<PSCustomObject>
#>
function ConvertFrom-JsonToVlunsListSingle {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => VlunsListSingle' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in VlunsListSingle
