...
VolumePerformanceHistory<PSCustomObject>
#>

function Initialize-VolumePerformanceHistory {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => VolumePerformanceHistory' | Write-Debug
...
Convert from JSON to VolumePerformanceHistory<PSCustomObject>
...
VolumePerformanceHistory<PSCustomObject>
#>
function ConvertFrom-JsonToVolumePerformanceHistory {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => VolumePerformanceHistory' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in VolumePerformanceHistory
