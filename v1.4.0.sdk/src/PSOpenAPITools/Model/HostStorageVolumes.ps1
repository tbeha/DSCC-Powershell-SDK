...
requestUri for detailed object
.PARAMETER Total
Number of volume count for the host.
.OUTPUTS

HostStorageVolumes<PSCustomObject>
#>

function Initialize-HostStorageVolumes {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => HostStorageVolumes' | Write-Debug
...
Convert from JSON to HostStorageVolumes<PSCustomObject>
...
HostStorageVolumes<PSCustomObject>
#>
function ConvertFrom-JsonToHostStorageVolumes {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => HostStorageVolumes' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in HostStorageVolumes
