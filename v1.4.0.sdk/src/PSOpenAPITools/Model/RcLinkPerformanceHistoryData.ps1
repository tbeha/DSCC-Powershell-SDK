...
RcLinkPerformanceHistoryData<PSCustomObject>
#>

function Initialize-RcLinkPerformanceHistoryData {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => RcLinkPerformanceHistoryData' | Write-Debug
...
Convert from JSON to RcLinkPerformanceHistoryData<PSCustomObject>
...
RcLinkPerformanceHistoryData<PSCustomObject>
#>
function ConvertFrom-JsonToRcLinkPerformanceHistoryData {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => RcLinkPerformanceHistoryData' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in RcLinkPerformanceHistoryData
