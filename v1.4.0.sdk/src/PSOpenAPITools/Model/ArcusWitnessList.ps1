...
Request URI for quorum witness objects
.PARAMETER Total
Total number of witnesses.
.OUTPUTS

ArcusWitnessList<PSCustomObject>
#>

function Initialize-ArcusWitnessList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ArcusWitnessList' | Write-Debug
...
Convert from JSON to ArcusWitnessList<PSCustomObject>
...
ArcusWitnessList<PSCustomObject>
#>
function ConvertFrom-JsonToArcusWitnessList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ArcusWitnessList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ArcusWitnessList
