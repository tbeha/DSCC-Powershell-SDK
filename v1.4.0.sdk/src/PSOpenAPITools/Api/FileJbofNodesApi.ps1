...
#>
function Invoke-DeviceType6GetJBOFNodes {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: Invoke-DeviceType6GetJBOFNodes' | Write-Debug
        ...
        $LocalVarUri = '/api/v1/storage-systems/device-type6/{systemUuid}/jbof-nodes'
        if (!$SystemUuid) {
            throw "Error! The required parameter `SystemUuid` missing when calling deviceType6GetJBOFNodes."
        }
        ...
        $LocalVarResult = Invoke-ApiClient -Method 'GET' `
                                ...
                                -ReturnType "DeviceType6GetJBOFNodes200Response" `
...
.PARAMETER JbofNodeUuid
Unique identifier for fileserver jbof-nodes
...
#>
function Invoke-DeviceType6GetJbofNodesByID {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Invoke-DeviceType6GetJbofNodesByID' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/api/v1/storage-systems/device-type6/{systemUuid}/jbof-nodes/{jbofNodeUuid}'
        if (!$SystemUuid) {
            throw "Error! The required parameter `SystemUuid` missing when calling deviceType6GetJbofNodesByID."
        }
        $LocalVarUri = $LocalVarUri.replace('{systemUuid}', [System.Web.HTTPUtility]::UrlEncode($SystemUuid))
        if (!$JbofNodeUuid) {
            throw "Error! The required parameter `JbofNodeUuid` missing when calling deviceType6GetJbofNodesByID."
        }
        $LocalVarUri = $LocalVarUri.replace('{jbofNodeUuid}', [System.Web.HTTPUtility]::UrlEncode($JbofNodeUuid))
        ...
        $LocalVarResult = Invoke-ApiClient -Method 'GET' `
                                ...
                                -FormParameters $LocalVarFormParameters `
                                -CookieParameters $LocalVarCookieParameters `
                                -ReturnType "GetJBOFNodesResponse" `
                                -IsBodyNullable $false
