...
#>
function Invoke-DeviceType6GetDrives {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: Invoke-DeviceType6GetDrives' | Write-Debug
        ...
        $LocalVarUri = '/api/v1/storage-systems/device-type6/{systemUuid}/drives'
        if (!$SystemUuid) {
            throw "Error! The required parameter `SystemUuid` missing when calling deviceType6GetDrives."
        }
        ...
        $LocalVarResult = Invoke-ApiClient -Method 'GET' `
                                ...
                                -ReturnType "DeviceType6GetDrives200Response" `
