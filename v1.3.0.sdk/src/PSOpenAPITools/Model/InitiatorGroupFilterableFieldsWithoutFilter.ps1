...
InitiatorGroupFilterableFieldsWithoutFilter<PSCustomObject>
#>

function Initialize-InitiatorGroupFilterableFieldsWithoutFilter {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => InitiatorGroupFilterableFieldsWithoutFilter' | Write-Debug
...
Convert from JSON to InitiatorGroupFilterableFieldsWithoutFilter<PSCustomObject>
...
InitiatorGroupFilterableFieldsWithoutFilter<PSCustomObject>
#>
function ConvertFrom-JsonToInitiatorGroupFilterableFieldsWithoutFilter {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => InitiatorGroupFilterableFieldsWithoutFilter' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in InitiatorGroupFilterableFieldsWithoutFilter
