...
NodePerfStats<PSCustomObject>
#>

function Initialize-NodePerfStats {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => NodePerfStats' | Write-Debug
...
Convert from JSON to NodePerfStats<PSCustomObject>
...
NodePerfStats<PSCustomObject>
#>
function ConvertFrom-JsonToNodePerfStats {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => NodePerfStats' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NodePerfStats
