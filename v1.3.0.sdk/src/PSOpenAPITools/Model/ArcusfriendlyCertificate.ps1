...
ArcusfriendlyCertificate<PSCustomObject>
#>

function Initialize-ArcusfriendlyCertificate {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ArcusfriendlyCertificate' | Write-Debug
...
Convert from JSON to ArcusfriendlyCertificate<PSCustomObject>
...
ArcusfriendlyCertificate<PSCustomObject>
#>
function ConvertFrom-JsonToArcusfriendlyCertificate {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ArcusfriendlyCertificate' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ArcusfriendlyCertificate
