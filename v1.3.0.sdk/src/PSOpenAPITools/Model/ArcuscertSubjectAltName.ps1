...
ArcuscertSubjectAltName<PSCustomObject>
#>

function Initialize-ArcuscertSubjectAltName {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ArcuscertSubjectAltName' | Write-Debug
...
Convert from JSON to ArcuscertSubjectAltName<PSCustomObject>
...
ArcuscertSubjectAltName<PSCustomObject>
#>
function ConvertFrom-JsonToArcuscertSubjectAltName {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ArcuscertSubjectAltName' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ArcuscertSubjectAltName
