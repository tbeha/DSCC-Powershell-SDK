...
ArcusReplicationPartnerVolumeListRemoteVolume<PSCustomObject>
#>

function Initialize-ArcusReplicationPartnerVolumeListRemoteVolume {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ArcusReplicationPartnerVolumeListRemoteVolume' | Write-Debug
...
Convert from JSON to ArcusReplicationPartnerVolumeListRemoteVolume<PSCustomObject>
...
ArcusReplicationPartnerVolumeListRemoteVolume<PSCustomObject>
#>
function ConvertFrom-JsonToArcusReplicationPartnerVolumeListRemoteVolume {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ArcusReplicationPartnerVolumeListRemoteVolume' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ArcusReplicationPartnerVolumeListRemoteVolume
