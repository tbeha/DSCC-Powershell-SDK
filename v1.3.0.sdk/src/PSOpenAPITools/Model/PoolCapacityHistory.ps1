...
PoolCapacityHistory<PSCustomObject>
#>

function Initialize-PoolCapacityHistory {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PoolCapacityHistory' | Write-Debug
...
Convert from JSON to PoolCapacityHistory<PSCustomObject>
...
PoolCapacityHistory<PSCustomObject>
#>
function ConvertFrom-JsonToPoolCapacityHistory {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PoolCapacityHistory' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PoolCapacityHistory
