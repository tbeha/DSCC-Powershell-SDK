...
NimbleSnapshot<PSCustomObject>
#>

function Initialize-NimbleSnapshot {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => NimbleSnapshot' | Write-Debug
...
Convert from JSON to NimbleSnapshot<PSCustomObject>
...
NimbleSnapshot<PSCustomObject>
#>
function ConvertFrom-JsonToNimbleSnapshot {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
