...
function ConvertFrom-JsonToArcusportDetails {
    ...
    Process {
        ...
        $AllProperties = ("associatedLinks", "cardType", "class", "class2", "config", "configMode", "connectionType", "consoleUri", "customerId", "devices", "displayname", "domain", "enclosureCardId", "enclosureCardPCIUid", "enclosureCardPCId", "enclosureCardUid", "enclosureId", "enclosureUid", "failoverStatus", "fcData", "fwVersion", "generation", "id", "initiatorPorts", "interuptCoalesce", "ipData", "iscsiData", "label", "manufacturing", "mode", "modeChange", "name", "nodeCardId", "nodeId", "partner", "portSfp", "portType", "position", "protocol", "requestUri", "resourceUri", "revision", "smartSAN", "speedActual", "speedConfigured", "speedMax", "speedMin", "state", "stateDescription", "systemId", "tgtModeWriteOpt", "type", "uniqueWWN", "vlans")
