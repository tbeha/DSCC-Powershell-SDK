...
Request URI for detailed quorum witness object
.PARAMETER Id
...
ArcusWitnessDetails<PSCustomObject>
#>

function Initialize-ArcusWitnessDetails {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ArcusWitnessDetails' | Write-Debug
...
Convert from JSON to ArcusWitnessDetails<PSCustomObject>
...
ArcusWitnessDetails<PSCustomObject>
#>
function ConvertFrom-JsonToArcusWitnessDetails {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ArcusWitnessDetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ArcusWitnessDetails
        $AllProperties = ("consoleUri", "requestUri", "id", "associatedLinks", "customerId", "generation", "isRemoteArraySupportReplication", "name", "quorumATFTimeout", "quorumIpAddress", "quorumSSLPort", "quorumStatus", "quorumStatusQual", "quorumVersion", "remoteId", "remoteName", "remoteSystemId", "remoteSystemName", "resourceUri", "systemId", "systemName", "type")
