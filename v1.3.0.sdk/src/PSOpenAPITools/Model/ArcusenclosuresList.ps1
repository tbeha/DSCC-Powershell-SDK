...
ArcusenclosuresList<PSCustomObject>
#>

function Initialize-ArcusenclosuresList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ArcusenclosuresList' | Write-Debug
...
Convert from JSON to ArcusenclosuresList<PSCustomObject>
...
ArcusenclosuresList<PSCustomObject>
#>
function ConvertFrom-JsonToArcusenclosuresList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ArcusenclosuresList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ArcusenclosuresList
        $AllProperties = ("associatedLinks", "chainPosLoopA", "chainPosLoopB", "customerId", "dcsdata", "detailedState", "displayname", "domain", "enclosureId", "enclosureType", "errors", "failIndicator", "failRequested", "formFactor", "generation", "id", "locateEnabled", "location", "loopSplit", "manufacturing", "name", "nodeWwn", "resourceUri", "state", "subType", "systemId", "type", "warnIndicator", "warnRequested")
