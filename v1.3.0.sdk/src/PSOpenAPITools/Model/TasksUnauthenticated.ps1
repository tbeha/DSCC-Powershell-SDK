...
TasksUnauthenticated<PSCustomObject>
#>

function Initialize-TasksUnauthenticated {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => TasksUnauthenticated' | Write-Debug
...
Convert from JSON to TasksUnauthenticated<PSCustomObject>
...
TasksUnauthenticated<PSCustomObject>
#>
function ConvertFrom-JsonToTasksUnauthenticated {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => TasksUnauthenticated' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in TasksUnauthenticated
