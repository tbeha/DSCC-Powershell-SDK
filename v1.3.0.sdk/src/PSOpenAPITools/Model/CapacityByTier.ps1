...
CapacityByTier<PSCustomObject>
#>

function Initialize-CapacityByTier {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => CapacityByTier' | Write-Debug
...
Convert from JSON to CapacityByTier<PSCustomObject>
...
CapacityByTier<PSCustomObject>
#>
function ConvertFrom-JsonToCapacityByTier {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => CapacityByTier' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in CapacityByTier
