...
.PARAMETER Members
Members of the volume set. This field is deprecated.
.PARAMETER Name
...
FleetVolumeset<PSCustomObject>
#>

function Initialize-FleetVolumeset {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => FleetVolumeset' | Write-Debug
...
Convert from JSON to FleetVolumeset<PSCustomObject>
...
FleetVolumeset<PSCustomObject>
#>
function ConvertFrom-JsonToFleetVolumeset {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => FleetVolumeset' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in FleetVolumeset
        $AllProperties = ("appType", "application", "associatedLinks", "customerId", "generation", "id", "members", "name", "productFamily", "resourceUri", "systemId", "type")
