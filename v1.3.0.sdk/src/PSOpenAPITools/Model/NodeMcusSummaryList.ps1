...
NodeMcusSummaryList<PSCustomObject>
#>

function Initialize-NodeMcusSummaryList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => NodeMcusSummaryList' | Write-Debug
...
Convert from JSON to NodeMcusSummaryList<PSCustomObject>
...
NodeMcusSummaryList<PSCustomObject>
#>
function ConvertFrom-JsonToNodeMcusSummaryList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => NodeMcusSummaryList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NodeMcusSummaryList
