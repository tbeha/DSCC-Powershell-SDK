...
ArcusperfData<PSCustomObject>
#>

function Initialize-ArcusperfData {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ArcusperfData' | Write-Debug
...
Convert from JSON to ArcusperfData<PSCustomObject>
...
ArcusperfData<PSCustomObject>
#>
function ConvertFrom-JsonToArcusperfData {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ArcusperfData' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ArcusperfData
