...
FilterDiskCapacity<PSCustomObject>
#>

function Initialize-FilterDiskCapacity {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => FilterDiskCapacity' | Write-Debug
...
Convert from JSON to FilterDiskCapacity<PSCustomObject>
...
FilterDiskCapacity<PSCustomObject>
#>
function ConvertFrom-JsonToFilterDiskCapacity {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => FilterDiskCapacity' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in FilterDiskCapacity
