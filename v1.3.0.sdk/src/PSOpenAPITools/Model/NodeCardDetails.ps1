...
.PARAMETER NodeCardType
Type of the node adapter card
.PARAMETER NodeDeviceId
ID of the node
.PARAMETER NodeId
Unique Identifier of the node.
.PARAMETER RequestUri
requestUri for detailed node card object
.PARAMETER ResourceUri
resourceUri for detailed node card object
.PARAMETER Revision
Revision
...
NodeCardDetails<PSCustomObject>
#>

function Initialize-NodeCardDetails {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => NodeCardDetails' | Write-Debug
...
Convert from JSON to NodeCardDetails<PSCustomObject>
...
NodeCardDetails<PSCustomObject>
#>
function ConvertFrom-JsonToNodeCardDetails {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => NodeCardDetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NodeCardDetails
        $AllProperties = ("associatedLinks", "consoleUri", "customerId", "displayname", "domain", "fwVersion", "generation", "id", "locateEnabled", "manufacturing", "name", "nodeCardType", "nodeDeviceId", "nodeId", "requestUri", "resourceUri", "revision", "safeToRemove", "serviceLED", "slot", "systemId", "type")
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "nodeCardType"))) { #optional property not found
            $NodeCardType = $null
        } else {
            $NodeCardType = $JsonParameters.PSobject.Properties["nodeCardType"].value
        }
