...
.PARAMETER Total
Number of node Batteries.
.OUTPUTS

NodeBatteriesSummaryList<PSCustomObject>
#>

function Initialize-NodeBatteriesSummaryList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => NodeBatteriesSummaryList' | Write-Debug
...
Convert from JSON to NodeBatteriesSummaryList<PSCustomObject>
...
NodeBatteriesSummaryList<PSCustomObject>
#>
function ConvertFrom-JsonToNodeBatteriesSummaryList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => NodeBatteriesSummaryList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NodeBatteriesSummaryList
