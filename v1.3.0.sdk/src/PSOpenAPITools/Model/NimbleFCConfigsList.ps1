...
requestUri for  Fibre Channel Configs
.PARAMETER Total
Total number of Fibre Channel Configs.
.OUTPUTS

NimbleFCConfigsList<PSCustomObject>
#>

function Initialize-NimbleFCConfigsList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => NimbleFCConfigsList' | Write-Debug
...
Convert from JSON to NimbleFCConfigsList<PSCustomObject>
...
NimbleFCConfigsList<PSCustomObject>
#>
function ConvertFrom-JsonToNimbleFCConfigsList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => NimbleFCConfigsList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NimbleFCConfigsList
