...
StoragePoolsFleetSummaryList<PSCustomObject>
#>

function Initialize-StoragePoolsFleetSummaryList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => StoragePoolsFleetSummaryList' | Write-Debug
...
Convert from JSON to StoragePoolsFleetSummaryList<PSCustomObject>
...
StoragePoolsFleetSummaryList<PSCustomObject>
#>
function ConvertFrom-JsonToStoragePoolsFleetSummaryList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => StoragePoolsFleetSummaryList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in StoragePoolsFleetSummaryList
