...
requestUri for controller objects
.PARAMETER Total
Total number of controllers.
.OUTPUTS

NimbleControllerList<PSCustomObject>
#>

function Initialize-NimbleControllerList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => NimbleControllerList' | Write-Debug
...
Convert from JSON to NimbleControllerList<PSCustomObject>
...
NimbleControllerList<PSCustomObject>
#>
function ConvertFrom-JsonToNimbleControllerList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => NimbleControllerList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NimbleControllerList
