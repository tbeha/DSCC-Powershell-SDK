...
SystemPerformanceHistory<PSCustomObject>
#>

function Initialize-SystemPerformanceHistory {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => SystemPerformanceHistory' | Write-Debug
...
Convert from JSON to SystemPerformanceHistory<PSCustomObject>
...
SystemPerformanceHistory<PSCustomObject>
#>
function ConvertFrom-JsonToSystemPerformanceHistory {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => SystemPerformanceHistory' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in SystemPerformanceHistory
