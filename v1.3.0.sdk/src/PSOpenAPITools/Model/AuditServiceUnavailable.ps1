...
AuditServiceUnavailable<PSCustomObject>
#>

function Initialize-AuditServiceUnavailable {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => AuditServiceUnavailable' | Write-Debug
...
Convert from JSON to AuditServiceUnavailable<PSCustomObject>
...
AuditServiceUnavailable<PSCustomObject>
#>
function ConvertFrom-JsonToAuditServiceUnavailable {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => AuditServiceUnavailable' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in AuditServiceUnavailable
