...
requestUri for volume objects
.PARAMETER Total
Total number of volumes.
.OUTPUTS

NimbleVolumesList<PSCustomObject>
#>

function Initialize-NimbleVolumesList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => NimbleVolumesList' | Write-Debug
...
Convert from JSON to NimbleVolumesList<PSCustomObject>
...
NimbleVolumesList<PSCustomObject>
#>
function ConvertFrom-JsonToNimbleVolumesList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => NimbleVolumesList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NimbleVolumesList
