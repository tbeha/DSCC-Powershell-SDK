...
UserAllocationSettingsSingle<PSCustomObject>
#>

function Initialize-UserAllocationSettingsSingle {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => UserAllocationSettingsSingle' | Write-Debug
...
Convert from JSON to UserAllocationSettingsSingle<PSCustomObject>
...
UserAllocationSettingsSingle<PSCustomObject>
#>
function ConvertFrom-JsonToUserAllocationSettingsSingle {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => UserAllocationSettingsSingle' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in UserAllocationSettingsSingle
