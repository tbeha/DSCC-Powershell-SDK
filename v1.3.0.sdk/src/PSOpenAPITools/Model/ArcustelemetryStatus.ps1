...
ArcustelemetryStatus<PSCustomObject>
#>

function Initialize-ArcustelemetryStatus {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ArcustelemetryStatus' | Write-Debug
...
Convert from JSON to ArcustelemetryStatus<PSCustomObject>
...
ArcustelemetryStatus<PSCustomObject>
#>
function ConvertFrom-JsonToArcustelemetryStatus {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ArcustelemetryStatus' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ArcustelemetryStatus
