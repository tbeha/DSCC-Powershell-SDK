...
ArcusinitiatorPort<PSCustomObject>
#>

function Initialize-ArcusinitiatorPort {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ArcusinitiatorPort' | Write-Debug
...
Convert from JSON to ArcusinitiatorPort<PSCustomObject>
...
ArcusinitiatorPort<PSCustomObject>
#>
function ConvertFrom-JsonToArcusinitiatorPort {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ArcusinitiatorPort' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ArcusinitiatorPort
