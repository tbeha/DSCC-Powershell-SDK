...
AuditBadRequest<PSCustomObject>
#>

function Initialize-AuditBadRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => AuditBadRequest' | Write-Debug
...
Convert from JSON to AuditBadRequest<PSCustomObject>
...
AuditBadRequest<PSCustomObject>
#>
function ConvertFrom-JsonToAuditBadRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => AuditBadRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in AuditBadRequest
