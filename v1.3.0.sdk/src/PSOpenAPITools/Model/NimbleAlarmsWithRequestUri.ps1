...
requestUri for detailed alarms object
.PARAMETER AckTime
...
NimbleAlarmsWithRequestUri<PSCustomObject>
#>

function Initialize-NimbleAlarmsWithRequestUri {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => NimbleAlarmsWithRequestUri' | Write-Debug
...
Convert from JSON to NimbleAlarmsWithRequestUri<PSCustomObject>
...
NimbleAlarmsWithRequestUri<PSCustomObject>
#>
function ConvertFrom-JsonToNimbleAlarmsWithRequestUri {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => NimbleAlarmsWithRequestUri' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NimbleAlarmsWithRequestUri
        $AllProperties = ("requestUri", "ack_time", "activity", "alarm_type", "array", "category", "curr_onset_event_id", "id", "next_notification_time", "object_id", "object_name", "object_type", "onset_time", "remind_every", "remind_every_unit", "severity", "status", "user_full_name", "user_id", "user_name", "associated_links", "consoleUri", "customerId", "generation", "resourceUri", "summary", "type")
