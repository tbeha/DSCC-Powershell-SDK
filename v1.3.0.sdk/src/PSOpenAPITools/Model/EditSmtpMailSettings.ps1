...
EditSmtpMailSettings<PSCustomObject>
#>

function Initialize-EditSmtpMailSettings {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => EditSmtpMailSettings' | Write-Debug
...
Convert from JSON to EditSmtpMailSettings<PSCustomObject>
...
EditSmtpMailSettings<PSCustomObject>
#>
function ConvertFrom-JsonToEditSmtpMailSettings {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => EditSmtpMailSettings' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in EditSmtpMailSettings
