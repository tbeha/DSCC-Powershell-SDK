...
function ConvertFrom-JsonToNimbleCreateFolderInput {
    ...
    Process {
        ...
        $AllProperties = ("access_protocol", "agent_type", "appserver_id", "description", "inherited_vol_perfpol_id", "limit_iops", "limit_mbps", "limit_size_bytes", "name", "overdraft_limit_pct", "pool_id", "provisioned_limit_size_bytes")
