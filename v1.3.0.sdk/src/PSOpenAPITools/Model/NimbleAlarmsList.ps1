...
requestUri for Alarms objects
.PARAMETER Total
Total number of Alarms.
.OUTPUTS

NimbleAlarmsList<PSCustomObject>
#>

function Initialize-NimbleAlarmsList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => NimbleAlarmsList' | Write-Debug
...
Convert from JSON to NimbleAlarmsList<PSCustomObject>
...
NimbleAlarmsList<PSCustomObject>
#>
function ConvertFrom-JsonToNimbleAlarmsList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => NimbleAlarmsList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NimbleAlarmsList
