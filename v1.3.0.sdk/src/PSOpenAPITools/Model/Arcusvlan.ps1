...
Arcusvlan<PSCustomObject>
#>

function Initialize-Arcusvlan {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => Arcusvlan' | Write-Debug
...
Convert from JSON to Arcusvlan<PSCustomObject>
...
Arcusvlan<PSCustomObject>
#>
function ConvertFrom-JsonToArcusvlan {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => Arcusvlan' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Arcusvlan
