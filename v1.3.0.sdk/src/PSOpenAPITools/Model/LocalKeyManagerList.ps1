...
requestUri for local key manager
.PARAMETER Total
Total number of local key managers.
.OUTPUTS

LocalKeyManagerList<PSCustomObject>
#>

function Initialize-LocalKeyManagerList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => LocalKeyManagerList' | Write-Debug
...
Convert from JSON to LocalKeyManagerList<PSCustomObject>
...
LocalKeyManagerList<PSCustomObject>
#>
function ConvertFrom-JsonToLocalKeyManagerList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => LocalKeyManagerList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in LocalKeyManagerList
