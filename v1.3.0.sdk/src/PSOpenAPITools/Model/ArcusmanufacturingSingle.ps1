...
ArcusmanufacturingSingle<PSCustomObject>
#>

function Initialize-ArcusmanufacturingSingle {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ArcusmanufacturingSingle' | Write-Debug
...
Convert from JSON to ArcusmanufacturingSingle<PSCustomObject>
...
ArcusmanufacturingSingle<PSCustomObject>
#>
function ConvertFrom-JsonToArcusmanufacturingSingle {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ArcusmanufacturingSingle' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ArcusmanufacturingSingle
