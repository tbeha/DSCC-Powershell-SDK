...
function ConvertFrom-JsonToArcusportsList {
    ...
    Process {
        ...
        $AllProperties = ("associatedLinks", "cardType", "class", "class2", "config", "configMode", "connectionType", "customerId", "devices", "displayname", "domain", "enclosureCardId", "enclosureCardPCIUid", "enclosureCardPCId", "enclosureCardUid", "enclosureId", "enclosureUid", "failoverStatus", "fcData", "fwVersion", "generation", "id", "initiatorPorts", "interuptCoalesce", "ipData", "iscsiData", "label", "manufacturing", "mode", "modeChange", "name", "nodeCardId", "nodeId", "partner", "portSfp", "portType", "position", "protocol", "resourceUri", "revision", "smartSAN", "speedActual", "speedConfigured", "speedMax", "speedMin", "state", "stateDescription", "systemId", "tgtModeWriteOpt", "type", "uniqueWWN", "vlans")
