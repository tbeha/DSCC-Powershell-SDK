...
ArcusvolumePost<PSCustomObject>
#>

function Initialize-ArcusvolumePost {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ArcusvolumePost' | Write-Debug
...
Convert from JSON to ArcusvolumePost<PSCustomObject>
...
ArcusvolumePost<PSCustomObject>
#>
function ConvertFrom-JsonToArcusvolumePost {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ArcusvolumePost' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ArcusvolumePost
