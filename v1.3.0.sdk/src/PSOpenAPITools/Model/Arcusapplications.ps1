...
Arcusapplications<PSCustomObject>
#>

function Initialize-Arcusapplications {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => Arcusapplications' | Write-Debug
...
Convert from JSON to Arcusapplications<PSCustomObject>
...
Arcusapplications<PSCustomObject>
#>
function ConvertFrom-JsonToArcusapplications {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => Arcusapplications' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Arcusapplications
