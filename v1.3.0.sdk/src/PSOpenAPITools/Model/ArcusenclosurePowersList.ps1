...
ArcusenclosurePowersList<PSCustomObject>
#>

function Initialize-ArcusenclosurePowersList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ArcusenclosurePowersList' | Write-Debug
...
Convert from JSON to ArcusenclosurePowersList<PSCustomObject>
...
ArcusenclosurePowersList<PSCustomObject>
#>
function ConvertFrom-JsonToArcusenclosurePowersList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ArcusenclosurePowersList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ArcusenclosurePowersList
        $AllProperties = ("acStatus", "associatedLinks", "customerId", "dcStatus", "displayname", "domain", "elementStatusCode", "enclosureId", "enclosureName", "enclosurePowerId", "enclosureType", "enclosureUid", "failIndicator", "failInput", "failOutput", "generation", "id", "locateEnabled", "manufacturing", "modelReadOnly", "name", "resourceUri", "safeToRemove", "state", "systemId", "type")
