...
NimbleFCConfigsListItemsInner<PSCustomObject>
#>

function Initialize-NimbleFCConfigsListItemsInner {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => NimbleFCConfigsListItemsInner' | Write-Debug
...
Convert from JSON to NimbleFCConfigsListItemsInner<PSCustomObject>
...
NimbleFCConfigsListItemsInner<PSCustomObject>
#>
function ConvertFrom-JsonToNimbleFCConfigsListItemsInner {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => NimbleFCConfigsListItemsInner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NimbleFCConfigsListItemsInner
        $AllProperties = ("id", "array_list", "associated_links", "consoleUri", "controller_name", "customerId", "generation", "group_leader_array", "resourceUri", "type")
