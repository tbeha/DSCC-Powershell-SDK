...
ArcuseditVCenterSettingsInput<PSCustomObject>
#>

function Initialize-ArcuseditVCenterSettingsInput {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ArcuseditVCenterSettingsInput' | Write-Debug
...
Convert from JSON to ArcuseditVCenterSettingsInput<PSCustomObject>
...
ArcuseditVCenterSettingsInput<PSCustomObject>
#>
function ConvertFrom-JsonToArcuseditVCenterSettingsInput {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ArcuseditVCenterSettingsInput' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ArcuseditVCenterSettingsInput
