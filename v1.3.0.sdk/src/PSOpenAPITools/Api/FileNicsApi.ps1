...
#>
function Invoke-DeviceType6GetNics {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: Invoke-DeviceType6GetNics' | Write-Debug
        ...
        $LocalVarUri = '/api/v1/storage-systems/device-type6/{systemUuid}/nics'
        if (!$SystemUuid) {
            throw "Error! The required parameter `SystemUuid` missing when calling deviceType6GetNics."
        }
        ...
        $LocalVarResult = Invoke-ApiClient -Method 'GET' `
                                ...
                                -ReturnType "DeviceType6GetNics200Response" `
