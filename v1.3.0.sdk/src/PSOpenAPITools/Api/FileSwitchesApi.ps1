...
Unique identifier for fileserver switch
...
GetSwitchResponse
#>
function Invoke-DeviceType6GetSwitchById {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: Invoke-DeviceType6GetSwitchById' | Write-Debug
        ...
        $LocalVarUri = '/api/v1/storage-systems/device-type6/{systemUuid}/switches/{switchUuid}'
        if (!$SystemUuid) {
            throw "Error! The required parameter `SystemUuid` missing when calling deviceType6GetSwitchById."
        }
        $LocalVarUri = $LocalVarUri.replace('{systemUuid}', [System.Web.HTTPUtility]::UrlEncode($SystemUuid))
        if (!$SwitchUuid) {
            throw "Error! The required parameter `SwitchUuid` missing when calling deviceType6GetSwitchById."
        }
        $LocalVarUri = $LocalVarUri.replace('{switchUuid}', [System.Web.HTTPUtility]::UrlEncode($SwitchUuid))
...
#>
function Invoke-DeviceType6GetSwitchesByFileServerId {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Invoke-DeviceType6GetSwitchesByFileServerId' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/api/v1/storage-systems/device-type6/{systemUuid}/switches'
        if (!$SystemUuid) {
            throw "Error! The required parameter `SystemUuid` missing when calling deviceType6GetSwitchesByFileServerId."
        }
        $LocalVarUri = $LocalVarUri.replace('{systemUuid}', [System.Web.HTTPUtility]::UrlEncode($SystemUuid))
        ...
        $LocalVarResult = Invoke-ApiClient -Method 'GET' `
                                ...
                                -FormParameters $LocalVarFormParameters `
                                -CookieParameters $LocalVarCookieParameters `
                                -ReturnType "DeviceType6GetSwitchesByFileServerId200Response" `
                                -IsBodyNullable $false
