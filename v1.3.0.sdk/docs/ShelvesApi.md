...
[**Invoke-DeviceType1EnclosureSledsListGetById**](ShelvesApi.md#Invoke-DeviceType1EnclosureSledsListGetById) | **GET** /api/v1/storage-systems/device-type1/{systemId}/enclosures/{enclosureId}/enclosure-sleds | Get details of Primera / Alletra 9K Enclosure Sleds identified by {enclosureId}
...
# Locate IO Module of HPE Alletra Storage MP identified by {id}
try {
    $Result = Invoke-EnclosureCardsLocateIOById -SystemId $SystemId -EnclosureId $EnclosureId -Id $Id -ArcusLocateInput $ArcusLocateInput
} catch {
...
# Locate drive of HPE Alletra Storage MP identified by {id}
try {
    $Result = Invoke-EnclosureSledsLocateDriveById -SystemId $SystemId -EnclosureId $EnclosureId -Id $Id -ArcusLocateInput $ArcusLocateInput
} catch {
...
# Edit details of HPE Alletra Storage MP Enclosure identified by {id}
try {
    $Result = Invoke-EnclosuresEditById -SystemId $SystemId -Id $Id -ArcuseditEnclosureInput $ArcuseditEnclosureInput
} catch {
