...
TaskResponse
#>
function Invoke-DeviceType1PromoteCloneVolume {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Invoke-DeviceType1PromoteCloneVolume' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        if (!$SystemId) {
            throw "Error! The required parameter `SystemId` missing when calling deviceType1PromoteCloneVolume."
        }
        $LocalVarUri = $LocalVarUri.replace('{systemId}', [System.Web.HTTPUtility]::UrlEncode($SystemId))
        if (!$VolumeId) {
            throw "Error! The required parameter `VolumeId` missing when calling deviceType1PromoteCloneVolume."
        }
        $LocalVarUri = $LocalVarUri.replace('{volumeId}', [System.Web.HTTPUtility]::UrlEncode($VolumeId))
        if (!$CloneId) {
            throw "Error! The required parameter `CloneId` missing when calling deviceType1PromoteCloneVolume."
        }
...
TaskResponse
#>
function Invoke-DeviceType1PromoteSnapshot {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Invoke-DeviceType1PromoteSnapshot' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        if (!$SystemId) {
            throw "Error! The required parameter `SystemId` missing when calling deviceType1PromoteSnapshot."
        }
        $LocalVarUri = $LocalVarUri.replace('{systemId}', [System.Web.HTTPUtility]::UrlEncode($SystemId))
        if (!$VolumeId) {
            throw "Error! The required parameter `VolumeId` missing when calling deviceType1PromoteSnapshot."
        }
        $LocalVarUri = $LocalVarUri.replace('{volumeId}', [System.Web.HTTPUtility]::UrlEncode($VolumeId))
        if (!$SnapshotId) {
            throw "Error! The required parameter `SnapshotId` missing when calling deviceType1PromoteSnapshot."
        }
        $LocalVarUri = $LocalVarUri.replace('{snapshotId}', [System.Web.HTTPUtility]::UrlEncode($SnapshotId))
...
TaskResponse
#>
function Invoke-DeviceType1ResyncCloneVolume {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Invoke-DeviceType1ResyncCloneVolume' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        if (!$SystemId) {
            throw "Error! The required parameter `SystemId` missing when calling deviceType1ResyncCloneVolume."
        }
        $LocalVarUri = $LocalVarUri.replace('{systemId}', [System.Web.HTTPUtility]::UrlEncode($SystemId))
        if (!$VolumeId) {
            throw "Error! The required parameter `VolumeId` missing when calling deviceType1ResyncCloneVolume."
        }
        $LocalVarUri = $LocalVarUri.replace('{volumeId}', [System.Web.HTTPUtility]::UrlEncode($VolumeId))
        if (!$CloneId) {
            throw "Error! The required parameter `CloneId` missing when calling deviceType1ResyncCloneVolume."
        }
        $LocalVarUri = $LocalVarUri.replace('{cloneId}', [System.Web.HTTPUtility]::UrlEncode($CloneId))
...
#>
function Invoke-DeviceType4GetPerformanceDrifts {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Invoke-DeviceType4GetPerformanceDrifts' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        if (!$SystemId) {
            throw "Error! The required parameter `SystemId` missing when calling deviceType4GetPerformanceDrifts."
        }
        $LocalVarUri = $LocalVarUri.replace('{systemId}', [System.Web.HTTPUtility]::UrlEncode($SystemId))
        if (!$VolumeId) {
            throw "Error! The required parameter `VolumeId` missing when calling deviceType4GetPerformanceDrifts."
        }
        $LocalVarUri = $LocalVarUri.replace('{volumeId}', [System.Web.HTTPUtility]::UrlEncode($VolumeId))

        if (!$TimeIntervalMin) {
            throw "Error! The required parameter `TimeIntervalMin` missing when calling deviceType4GetPerformanceDrifts."
        }
        $LocalVarQueryParameters['timeIntervalMin'] = $TimeIntervalMin

        if (!$Range) {
            throw "Error! The required parameter `Range` missing when calling deviceType4GetPerformanceDrifts."
        }
        $LocalVarQueryParameters['range'] = $Range
...
#>
function Invoke-DeviceType4GetVolumeLatencyAnnotations {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Invoke-DeviceType4GetVolumeLatencyAnnotations' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        if (!$SystemId) {
            throw "Error! The required parameter `SystemId` missing when calling deviceType4GetVolumeLatencyAnnotations."
        }
        $LocalVarUri = $LocalVarUri.replace('{systemId}', [System.Web.HTTPUtility]::UrlEncode($SystemId))
        if (!$VolumeId) {
            throw "Error! The required parameter `VolumeId` missing when calling deviceType4GetVolumeLatencyAnnotations."
        }
        $LocalVarUri = $LocalVarUri.replace('{volumeId}', [System.Web.HTTPUtility]::UrlEncode($VolumeId))

        if (!$TimeIntervalMin) {
            throw "Error! The required parameter `TimeIntervalMin` missing when calling deviceType4GetVolumeLatencyAnnotations."
        }
        $LocalVarQueryParameters['timeIntervalMin'] = $TimeIntervalMin

        if (!$Range) {
            throw "Error! The required parameter `Range` missing when calling deviceType4GetVolumeLatencyAnnotations."
        }
        $LocalVarQueryParameters['range'] = $Range
...
TaskResponse
#>
function Invoke-DeviceType4SnapshotCloneCreate {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Invoke-DeviceType4SnapshotCloneCreate' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        if (!$SystemId) {
            throw "Error! The required parameter `SystemId` missing when calling deviceType4SnapshotCloneCreate."
        }
        $LocalVarUri = $LocalVarUri.replace('{systemId}', [System.Web.HTTPUtility]::UrlEncode($SystemId))
        if (!$SnapshotId) {
            throw "Error! The required parameter `SnapshotId` missing when calling deviceType4SnapshotCloneCreate."
        }
        $LocalVarUri = $LocalVarUri.replace('{snapshotId}', [System.Web.HTTPUtility]::UrlEncode($SnapshotId))

        if (!$ArcusCreateCloneSnapshotInput) {
            throw "Error! The required parameter `ArcusCreateCloneSnapshotInput` missing when calling deviceType4SnapshotCloneCreate."
        }
...
TaskResponse
#>
function Invoke-DeviceType4VlunsDelete {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Invoke-DeviceType4VlunsDelete' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        if (!$SystemId) {
            throw "Error! The required parameter `SystemId` missing when calling deviceType4VlunsDelete."
        }
        $LocalVarUri = $LocalVarUri.replace('{systemId}', [System.Web.HTTPUtility]::UrlEncode($SystemId))
        if (!$VolumeId) {
            throw "Error! The required parameter `VolumeId` missing when calling deviceType4VlunsDelete."
        }
        $LocalVarUri = $LocalVarUri.replace('{volumeId}', [System.Web.HTTPUtility]::UrlEncode($VolumeId))
        if (!$Id) {
            throw "Error! The required parameter `Id` missing when calling deviceType4VlunsDelete."
        }
        $LocalVarUri = $LocalVarUri.replace('{id}', [System.Web.HTTPUtility]::UrlEncode($Id))
...
TaskResponse
#>
function Invoke-DeviceType4VolumeCloneCreate {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Invoke-DeviceType4VolumeCloneCreate' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        if (!$SystemId) {
            throw "Error! The required parameter `SystemId` missing when calling deviceType4VolumeCloneCreate."
        }
        $LocalVarUri = $LocalVarUri.replace('{systemId}', [System.Web.HTTPUtility]::UrlEncode($SystemId))
        if (!$Id) {
            throw "Error! The required parameter `Id` missing when calling deviceType4VolumeCloneCreate."
        }
        $LocalVarUri = $LocalVarUri.replace('{id}', [System.Web.HTTPUtility]::UrlEncode($Id))

        if (!$ArcuscreateCloneVolumeInput) {
            throw "Error! The required parameter `ArcuscreateCloneVolumeInput` missing when calling deviceType4VolumeCloneCreate."
        }
...
TaskResponse
#>
function Invoke-DeviceType4VolumeCreate {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Invoke-DeviceType4VolumeCreate' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        if (!$SystemId) {
            throw "Error! The required parameter `SystemId` missing when calling deviceType4VolumeCreate."
        }
        $LocalVarUri = $LocalVarUri.replace('{systemId}', [System.Web.HTTPUtility]::UrlEncode($SystemId))
...
TaskResponse
#>
function Invoke-DeviceType4VolumeDelete {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Invoke-DeviceType4VolumeDelete' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        if (!$SystemId) {
            throw "Error! The required parameter `SystemId` missing when calling deviceType4VolumeDelete."
        }
        $LocalVarUri = $LocalVarUri.replace('{systemId}', [System.Web.HTTPUtility]::UrlEncode($SystemId))
        if (!$Id) {
            throw "Error! The required parameter `Id` missing when calling deviceType4VolumeDelete."
        }
        $LocalVarUri = $LocalVarUri.replace('{id}', [System.Web.HTTPUtility]::UrlEncode($Id))
...
TaskResponse
#>
function Invoke-DeviceType4VolumeEdit {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Invoke-DeviceType4VolumeEdit' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/api/v1/storage-systems/device-type4/{systemId}/volumes/{id}'
        if (!$SystemId) {
            throw "Error! The required parameter `SystemId` missing when calling deviceType4VolumeEdit."
        }
        $LocalVarUri = $LocalVarUri.replace('{systemId}', [System.Web.HTTPUtility]::UrlEncode($SystemId))
        if (!$Id) {
            throw "Error! The required parameter `Id` missing when calling deviceType4VolumeEdit."
        }
        $LocalVarUri = $LocalVarUri.replace('{id}', [System.Web.HTTPUtility]::UrlEncode($Id))
...
TaskResponse
#>
function Invoke-DeviceType4VolumeSnapshotCreate {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Invoke-DeviceType4VolumeSnapshotCreate' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        if (!$SystemId) {
            throw "Error! The required parameter `SystemId` missing when calling deviceType4VolumeSnapshotCreate."
        }
        $LocalVarUri = $LocalVarUri.replace('{systemId}', [System.Web.HTTPUtility]::UrlEncode($SystemId))
        if (!$Id) {
            throw "Error! The required parameter `Id` missing when calling deviceType4VolumeSnapshotCreate."
        }
        $LocalVarUri = $LocalVarUri.replace('{id}', [System.Web.HTTPUtility]::UrlEncode($Id))
...
TaskResponse
#>
function Invoke-DeviceType4VolumeSnapshotGetById {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Invoke-DeviceType4VolumeSnapshotGetById' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/api/v1/storage-systems/device-type4/{systemId}/volumes/{volumeId}/snapshots/{snapshotId}'
        if (!$SystemId) {
            throw "Error! The required parameter `SystemId` missing when calling deviceType4VolumeSnapshotGetById."
        }
        $LocalVarUri = $LocalVarUri.replace('{systemId}', [System.Web.HTTPUtility]::UrlEncode($SystemId))
        if (!$VolumeId) {
            throw "Error! The required parameter `VolumeId` missing when calling deviceType4VolumeSnapshotGetById."
        }
        $LocalVarUri = $LocalVarUri.replace('{volumeId}', [System.Web.HTTPUtility]::UrlEncode($VolumeId))
        if (!$SnapshotId) {
            throw "Error! The required parameter `SnapshotId` missing when calling deviceType4VolumeSnapshotGetById."
        }
        $LocalVarUri = $LocalVarUri.replace('{snapshotId}', [System.Web.HTTPUtility]::UrlEncode($SnapshotId))
...
function Invoke-SnapshotCloneCreate {
    ...
    Process {
        ...
        if (!$CreateCloneSnapshotInput) {
            throw "Error! The required parameter `CreateCloneSnapshotInput` missing when calling snapshotCloneCreate."
        }
...
function Invoke-VolumeCloneCreate {
    ...
    Process {
        ...
        if (!$CreateCloneVolumeInput) {
            throw "Error! The required parameter `CreateCloneVolumeInput` missing when calling volumeCloneCreate."
        }
