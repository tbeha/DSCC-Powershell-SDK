...
CreateProtectionPolicyInputSchema<PSCustomObject>
#>

function Initialize-CreateProtectionPolicyInputSchema {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => CreateProtectionPolicyInputSchema' | Write-Debug
...
Convert from JSON to CreateProtectionPolicyInputSchema<PSCustomObject>
...
CreateProtectionPolicyInputSchema<PSCustomObject>
#>
function ConvertFrom-JsonToCreateProtectionPolicyInputSchema {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => CreateProtectionPolicyInputSchema' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in CreateProtectionPolicyInputSchema
