...
requestUri for detailed node power object
...
NodePowerSupplyDetails<PSCustomObject>
#>

function Initialize-NodePowerSupplyDetails {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => NodePowerSupplyDetails' | Write-Debug
...
Convert from JSON to NodePowerSupplyDetails<PSCustomObject>
...
NodePowerSupplyDetails<PSCustomObject>
#>
function ConvertFrom-JsonToNodePowerSupplyDetails {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => NodePowerSupplyDetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NodePowerSupplyDetails
        $AllProperties = ("associatedLinks", "consoleUri", "customerId", "displayname", "domain", "fanspeed", "fanstate", "generation", "id", "locateEnabled", "manufacturing", "name", "nodePowerId", "primaryNodeId", "requestUri", "resourceUri", "safeToRemove", "secondaryNodeId", "serviceLED", "state", "systemId", "type")
