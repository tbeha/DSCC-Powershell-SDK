...
ArcusRecoverParams<PSCustomObject>
#>

function Initialize-ArcusRecoverParams {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ArcusRecoverParams' | Write-Debug
...
Convert from JSON to ArcusRecoverParams<PSCustomObject>
...
ArcusRecoverParams<PSCustomObject>
#>
function ConvertFrom-JsonToArcusRecoverParams {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ArcusRecoverParams' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ArcusRecoverParams
