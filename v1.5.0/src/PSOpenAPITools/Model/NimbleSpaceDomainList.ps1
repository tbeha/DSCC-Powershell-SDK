...
requestUri for application-summary objects
.PARAMETER Total
Total number of applications.
.OUTPUTS

NimbleSpaceDomainList<PSCustomObject>
#>

function Initialize-NimbleSpaceDomainList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => NimbleSpaceDomainList' | Write-Debug
...
Convert from JSON to NimbleSpaceDomainList<PSCustomObject>
...
NimbleSpaceDomainList<PSCustomObject>
#>
function ConvertFrom-JsonToNimbleSpaceDomainList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => NimbleSpaceDomainList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NimbleSpaceDomainList
