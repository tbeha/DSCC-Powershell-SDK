...
ArcusenclosureCardList<PSCustomObject>
#>

function Initialize-ArcusenclosureCardList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ArcusenclosureCardList' | Write-Debug
...
Convert from JSON to ArcusenclosureCardList<PSCustomObject>
...
ArcusenclosureCardList<PSCustomObject>
#>
function ConvertFrom-JsonToArcusenclosureCardList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ArcusenclosureCardList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ArcusenclosureCardList
        $AllProperties = ("associatedLinks", "customerId", "dcsdata", "displayname", "domain", "elementStatusCode", "enclosureCardId", "enclosureId", "enclosureName", "enclosureType", "enclosureUid", "failIndicator", "generation", "id", "isNodeCard", "locateEnabled", "locateSevenSegDisplay", "loopA", "loopB", "manufacturing", "name", "resourceUri", "safeToRemove", "sevenSegDisplay", "state", "systemId", "type")
