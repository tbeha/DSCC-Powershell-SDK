...
ArcusenclosureDiskList<PSCustomObject>
#>

function Initialize-ArcusenclosureDiskList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ArcusenclosureDiskList' | Write-Debug
...
Convert from JSON to ArcusenclosureDiskList<PSCustomObject>
...
ArcusenclosureDiskList<PSCustomObject>
#>
function ConvertFrom-JsonToArcusenclosureDiskList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ArcusenclosureDiskList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ArcusenclosureDiskList
        $AllProperties = ("associatedLinks", "customerId", "dc4data", "dcsdata", "displayname", "domain", "enclosureId", "enclosureName", "enclosureType", "enclosureUid", "generation", "id", "loopA", "loopB", "manufacturing", "name", "position", "resourceUri", "systemId", "temperature", "type", "wwn")
