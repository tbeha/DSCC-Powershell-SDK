...
function ConvertFrom-JsonToNimbleFCInitiator {
    ...
    Process {
        ...
        $AllProperties = ("alias", "id", "initiator_id", "wwpn")
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "initiator_id"))) { #optional property not found
            $InitiatorId = $null
        } else {
            $InitiatorId = $JsonParameters.PSobject.Properties["initiator_id"].value
        }
