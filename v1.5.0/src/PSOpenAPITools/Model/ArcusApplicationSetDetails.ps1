...
Shows if failover is allowed or not. This field is deprecated.
.PARAMETER IsOverrideAllowed
Shows if Override is allowed or not. This field is deprecated.
.PARAMETER IsPrimary
States if the Application set is Primary or not
.PARAMETER IsSyncAllowed
Shows if sync is allowed or not. This field is deprecated.
...
Shows the replication state of the application set
...
Zero RTO configuration. Supported config is Active Peer Persistence. Classic Peer Persistence is not supported for Arcus.
.OUTPUTS

ArcusApplicationSetDetails<PSCustomObject>
#>

function Initialize-ArcusApplicationSetDetails {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ArcusApplicationSetDetails' | Write-Debug
...
Convert from JSON to ArcusApplicationSetDetails<PSCustomObject>
...
ArcusApplicationSetDetails<PSCustomObject>
#>
function ConvertFrom-JsonToArcusApplicationSetDetails {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ArcusApplicationSetDetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ArcusApplicationSetDetails
        $AllProperties = ("appSetBusinessUnit", "appSetComments", "appSetExcludeAIQoS", "appSetId", "appSetImportance", "appSetName", "appSetType", "appSetTypeEnum", "associatedLinks", "comment", "consoleUri", "customerId", "displayName", "domain", "drState", "exportStatus", "generation", "id", "initiators", "isFailoverAllowed", "isOverrideAllowed", "isPrimary", "isSyncAllowed", "kvPairsPresent", "members", "name", "nonZeroRtoConfig", "remoteRecoveryPoint", "replicationPartner", "replicationState", "replicationTraffic", "replicationType", "requestUri", "role", "serialNumber", "sizeMiB", "snapSetParentId", "snapSetParentName", "systemId", "type", "vvSetType", "zeroRtoConfig")
