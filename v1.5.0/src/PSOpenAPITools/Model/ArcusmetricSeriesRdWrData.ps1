...
ArcusmetricSeriesRdWrData<PSCustomObject>
#>

function Initialize-ArcusmetricSeriesRdWrData {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ArcusmetricSeriesRdWrData' | Write-Debug
...
Convert from JSON to ArcusmetricSeriesRdWrData<PSCustomObject>
...
ArcusmetricSeriesRdWrData<PSCustomObject>
#>
function ConvertFrom-JsonToArcusmetricSeriesRdWrData {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ArcusmetricSeriesRdWrData' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ArcusmetricSeriesRdWrData
