...
NodeBatteriesList<PSCustomObject>
#>

function Initialize-NodeBatteriesList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => NodeBatteriesList' | Write-Debug
...
Convert from JSON to NodeBatteriesList<PSCustomObject>
...
NodeBatteriesList<PSCustomObject>
#>
function ConvertFrom-JsonToNodeBatteriesList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => NodeBatteriesList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NodeBatteriesList
        $AllProperties = ("associatedLinks", "chargeLevel", "customerId", "dischargeLED", "displayname", "domain", "expirationDate", "faultLED", "fullyCharged", "generation", "id", "life", "locateEnabled", "manufacturing", "maxLife", "name", "nodeBatteryId", "powerSupplyId", "primaryNodeId", "resourceUri", "safeToRemove", "secondaryNodeId", "serviceLED", "state", "statusLED", "systemId", "testInProgress", "timeToCharge", "type")
