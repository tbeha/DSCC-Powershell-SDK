...
ArcusenclosureSledDetails<PSCustomObject>
#>

function Initialize-ArcusenclosureSledDetails {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ArcusenclosureSledDetails' | Write-Debug
...
Convert from JSON to ArcusenclosureSledDetails<PSCustomObject>
...
ArcusenclosureSledDetails<PSCustomObject>
#>
function ConvertFrom-JsonToArcusenclosureSledDetails {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ArcusenclosureSledDetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ArcusenclosureSledDetails
        $AllProperties = ("associatedLinks", "consoleUri", "customerId", "dc4data", "diskCount", "displayname", "domain", "elementStatusCode", "enclosureId", "enclosureName", "enclosureType", "enclosureUid", "failIndicator", "generation", "id", "locateEnabled", "manufacturing", "name", "okIndicator", "portBypassA", "portBypassB", "power", "predFailIndicator", "protocol", "requestUri", "resourceUri", "safeToRemove", "sledId", "stateLoopA", "stateLoopB", "systemId", "temperature", "type", "wwn")
