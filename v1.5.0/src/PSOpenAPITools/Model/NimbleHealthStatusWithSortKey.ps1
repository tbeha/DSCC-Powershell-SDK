...
NimbleHealthStatusWithSortKey<PSCustomObject>
#>

function Initialize-NimbleHealthStatusWithSortKey {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => NimbleHealthStatusWithSortKey' | Write-Debug
...
Convert from JSON to NimbleHealthStatusWithSortKey<PSCustomObject>
...
NimbleHealthStatusWithSortKey<PSCustomObject>
#>
function ConvertFrom-JsonToNimbleHealthStatusWithSortKey {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => NimbleHealthStatusWithSortKey' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NimbleHealthStatusWithSortKey
