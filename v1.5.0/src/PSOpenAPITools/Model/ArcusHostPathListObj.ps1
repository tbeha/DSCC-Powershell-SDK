...
ArcusHostPathListObj<PSCustomObject>
#>

function Initialize-ArcusHostPathListObj {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ArcusHostPathListObj' | Write-Debug
...
Convert from JSON to ArcusHostPathListObj<PSCustomObject>
...
ArcusHostPathListObj<PSCustomObject>
#>
function ConvertFrom-JsonToArcusHostPathListObj {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ArcusHostPathListObj' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ArcusHostPathListObj
