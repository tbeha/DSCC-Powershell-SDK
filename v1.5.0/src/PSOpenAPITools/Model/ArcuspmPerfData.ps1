...
ArcuspmPerfData<PSCustomObject>
#>

function Initialize-ArcuspmPerfData {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ArcuspmPerfData' | Write-Debug
...
Convert from JSON to ArcuspmPerfData<PSCustomObject>
...
ArcuspmPerfData<PSCustomObject>
#>
function ConvertFrom-JsonToArcuspmPerfData {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ArcuspmPerfData' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ArcuspmPerfData
