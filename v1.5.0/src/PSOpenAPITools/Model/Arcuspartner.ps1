...
Arcuspartner<PSCustomObject>
#>

function Initialize-Arcuspartner {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => Arcuspartner' | Write-Debug
...
Convert from JSON to Arcuspartner<PSCustomObject>
...
Arcuspartner<PSCustomObject>
#>
function ConvertFrom-JsonToArcuspartner {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => Arcuspartner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Arcuspartner
