...
CertificatesSummaryList<PSCustomObject>
#>

function Initialize-CertificatesSummaryList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => CertificatesSummaryList' | Write-Debug
...
Convert from JSON to CertificatesSummaryList<PSCustomObject>
...
CertificatesSummaryList<PSCustomObject>
#>
function ConvertFrom-JsonToCertificatesSummaryList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => CertificatesSummaryList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in CertificatesSummaryList
