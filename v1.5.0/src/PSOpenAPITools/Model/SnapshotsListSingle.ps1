...
SnapshotsListSingle<PSCustomObject>
#>

function Initialize-SnapshotsListSingle {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => SnapshotsListSingle' | Write-Debug
...
Convert from JSON to SnapshotsListSingle<PSCustomObject>
...
SnapshotsListSingle<PSCustomObject>
#>
function ConvertFrom-JsonToSnapshotsListSingle {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => SnapshotsListSingle' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in SnapshotsListSingle
        $AllProperties = ("adminAllocationSettings", "adminSpace", "baseId", "comment", "compactEfficiency", "compressionEfficiency", "compressionPolicy", "consoleUri", "conversionType", "copiedMB", "copiedPerc", "copyOfID", "creationTime", "customerId", "dataReduction", "ddcSize", "ddsSize", "dedup", "dedupSavingsSize", "dedupWrittenSize", "devType", "displayname", "domain", "efficiencyUpdateTime", "expirationTime", "fullyProvisioned", "generation", "headsPerCylinder", "healthState", "hidden", "hostWrittenMiB", "hostWrittenToVirtualPercent", "id", "initiators", "name", "parentID", "physParentID", "physicalCopy", "policy", "provType", "raid", "rcopyStatus", "readOnly", "retentionTime", "roChildID", "rwChildID", "sectorsPerTrack", "sharedParentId", "sizeMiB", "snapshotAllocLimit", "snapshotAllocWarning", "snapshotAllocationSettings", "snapshotCpgID", "snapshotCpgName", "snapshotId", "snapshotSpace", "snapshotTdvvSize", "snapshotType", "snapshotUsedToVirtualPercent", "spaceCalculationTime", "started", "state", "systemId", "thinProvisioned", "totalRawReservedMiB", "totalReservedMiB", "totalSpaceMiB", "type", "unrefSpaceFreedTime", "usedCapacity", "usedSizeMiB", "userAllocLimit", "userAllocWarning", "userAllocationSettings", "userCpgID", "userCpgName", "userReservedToVirtualPercent", "userSpace", "userUsedToVirtualPercent", "vlunSectorSize", "wwn")
