...
ArcushostProximityDetail<PSCustomObject>
#>

function Initialize-ArcushostProximityDetail {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ArcushostProximityDetail' | Write-Debug
...
Convert from JSON to ArcushostProximityDetail<PSCustomObject>
...
ArcushostProximityDetail<PSCustomObject>
#>
function ConvertFrom-JsonToArcushostProximityDetail {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ArcushostProximityDetail' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ArcushostProximityDetail
