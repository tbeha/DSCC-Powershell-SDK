...
ArcusRemoteCopyLink<PSCustomObject>
#>

function Initialize-ArcusRemoteCopyLink {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ArcusRemoteCopyLink' | Write-Debug
...
Convert from JSON to ArcusRemoteCopyLink<PSCustomObject>
...
ArcusRemoteCopyLink<PSCustomObject>
#>
function ConvertFrom-JsonToArcusRemoteCopyLink {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ArcusRemoteCopyLink' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ArcusRemoteCopyLink
