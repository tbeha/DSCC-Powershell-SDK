...
function ConvertFrom-JsonToArcusVolumeDetailsList {
    ...
    Process {
        ...
        $AllProperties = ("adminAllocationSettings", "associatedLinks", "baseId", "comment", "compressionPolicy", "consoleUri", "conversionType", "copyOfID", "creationTime", "customerId", "dataReduction", "dedup", "devType", "displayname", "domain", "efficiencyUpdateTime", "expirationTime", "fullyProvisioned", "generation", "headsPerCylinder", "healthState", "hidden", "id", "initiators", "name", "parentID", "physParentID", "physicalCopy", "policy", "provType", "raid", "rcopyStatus", "readOnly", "resourceUri", "retentionTime", "roChildID", "rwChildID", "sectorsPerTrack", "sharedParentId", "snapShotTier", "snapshotAllocLimit", "snapshotAllocWarning", "snapshotAllocationSettings", "spaceCalculationTime", "started", "state", "storageTier", "systemId", "thinProvisioned", "type", "unrefSpaceFreedTime", "userAllocLimit", "userAllocWarning", "userAllocationSettings", "userCpgID", "userCpgName", "vlunSectorSize", "volumeCapacity", "volumeId", "volumePerformance", "volumeType", "wwn")
