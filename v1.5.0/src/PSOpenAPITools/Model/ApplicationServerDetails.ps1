...
function ConvertFrom-JsonToApplicationServerDetails {
    ...
    Process {
        ...
        $AllProperties = ("requestUri", "hostname", "id", "name", "server_type", "associated_links", "consoleUri", "creation_time", "customerId", "description", "generation", "last_modified", "metadata", "port", "resourceUri", "type", "username")
