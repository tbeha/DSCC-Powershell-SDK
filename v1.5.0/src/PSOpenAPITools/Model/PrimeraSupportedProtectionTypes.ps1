...
PrimeraSupportedProtectionTypes<PSCustomObject>
#>

function Initialize-PrimeraSupportedProtectionTypes {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PrimeraSupportedProtectionTypes' | Write-Debug
...
Convert from JSON to PrimeraSupportedProtectionTypes<PSCustomObject>
...
PrimeraSupportedProtectionTypes<PSCustomObject>
#>
function ConvertFrom-JsonToPrimeraSupportedProtectionTypes {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PrimeraSupportedProtectionTypes' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PrimeraSupportedProtectionTypes
