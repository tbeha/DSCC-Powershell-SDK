...
Arcuspolicy<PSCustomObject>
#>

function Initialize-Arcuspolicy {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => Arcuspolicy' | Write-Debug
...
Convert from JSON to Arcuspolicy<PSCustomObject>
...
Arcuspolicy<PSCustomObject>
#>
function ConvertFrom-JsonToArcuspolicy {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => Arcuspolicy' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Arcuspolicy
