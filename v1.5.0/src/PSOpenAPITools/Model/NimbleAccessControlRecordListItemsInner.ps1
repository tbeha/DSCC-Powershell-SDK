...
Access protocol of the volume. Possible values:'iscsi', 'fc'. `Filter, Sort`
.PARAMETER ChapUserId
Identifier for the CHAP user. `Filter, Sort`
.PARAMETER ChapUserName
Flag denoting if data in the associated volume should be compressed. `Filter, Sort`
.PARAMETER CreationTime
Time when this access control record was created. `Filter, Sort`
.PARAMETER Id
Identifier for the access control record. `Filter`
.PARAMETER InitiatorGroupId
Identifier for the initiator group. `Filter, Sort`
.PARAMETER InitiatorGroupName
Name of the initiator group. `Filter, Sort` (this argument is deprecated)
.PARAMETER LastModified
Time when this access control record was last modified. `Filter, Sort`
.PARAMETER Lun
...
.PARAMETER PeId
Identifier for the protocol endpoint this access control record applies to. `Filter, Sort`
.PARAMETER PeLun
LUN (Logical Unit Number) to associate with this protocol endpoint. Valid LUNs are in the 0-2047 range. `Filter, Sort`
.PARAMETER PeName
Name of the protocol endpoint this access control record applies to. `Filter, Sort`
.PARAMETER SnapId
Identifier for the snapshot this access control record applies to. `Filter, Sort`
.PARAMETER SnapName
Name of the snapshot this access control record applies to. `Filter, Sort`
.PARAMETER VolId
Identifier for the volume this access control record applies to. `Filter, Sort`
.PARAMETER VolName
Name of the volume this access control record applies to. `Filter, Sort`
.PARAMETER ApplyTo
...
NimbleAccessControlRecordListItemsInner<PSCustomObject>
#>

function Initialize-NimbleAccessControlRecordListItemsInner {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => NimbleAccessControlRecordListItemsInner' | Write-Debug
...
Convert from JSON to NimbleAccessControlRecordListItemsInner<PSCustomObject>
...
NimbleAccessControlRecordListItemsInner<PSCustomObject>
#>
function ConvertFrom-JsonToNimbleAccessControlRecordListItemsInner {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => NimbleAccessControlRecordListItemsInner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NimbleAccessControlRecordListItemsInner
        $AllProperties = ("access_protocol", "chap_user_id", "chap_user_name", "creation_time", "id", "initiator_group_id", "initiator_group_name", "last_modified", "lun", "pe_id", "pe_lun", "pe_name", "snap_id", "snap_name", "vol_id", "vol_name", "apply_to", "associated_links", "consoleUri", "customerId", "generation", "pe_ids", "resourceUri", "snapluns", "type", "vol_agent_type")
