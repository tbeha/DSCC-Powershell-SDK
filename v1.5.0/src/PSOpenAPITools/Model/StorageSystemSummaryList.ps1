...
StorageSystemSummaryList<PSCustomObject>
#>

function Initialize-StorageSystemSummaryList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => StorageSystemSummaryList' | Write-Debug
...
Convert from JSON to StorageSystemSummaryList<PSCustomObject>
...
StorageSystemSummaryList<PSCustomObject>
#>
function ConvertFrom-JsonToStorageSystemSummaryList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => StorageSystemSummaryList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in StorageSystemSummaryList
