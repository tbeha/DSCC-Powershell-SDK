...
function ConvertFrom-JsonToNimbleSnapCollSnapshot {
    ...
    Process {
        ...
        $AllProperties = ("expiry_time", "id", "name", "schedule_id", "schedule_name", "snap_collection_id", "snap_collection_name", "vol_id", "vol_name", "volume_creator_id", "volume_creator_name")
