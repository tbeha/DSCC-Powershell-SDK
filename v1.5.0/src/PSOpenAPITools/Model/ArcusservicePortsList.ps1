...
requestUri for detailed volume set object
.PARAMETER Total
Number of serviceports.
.OUTPUTS

ArcusservicePortsList<PSCustomObject>
#>

function Initialize-ArcusservicePortsList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ArcusservicePortsList' | Write-Debug
...
Convert from JSON to ArcusservicePortsList<PSCustomObject>
...
ArcusservicePortsList<PSCustomObject>
#>
function ConvertFrom-JsonToArcusservicePortsList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ArcusservicePortsList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ArcusservicePortsList
