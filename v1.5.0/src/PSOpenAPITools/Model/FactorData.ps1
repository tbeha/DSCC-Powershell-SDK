...
FactorData<PSCustomObject>
#>

function Initialize-FactorData {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => FactorData' | Write-Debug
...
Convert from JSON to FactorData<PSCustomObject>
...
FactorData<PSCustomObject>
#>
function ConvertFrom-JsonToFactorData {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => FactorData' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in FactorData
