...
ArcusPortPositionInput<PSCustomObject>
#>

function Initialize-ArcusPortPositionInput {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ArcusPortPositionInput' | Write-Debug
...
Convert from JSON to ArcusPortPositionInput<PSCustomObject>
...
ArcusPortPositionInput<PSCustomObject>
#>
function ConvertFrom-JsonToArcusPortPositionInput {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ArcusPortPositionInput' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ArcusPortPositionInput
