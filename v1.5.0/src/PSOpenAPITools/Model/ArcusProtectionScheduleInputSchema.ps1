...
ArcusProtectionScheduleInputSchema<PSCustomObject>
#>

function Initialize-ArcusProtectionScheduleInputSchema {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ArcusProtectionScheduleInputSchema' | Write-Debug
...
Convert from JSON to ArcusProtectionScheduleInputSchema<PSCustomObject>
...
ArcusProtectionScheduleInputSchema<PSCustomObject>
#>
function ConvertFrom-JsonToArcusProtectionScheduleInputSchema {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ArcusProtectionScheduleInputSchema' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ArcusProtectionScheduleInputSchema
