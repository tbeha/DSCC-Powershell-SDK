...
ApplicationServer<PSCustomObject>
#>

function Initialize-ApplicationServer {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ApplicationServer' | Write-Debug
...
Convert from JSON to ApplicationServer<PSCustomObject>
...
ApplicationServer<PSCustomObject>
#>
function ConvertFrom-JsonToApplicationServer {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ApplicationServer' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ApplicationServer
        $AllProperties = ("hostname", "id", "name", "server_type", "associated_links", "consoleUri", "creation_time", "customerId", "description", "generation", "last_modified", "metadata", "port", "resourceUri", "type", "username")
