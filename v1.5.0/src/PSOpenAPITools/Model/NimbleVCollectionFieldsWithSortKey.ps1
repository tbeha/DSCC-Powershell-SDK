...
NimbleVCollectionFieldsWithSortKey<PSCustomObject>
#>

function Initialize-NimbleVCollectionFieldsWithSortKey {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => NimbleVCollectionFieldsWithSortKey' | Write-Debug
...
Convert from JSON to NimbleVCollectionFieldsWithSortKey<PSCustomObject>
...
NimbleVCollectionFieldsWithSortKey<PSCustomObject>
#>
function ConvertFrom-JsonToNimbleVCollectionFieldsWithSortKey {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => NimbleVCollectionFieldsWithSortKey' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NimbleVCollectionFieldsWithSortKey
