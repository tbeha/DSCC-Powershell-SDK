...
NimbleStorageSystemSummaryListItemsInner<PSCustomObject>
#>

function Initialize-NimbleStorageSystemSummaryListItemsInner {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => NimbleStorageSystemSummaryListItemsInner' | Write-Debug
...
Convert from JSON to NimbleStorageSystemSummaryListItemsInner<PSCustomObject>
...
NimbleStorageSystemSummaryListItemsInner<PSCustomObject>
#>
function ConvertFrom-JsonToNimbleStorageSystemSummaryListItemsInner {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
