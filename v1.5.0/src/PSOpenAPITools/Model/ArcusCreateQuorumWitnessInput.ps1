...
ArcusCreateQuorumWitnessInput<PSCustomObject>
#>

function Initialize-ArcusCreateQuorumWitnessInput {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ArcusCreateQuorumWitnessInput' | Write-Debug
...
Convert from JSON to ArcusCreateQuorumWitnessInput<PSCustomObject>
...
ArcusCreateQuorumWitnessInput<PSCustomObject>
#>
function ConvertFrom-JsonToArcusCreateQuorumWitnessInput {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ArcusCreateQuorumWitnessInput' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ArcusCreateQuorumWitnessInput
