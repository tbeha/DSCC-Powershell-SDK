...
ArcusReplicationPartnerVolumeList<PSCustomObject>
#>

function Initialize-ArcusReplicationPartnerVolumeList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ArcusReplicationPartnerVolumeList' | Write-Debug
...
Convert from JSON to ArcusReplicationPartnerVolumeList<PSCustomObject>
...
ArcusReplicationPartnerVolumeList<PSCustomObject>
#>
function ConvertFrom-JsonToArcusReplicationPartnerVolumeList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ArcusReplicationPartnerVolumeList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ArcusReplicationPartnerVolumeList
