...
NimblecapacityHistory<PSCustomObject>
#>

function Initialize-NimblecapacityHistory {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => NimblecapacityHistory' | Write-Debug
...
Convert from JSON to NimblecapacityHistory<PSCustomObject>
...
NimblecapacityHistory<PSCustomObject>
#>
function ConvertFrom-JsonToNimblecapacityHistory {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => NimblecapacityHistory' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NimblecapacityHistory
