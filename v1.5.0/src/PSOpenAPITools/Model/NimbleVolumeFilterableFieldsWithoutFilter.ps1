...
NimbleVolumeFilterableFieldsWithoutFilter<PSCustomObject>
#>

function Initialize-NimbleVolumeFilterableFieldsWithoutFilter {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => NimbleVolumeFilterableFieldsWithoutFilter' | Write-Debug
...
Convert from JSON to NimbleVolumeFilterableFieldsWithoutFilter<PSCustomObject>
...
NimbleVolumeFilterableFieldsWithoutFilter<PSCustomObject>
#>
function ConvertFrom-JsonToNimbleVolumeFilterableFieldsWithoutFilter {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => NimbleVolumeFilterableFieldsWithoutFilter' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NimbleVolumeFilterableFieldsWithoutFilter
