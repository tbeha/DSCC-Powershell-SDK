...
SysPortManagement<PSCustomObject>
#>

function Initialize-SysPortManagement {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => SysPortManagement' | Write-Debug
...
Convert from JSON to SysPortManagement<PSCustomObject>
...
SysPortManagement<PSCustomObject>
#>
function ConvertFrom-JsonToSysPortManagement {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => SysPortManagement' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in SysPortManagement
