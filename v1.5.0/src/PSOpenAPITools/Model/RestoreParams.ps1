...
function Initialize-RestoreParams {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => RestoreParams' | Write-Debug
...
Convert from JSON to RestoreParams<PSCustomObject>
...
RestoreParams<PSCustomObject>
#>
function ConvertFrom-JsonToRestoreParams {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => RestoreParams' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in RestoreParams
