...
function Initialize-Snmp {
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => Snmp' | Write-Debug
...
Convert from JSON to Snmp<PSCustomObject>
...
Snmp<PSCustomObject>
#>
function ConvertFrom-JsonToSnmp {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => Snmp' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Snmp
