...
.PARAMETER PageLimit
The limit specified in the limit query parameter.
...
function Initialize-AuditResults {
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => AuditResults' | Write-Debug
...
Convert from JSON to AuditResults<PSCustomObject>
...
AuditResults<PSCustomObject>
#>
function ConvertFrom-JsonToAuditResults {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => AuditResults' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in AuditResults
