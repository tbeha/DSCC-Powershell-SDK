...
.PARAMETER Total
Total Number of volume sets.
.OUTPUTS

FleetVolumeSetList<PSCustomObject>
#>

function Initialize-FleetVolumeSetList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => FleetVolumeSetList' | Write-Debug
...
Convert from JSON to FleetVolumeSetList<PSCustomObject>
...
FleetVolumeSetList<PSCustomObject>
#>
function ConvertFrom-JsonToFleetVolumeSetList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => FleetVolumeSetList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in FleetVolumeSetList
