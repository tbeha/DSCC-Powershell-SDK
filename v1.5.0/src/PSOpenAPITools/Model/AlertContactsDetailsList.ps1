...
AlertContactsDetailsList<PSCustomObject>
#>

function Initialize-AlertContactsDetailsList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => AlertContactsDetailsList' | Write-Debug
...
Convert from JSON to AlertContactsDetailsList<PSCustomObject>
...
AlertContactsDetailsList<PSCustomObject>
#>
function ConvertFrom-JsonToAlertContactsDetailsList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => AlertContactsDetailsList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in AlertContactsDetailsList
