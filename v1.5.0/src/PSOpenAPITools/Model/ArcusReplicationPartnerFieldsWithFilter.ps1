...
ArcusReplicationPartnerFieldsWithFilter<PSCustomObject>
#>

function Initialize-ArcusReplicationPartnerFieldsWithFilter {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ArcusReplicationPartnerFieldsWithFilter' | Write-Debug
...
Convert from JSON to ArcusReplicationPartnerFieldsWithFilter<PSCustomObject>
...
ArcusReplicationPartnerFieldsWithFilter<PSCustomObject>
#>
function ConvertFrom-JsonToArcusReplicationPartnerFieldsWithFilter {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ArcusReplicationPartnerFieldsWithFilter' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ArcusReplicationPartnerFieldsWithFilter
