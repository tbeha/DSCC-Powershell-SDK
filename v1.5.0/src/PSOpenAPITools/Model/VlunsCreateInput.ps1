...
VlunsCreateInput<PSCustomObject>
#>

function Initialize-VlunsCreateInput {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => VlunsCreateInput' | Write-Debug
...
Convert from JSON to VlunsCreateInput<PSCustomObject>
...
VlunsCreateInput<PSCustomObject>
#>
function ConvertFrom-JsonToVlunsCreateInput {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => VlunsCreateInput' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in VlunsCreateInput
        $AllProperties = ("LUN", "autoLun", "hostGroupIds", "maxAutoLun", "noVcn", "override", "position", "proximity")
