...
ArcusAlertContactsDetails<PSCustomObject>
#>

function Initialize-ArcusAlertContactsDetails {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ArcusAlertContactsDetails' | Write-Debug
...
Convert from JSON to ArcusAlertContactsDetails<PSCustomObject>
...
ArcusAlertContactsDetails<PSCustomObject>
#>
function ConvertFrom-JsonToArcusAlertContactsDetails {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ArcusAlertContactsDetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ArcusAlertContactsDetails
