...
CapacityHistory<PSCustomObject>
#>

function Initialize-CapacityHistory {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => CapacityHistory' | Write-Debug
...
Convert from JSON to CapacityHistory<PSCustomObject>
...
CapacityHistory<PSCustomObject>
#>
function ConvertFrom-JsonToCapacityHistory {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => CapacityHistory' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in CapacityHistory
