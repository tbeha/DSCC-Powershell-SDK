...
ArcusHostSetListObj<PSCustomObject>
#>

function Initialize-ArcusHostSetListObj {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ArcusHostSetListObj' | Write-Debug
...
Convert from JSON to ArcusHostSetListObj<PSCustomObject>
...
ArcusHostSetListObj<PSCustomObject>
#>
function ConvertFrom-JsonToArcusHostSetListObj {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ArcusHostSetListObj' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ArcusHostSetListObj
