...
PrimeraPoolDetails<PSCustomObject>
#>

function Initialize-PrimeraPoolDetails {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PrimeraPoolDetails' | Write-Debug
...
Convert from JSON to PrimeraPoolDetails<PSCustomObject>
...
PrimeraPoolDetails<PSCustomObject>
#>
function ConvertFrom-JsonToPrimeraPoolDetails {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PrimeraPoolDetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PrimeraPoolDetails
        $AllProperties = ("alert", "allocationSettings", "aoConfigID", "associatedLinks", "baseSizeMiB", "baseSizePrivateMiB", "baseSizeRawMiB", "compactRatio", "compressRatio", "customerId", "dataReduceRatio", "dedupCapable", "dedupRatio", "dedupVersion", "displayname", "domain", "freeForAllocationMiB", "freeSizeMiB", "freeSizeRawMiB", "generation", "id", "name", "numberOfSnapRC", "numberOfTDVV", "numberOfTPVV", "numberOfUserRC", "overProvRatio", "requestUri", "resourceUri", "saGrow", "sdGrow", "sharedSizeMiB", "snapSizePrivateMiB", "snapSizeRawMiB", "snapSpaceAdmin", "snapSpaceData", "state", "storagePoolId", "systemId", "totalReservedMiB", "totalSizeMiB", "totalSizeRawMiB", "type", "userSpace", "warnPercent")
