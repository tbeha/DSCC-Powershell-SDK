...
EditNetworkSettingsInputProxyParams<PSCustomObject>
#>

function Initialize-EditNetworkSettingsInputProxyParams {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => EditNetworkSettingsInputProxyParams' | Write-Debug
...
Convert from JSON to EditNetworkSettingsInputProxyParams<PSCustomObject>
...
EditNetworkSettingsInputProxyParams<PSCustomObject>
#>
function ConvertFrom-JsonToEditNetworkSettingsInputProxyParams {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => EditNetworkSettingsInputProxyParams' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in EditNetworkSettingsInputProxyParams
