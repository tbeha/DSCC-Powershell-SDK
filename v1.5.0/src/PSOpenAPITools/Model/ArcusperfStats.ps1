...
ArcusperfStats<PSCustomObject>
#>

function Initialize-ArcusperfStats {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ArcusperfStats' | Write-Debug
...
Convert from JSON to ArcusperfStats<PSCustomObject>
...
ArcusperfStats<PSCustomObject>
#>
function ConvertFrom-JsonToArcusperfStats {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ArcusperfStats' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ArcusperfStats
