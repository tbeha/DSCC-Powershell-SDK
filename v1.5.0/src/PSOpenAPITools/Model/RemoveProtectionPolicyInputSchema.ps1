...
RemoveProtectionPolicyInputSchema<PSCustomObject>
#>

function Initialize-RemoveProtectionPolicyInputSchema {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => RemoveProtectionPolicyInputSchema' | Write-Debug
...
Convert from JSON to RemoveProtectionPolicyInputSchema<PSCustomObject>
...
RemoveProtectionPolicyInputSchema<PSCustomObject>
#>
function ConvertFrom-JsonToRemoveProtectionPolicyInputSchema {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => RemoveProtectionPolicyInputSchema' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in RemoveProtectionPolicyInputSchema
