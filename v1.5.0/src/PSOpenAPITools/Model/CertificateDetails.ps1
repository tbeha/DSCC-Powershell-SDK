...
function Initialize-CertificateDetails {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => CertificateDetails' | Write-Debug
...
Convert from JSON to CertificateDetails<PSCustomObject>
...
CertificateDetails<PSCustomObject>
#>
function ConvertFrom-JsonToCertificateDetails {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => CertificateDetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in CertificateDetails
