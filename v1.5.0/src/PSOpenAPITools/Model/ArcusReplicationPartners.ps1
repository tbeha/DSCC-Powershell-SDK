...
ArcusReplicationPartners<PSCustomObject>
#>

function Initialize-ArcusReplicationPartners {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ArcusReplicationPartners' | Write-Debug
...
Convert from JSON to ArcusReplicationPartners<PSCustomObject>
...
ArcusReplicationPartners<PSCustomObject>
#>
function ConvertFrom-JsonToArcusReplicationPartners {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ArcusReplicationPartners' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ArcusReplicationPartners
