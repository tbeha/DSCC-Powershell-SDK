...
function ConvertFrom-JsonToArcusnodesList {
    ...
    Process {
        ...
        $AllProperties = ("associatedLinks", "customerId", "displayname", "domain", "enclosureCardId", "enclosureCardUid", "enclosureId", "enclosureUid", "generation", "id", "inCluster", "kernelVersion", "master", "memoryMiB", "name", "nodeId", "online", "resourceUri", "state", "systemId", "type", "uptime")
