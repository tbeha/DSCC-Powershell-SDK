...
function ConvertFrom-JsonToArcusSnapshotCapacity {
    ...
    Process {
        ...
        $AllProperties = ("adminSpace", "branchUsedBlocksMiB", "branchVSizeMiB", "compactEfficiency", "compressionEfficiency", "copiedMB", "copiedPerc", "ddcSize", "ddsSize", "dedupSavingsSize", "dedupWrittenSize", "hostWrittenMiB", "hostWrittenToVirtualPercent", "sizeMiB", "snapshotTdvvSize", "snapshotUsedToVirtualPercent", "totalRawReservedMiB", "totalReservedMiB", "totalSpaceMiB", "usedBlocksMiB", "usedCapacity", "usedSizeMiB", "userReservedToVirtualPercent", "userSpace", "userUsedToVirtualPercent")
