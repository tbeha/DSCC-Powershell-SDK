...
ArcushistoryData<PSCustomObject>
#>

function Initialize-ArcushistoryData {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ArcushistoryData' | Write-Debug
...
Convert from JSON to ArcushistoryData<PSCustomObject>
...
ArcushistoryData<PSCustomObject>
#>
function ConvertFrom-JsonToArcushistoryData {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ArcushistoryData' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ArcushistoryData
