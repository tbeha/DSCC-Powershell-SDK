...
VolumePut<PSCustomObject>
#>

function Initialize-VolumePut {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => VolumePut' | Write-Debug
...
Convert from JSON to VolumePut<PSCustomObject>
...
VolumePut<PSCustomObject>
#>
function ConvertFrom-JsonToVolumePut {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => VolumePut' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in VolumePut
