...
DisksSummaryList<PSCustomObject>
#>

function Initialize-DisksSummaryList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => DisksSummaryList' | Write-Debug
...
Convert from JSON to DisksSummaryList<PSCustomObject>
...
DisksSummaryList<PSCustomObject>
#>
function ConvertFrom-JsonToDisksSummaryList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => DisksSummaryList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in DisksSummaryList
