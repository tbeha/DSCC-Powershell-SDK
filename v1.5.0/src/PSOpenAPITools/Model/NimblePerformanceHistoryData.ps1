...
NimblePerformanceHistoryData<PSCustomObject>
#>

function Initialize-NimblePerformanceHistoryData {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => NimblePerformanceHistoryData' | Write-Debug
...
Convert from JSON to NimblePerformanceHistoryData<PSCustomObject>
...
NimblePerformanceHistoryData<PSCustomObject>
#>
function ConvertFrom-JsonToNimblePerformanceHistoryData {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => NimblePerformanceHistoryData' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NimblePerformanceHistoryData
