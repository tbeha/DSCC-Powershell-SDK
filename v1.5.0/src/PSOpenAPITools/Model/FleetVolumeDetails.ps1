...
FleetVolumeDetails<PSCustomObject>
#>

function Initialize-FleetVolumeDetails {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => FleetVolumeDetails' | Write-Debug
...
Convert from JSON to FleetVolumeDetails<PSCustomObject>
...
FleetVolumeDetails<PSCustomObject>
#>
function ConvertFrom-JsonToFleetVolumeDetails {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => FleetVolumeDetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in FleetVolumeDetails
        $AllProperties = ("associatedLinks", "consoleUri", "customerId", "generation", "healthState", "hostWrittenCapacityMiB", "id", "initiators", "isInternal", "isSystemVolume", "name", "productFamily", "requestUri", "resourceUri", "sizeMiB", "spaceWarning", "subType", "systemId", "thinSavings", "type", "usedCapacityPercent", "usedSizeMiB", "volumeSetId", "volumeType", "wwn")
