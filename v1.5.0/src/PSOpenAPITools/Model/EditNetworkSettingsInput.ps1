...
EditNetworkSettingsInput<PSCustomObject>
#>

function Initialize-EditNetworkSettingsInput {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => EditNetworkSettingsInput' | Write-Debug
...
Convert from JSON to EditNetworkSettingsInput<PSCustomObject>
...
EditNetworkSettingsInput<PSCustomObject>
#>
function ConvertFrom-JsonToEditNetworkSettingsInput {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => EditNetworkSettingsInput' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in EditNetworkSettingsInput
