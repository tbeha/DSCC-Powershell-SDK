...
ArcusenclosureCardDetails<PSCustomObject>
#>

function Initialize-ArcusenclosureCardDetails {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ArcusenclosureCardDetails' | Write-Debug
...
Convert from JSON to ArcusenclosureCardDetails<PSCustomObject>
...
ArcusenclosureCardDetails<PSCustomObject>
#>
function ConvertFrom-JsonToArcusenclosureCardDetails {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ArcusenclosureCardDetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ArcusenclosureCardDetails
        $AllProperties = ("associatedLinks", "consoleUri", "customerId", "dcsdata", "displayname", "domain", "elementStatusCode", "enclosureCardId", "enclosureId", "enclosureName", "enclosureType", "enclosureUid", "failIndicator", "generation", "id", "isNodeCard", "locateEnabled", "locateSevenSegDisplay", "loopA", "loopB", "manufacturing", "name", "requestUri", "resourceUri", "safeToRemove", "sevenSegDisplay", "state", "systemId", "type")
