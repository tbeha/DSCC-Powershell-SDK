...
HostGroupsList<PSCustomObject>
#>

function Initialize-HostGroupsList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => HostGroupsList' | Write-Debug
...
Convert from JSON to HostGroupsList<PSCustomObject>
...
HostGroupsList<PSCustomObject>
#>
function ConvertFrom-JsonToHostGroupsList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => HostGroupsList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in HostGroupsList
