...
EnclosureExpandersSummaryList<PSCustomObject>
#>

function Initialize-EnclosureExpandersSummaryList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => EnclosureExpandersSummaryList' | Write-Debug
...
Convert from JSON to EnclosureExpandersSummaryList<PSCustomObject>
...
EnclosureExpandersSummaryList<PSCustomObject>
#>
function ConvertFrom-JsonToEnclosureExpandersSummaryList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => EnclosureExpandersSummaryList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in EnclosureExpandersSummaryList
