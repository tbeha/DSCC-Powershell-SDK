...
EnclosuresList<PSCustomObject>
#>

function Initialize-EnclosuresList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => EnclosuresList' | Write-Debug
...
Convert from JSON to EnclosuresList<PSCustomObject>
...
EnclosuresList<PSCustomObject>
#>
function ConvertFrom-JsonToEnclosuresList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => EnclosuresList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in EnclosuresList
        $AllProperties = ("associatedLinks", "chainPosLoopA", "chainPosLoopB", "customerId", "dc4data", "dcsdata", "detailedState", "displayname", "domain", "enclosureId", "enclosureType", "errors", "failIndicator", "failRequested", "formFactor", "generation", "id", "locateEnabled", "location", "loopSplit", "manufacturing", "name", "nodeWwn", "resourceUri", "state", "subType", "systemId", "type", "warnIndicator", "warnRequested")
