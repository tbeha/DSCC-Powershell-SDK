...
requestUri for detailed volume objects
...
Originator id for the associated performance policy.
.PARAMETER PerfpolicyCreatorName
Originator name for the associated performance policy.
...
Originator id for the associated volume collection.
.PARAMETER VolcollCreatorName
Originator name for the associated volume collection.
.PARAMETER VolumeCreatorId
Originator id for the volume.
.PARAMETER VolumeCreatorName
Originator name for the volume.
.PARAMETER VpdIeee0
...
NimbleVolumeDetails<PSCustomObject>
#>

function Initialize-NimbleVolumeDetails {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => NimbleVolumeDetails' | Write-Debug
...
Convert from JSON to NimbleVolumeDetails<PSCustomObject>
...
NimbleVolumeDetails<PSCustomObject>
#>
function ConvertFrom-JsonToNimbleVolumeDetails {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
