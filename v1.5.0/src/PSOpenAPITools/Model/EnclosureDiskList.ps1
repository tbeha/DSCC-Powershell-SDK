...
EnclosureDiskList<PSCustomObject>
#>

function Initialize-EnclosureDiskList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => EnclosureDiskList' | Write-Debug
...
Convert from JSON to EnclosureDiskList<PSCustomObject>
...
EnclosureDiskList<PSCustomObject>
#>
function ConvertFrom-JsonToEnclosureDiskList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => EnclosureDiskList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in EnclosureDiskList
        $AllProperties = ("associatedLinks", "customerId", "dc4data", "dcsdata", "displayname", "domain", "enclosureDeviceId", "enclosureId", "enclosureName", "enclosureType", "generation", "id", "loopA", "loopB", "manufacturing", "name", "position", "resourceUri", "systemId", "temperature", "type", "wwn")
