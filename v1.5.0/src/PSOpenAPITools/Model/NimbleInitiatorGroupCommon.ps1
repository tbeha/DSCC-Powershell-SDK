...
Total number of connections from initiators in the initiator group. (This field is deprecated)
...
Number of volumes that are accessible by the initiator group. (This field is deprecated)
.PARAMETER VolumeList
List of volumes that are accessible by the initiator group. List of volumes. (This field is deprecated)
.OUTPUTS

NimbleInitiatorGroupCommon<PSCustomObject>
#>

function Initialize-NimbleInitiatorGroupCommon {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => NimbleInitiatorGroupCommon' | Write-Debug
...
Convert from JSON to NimbleInitiatorGroupCommon<PSCustomObject>
...
NimbleInitiatorGroupCommon<PSCustomObject>
#>
function ConvertFrom-JsonToNimbleInitiatorGroupCommon {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => NimbleInitiatorGroupCommon' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NimbleInitiatorGroupCommon
        $AllProperties = ("associatedLinks", "consoleUri", "creation_time", "customerId", "description", "fc_initiators", "fc_sessions", "fc_tdz_ports", "full_name", "generation", "iscsi_initiators", "last_modified", "metadata", "num_connections", "resourceUri", "sc_HostId", "search_name", "target_subnets", "type", "volume_count", "volume_list")
