...
SnmpDetails<PSCustomObject>
#>

function Initialize-SnmpDetails {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => SnmpDetails' | Write-Debug
...
Convert from JSON to SnmpDetails<PSCustomObject>
...
SnmpDetails<PSCustomObject>
#>
function ConvertFrom-JsonToSnmpDetails {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => SnmpDetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in SnmpDetails
