...
ArcussystemState<PSCustomObject>
#>

function Initialize-ArcussystemState {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ArcussystemState' | Write-Debug
...
Convert from JSON to ArcussystemState<PSCustomObject>
...
ArcussystemState<PSCustomObject>
#>
function ConvertFrom-JsonToArcussystemState {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ArcussystemState' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ArcussystemState
