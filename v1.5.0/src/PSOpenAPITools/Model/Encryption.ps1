...
function Initialize-Encryption {
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => Encryption' | Write-Debug
...
Convert from JSON to Encryption<PSCustomObject>
...
Encryption<PSCustomObject>
#>
function ConvertFrom-JsonToEncryption {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => Encryption' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Encryption
