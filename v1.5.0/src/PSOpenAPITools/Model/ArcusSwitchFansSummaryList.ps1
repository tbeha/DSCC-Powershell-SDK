...
ArcusSwitchFansSummaryList<PSCustomObject>
#>

function Initialize-ArcusSwitchFansSummaryList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ArcusSwitchFansSummaryList' | Write-Debug
...
Convert from JSON to ArcusSwitchFansSummaryList<PSCustomObject>
...
ArcusSwitchFansSummaryList<PSCustomObject>
#>
function ConvertFrom-JsonToArcusSwitchFansSummaryList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ArcusSwitchFansSummaryList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ArcusSwitchFansSummaryList
