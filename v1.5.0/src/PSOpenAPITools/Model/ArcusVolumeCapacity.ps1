...
function Initialize-ArcusVolumeCapacity {
    ...
    Process {
        ...
        $PSO = [PSCustomObject]@{
            ...
            "branchUsedBlocksMiB" = ${BranchUsedBlocksMiB}
...
function ConvertFrom-JsonToArcusVolumeCapacity {
    ...
    Process {
        ...
        $AllProperties = ("adminSpace", "branchUsedBlocksMiB", "branchVSizeMiB", "compactEfficiency", "compressionEfficiency", "copiedMB", "copiedPerc", "ddcSize", "ddsSize", "dedupSavingsSize", "dedupWrittenSize", "hostWrittenMiB", "hostWrittenToVirtualPercent", "sizeMiB", "snapshotTdvvSize", "snapshotUsedToVirtualPercent", "thinSavings", "totalRawReservedMiB", "totalReservedMiB", "totalSpaceMiB", "usedBlocksMiB", "usedCapacity", "usedSizeMiB", "userReservedToVirtualPercent", "userSpace", "userUsedToVirtualPercent")
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "branchUsedBlocksMiB"))) { #optional property not found
            $BranchUsedBlocksMiB = $null
        } else {
            $BranchUsedBlocksMiB = $JsonParameters.PSobject.Properties["branchUsedBlocksMiB"].value
        }
