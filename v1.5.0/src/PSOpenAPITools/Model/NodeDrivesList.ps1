...
NodeDrivesList<PSCustomObject>
#>

function Initialize-NodeDrivesList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => NodeDrivesList' | Write-Debug
...
Convert from JSON to NodeDrivesList<PSCustomObject>
...
NodeDrivesList<PSCustomObject>
#>
function ConvertFrom-JsonToNodeDrivesList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => NodeDrivesList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NodeDrivesList
        $AllProperties = ("associatedLinks", "customerId", "displayname", "domain", "fwVersion", "generation", "id", "manufacturing", "maxLBA", "name", "nodeDeviceId", "nodeDriveId", "nodeDriveType", "nodeId", "resourceUri", "sedState", "sizeMiB", "systemId", "type", "wwn")
