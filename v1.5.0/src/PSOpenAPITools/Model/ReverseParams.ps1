...
ReverseParams<PSCustomObject>
#>

function Initialize-ReverseParams {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ReverseParams' | Write-Debug
...
Convert from JSON to ReverseParams<PSCustomObject>
...
ReverseParams<PSCustomObject>
#>
function ConvertFrom-JsonToReverseParams {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ReverseParams' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ReverseParams
