...
PrimeraHostPathListObj<PSCustomObject>
#>

function Initialize-PrimeraHostPathListObj {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PrimeraHostPathListObj' | Write-Debug
...
Convert from JSON to PrimeraHostPathListObj<PSCustomObject>
...
PrimeraHostPathListObj<PSCustomObject>
#>
function ConvertFrom-JsonToPrimeraHostPathListObj {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PrimeraHostPathListObj' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PrimeraHostPathListObj
