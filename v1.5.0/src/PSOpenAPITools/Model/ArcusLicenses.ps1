...
requestUri for detailed licenses object
...
function ConvertFrom-JsonToArcusLicenses {
    ...
    Process {
        ...
        $AllProperties = ("associatedLinks", "consoleUri", "customerId", "diskCount", "features", "issueDate", "requestUri", "resourceUri", "type", "version")
