...
ArcusenclosureConnectorsList<PSCustomObject>
#>

function Initialize-ArcusenclosureConnectorsList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ArcusenclosureConnectorsList' | Write-Debug
...
Convert from JSON to ArcusenclosureConnectorsList<PSCustomObject>
...
ArcusenclosureConnectorsList<PSCustomObject>
#>
function ConvertFrom-JsonToArcusenclosureConnectorsList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ArcusenclosureConnectorsList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ArcusenclosureConnectorsList
        $AllProperties = ("associatedLinks", "connector", "currentSpeed", "customerId", "disabled", "displayname", "domain", "elementStatusCode", "enclosureCardId", "enclosureCardPCIUid", "enclosureCardUid", "enclosureId", "enclosureName", "enclosureUid", "generation", "id", "ipv4Address", "ipv6Address", "label", "linkSpeed", "locate", "macAddress", "nodePort", "resourceUri", "slot", "systemId", "type")
