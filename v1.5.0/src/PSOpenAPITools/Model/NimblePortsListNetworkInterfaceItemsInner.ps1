...
NimblePortsListNetworkInterfaceItemsInner<PSCustomObject>
#>

function Initialize-NimblePortsListNetworkInterfaceItemsInner {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => NimblePortsListNetworkInterfaceItemsInner' | Write-Debug
...
Convert from JSON to NimblePortsListNetworkInterfaceItemsInner<PSCustomObject>
...
NimblePortsListNetworkInterfaceItemsInner<PSCustomObject>
#>
function ConvertFrom-JsonToNimblePortsListNetworkInterfaceItemsInner {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => NimblePortsListNetworkInterfaceItemsInner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NimblePortsListNetworkInterfaceItemsInner
        $AllProperties = ("array_id", "controller_name", "id", "name", "array_name_or_serial", "controller_id", "ip_list", "is_present", "link_speed", "link_status", "mac", "max_link_speed", "mtu", "nic_type", "partial_response_ok", "port", "slot")
