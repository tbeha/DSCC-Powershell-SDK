...
ArcussnapshotsetsList<PSCustomObject>
#>

function Initialize-ArcussnapshotsetsList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ArcussnapshotsetsList' | Write-Debug
...
Convert from JSON to ArcussnapshotsetsList<PSCustomObject>
...
ArcussnapshotsetsList<PSCustomObject>
#>
function ConvertFrom-JsonToArcussnapshotsetsList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ArcussnapshotsetsList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ArcussnapshotsetsList
