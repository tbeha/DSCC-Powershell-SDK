...
NimbleReplicationPartnerDetails<PSCustomObject>
#>

function Initialize-NimbleReplicationPartnerDetails {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => NimbleReplicationPartnerDetails' | Write-Debug
...
Convert from JSON to NimbleReplicationPartnerDetails<PSCustomObject>
...
NimbleReplicationPartnerDetails<PSCustomObject>
#>
function ConvertFrom-JsonToNimbleReplicationPartnerDetails {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
