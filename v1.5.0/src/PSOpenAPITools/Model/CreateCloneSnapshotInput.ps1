...
CreateCloneSnapshotInput<PSCustomObject>
#>

function Initialize-CreateCloneSnapshotInput {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => CreateCloneSnapshotInput' | Write-Debug
...
Convert from JSON to CreateCloneSnapshotInput<PSCustomObject>
...
CreateCloneSnapshotInput<PSCustomObject>
#>
function ConvertFrom-JsonToCreateCloneSnapshotInput {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => CreateCloneSnapshotInput' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in CreateCloneSnapshotInput
        $AllProperties = ("autoLun", "destinationCpg", "destinationSnapshotCpg", "destinationVolume", "hostGroupId", "lun", "priority")
