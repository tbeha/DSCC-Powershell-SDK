...
No description available.
.PARAMETER RoChildID
RO child id. This field is deprecated.
.PARAMETER RwChildID
...
function ConvertFrom-JsonToPrimeraVolumeDetailsList {
    ...
    Process {
        ...
        $AllProperties = ("adminAllocationSettings", "adminSpace", "associatedLinks", "baseId", "comment", "compactEfficiency", "compressionEfficiency", "compressionPolicy", "consoleUri", "conversionType", "copiedMB", "copiedPerc", "copyOfID", "creationTime", "customerId", "dataReduction", "ddcSize", "ddsSize", "dedup", "dedupSavingsSize", "dedupWrittenSize", "devType", "displayname", "domain", "efficiencyUpdateTime", "expirationTime", "fullyProvisioned", "generation", "headsPerCylinder", "healthState", "hidden", "hostWrittenMiB", "hostWrittenToVirtualPercent", "id", "initiators", "name", "parentID", "physParentID", "physicalCopy", "policy", "provType", "raid", "rcopyStatus", "readOnly", "resourceUri", "retentionTime", "roChildID", "rwChildID", "sectorsPerTrack", "sharedParentId", "sizeMiB", "snapShotTier", "snapshotAllocLimit", "snapshotAllocWarning", "snapshotAllocationSettings", "snapshotCpgID", "snapshotCpgName", "snapshotSpace", "snapshotTdvvSize", "snapshotUsedToVirtualPercent", "spaceCalculationTime", "started", "state", "storageTier", "systemId", "thinProvisioned", "thinSavings", "totalRawReservedMiB", "totalReservedMiB", "totalSpaceMiB", "type", "unrefSpaceFreedTime", "usedCapacity", "usedSizeMiB", "userAllocLimit", "userAllocWarning", "userAllocationSettings", "userCpgID", "userCpgName", "userReservedToVirtualPercent", "userSpace", "userUsedToVirtualPercent", "vlunSectorSize", "volumeId", "volumePerformance", "volumeType", "wwn")
