...
AuditUserForbidden<PSCustomObject>
#>

function Initialize-AuditUserForbidden {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => AuditUserForbidden' | Write-Debug
...
Convert from JSON to AuditUserForbidden<PSCustomObject>
...
AuditUserForbidden<PSCustomObject>
#>
function ConvertFrom-JsonToAuditUserForbidden {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => AuditUserForbidden' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in AuditUserForbidden
