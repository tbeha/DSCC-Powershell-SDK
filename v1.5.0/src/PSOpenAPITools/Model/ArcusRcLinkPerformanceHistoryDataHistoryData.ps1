...
ArcusRcLinkPerformanceHistoryDataHistoryData<PSCustomObject>
#>

function Initialize-ArcusRcLinkPerformanceHistoryDataHistoryData {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ArcusRcLinkPerformanceHistoryDataHistoryData' | Write-Debug
...
Convert from JSON to ArcusRcLinkPerformanceHistoryDataHistoryData<PSCustomObject>
...
ArcusRcLinkPerformanceHistoryDataHistoryData<PSCustomObject>
#>
function ConvertFrom-JsonToArcusRcLinkPerformanceHistoryDataHistoryData {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ArcusRcLinkPerformanceHistoryDataHistoryData' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ArcusRcLinkPerformanceHistoryDataHistoryData
