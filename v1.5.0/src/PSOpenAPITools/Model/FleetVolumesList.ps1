...
FleetVolumesList<PSCustomObject>
#>

function Initialize-FleetVolumesList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => FleetVolumesList' | Write-Debug
...
Convert from JSON to FleetVolumesList<PSCustomObject>
...
FleetVolumesList<PSCustomObject>
#>
function ConvertFrom-JsonToFleetVolumesList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => FleetVolumesList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in FleetVolumesList
