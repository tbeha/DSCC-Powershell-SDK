...
ArcuscertificatesList<PSCustomObject>
#>

function Initialize-ArcuscertificatesList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ArcuscertificatesList' | Write-Debug
...
Convert from JSON to ArcuscertificatesList<PSCustomObject>
...
ArcuscertificatesList<PSCustomObject>
#>
function ConvertFrom-JsonToArcuscertificatesList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ArcuscertificatesList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ArcuscertificatesList
