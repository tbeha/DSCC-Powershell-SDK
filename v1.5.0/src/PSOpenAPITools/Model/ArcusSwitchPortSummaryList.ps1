...
ArcusSwitchPortSummaryList<PSCustomObject>
#>

function Initialize-ArcusSwitchPortSummaryList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ArcusSwitchPortSummaryList' | Write-Debug
...
Convert from JSON to ArcusSwitchPortSummaryList<PSCustomObject>
...
ArcusSwitchPortSummaryList<PSCustomObject>
#>
function ConvertFrom-JsonToArcusSwitchPortSummaryList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ArcusSwitchPortSummaryList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ArcusSwitchPortSummaryList
