...
consoleUri for detailed storage container object
...
resourceUri for detailed storage container object
.PARAMETER ScUuid
...
.PARAMETER VvSetId
vvSetId of the storage container
.OUTPUTS

VvolscDetails<PSCustomObject>
#>

function Initialize-VvolscDetails {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => VvolscDetails' | Write-Debug
...
Convert from JSON to VvolscDetails<PSCustomObject>
...
VvolscDetails<PSCustomObject>
#>
function ConvertFrom-JsonToVvolscDetails {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => VvolscDetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in VvolscDetails
        $AllProperties = ("associatedLinks", "autoDissmissed", "comment", "consoleUri", "creationTime", "customerId", "displayname", "domain", "generation", "id", "inUseMiB", "lastModifiedEpoch", "name", "numOfVMs", "numOfVvols", "provisionedMiB", "resourceUri", "sc_uuid", "systemId", "systemWWN", "totalMiB", "type", "uri", "vvSetId")
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "vvSetId"))) { #optional property not found
            $VvSetId = $null
        } else {
            $VvSetId = $JsonParameters.PSobject.Properties["vvSetId"].value
        }
