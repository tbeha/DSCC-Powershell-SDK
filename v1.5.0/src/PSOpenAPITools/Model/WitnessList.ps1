...
WitnessList<PSCustomObject>
#>

function Initialize-WitnessList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => WitnessList' | Write-Debug
...
Convert from JSON to WitnessList<PSCustomObject>
...
WitnessList<PSCustomObject>
#>
function ConvertFrom-JsonToWitnessList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => WitnessList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in WitnessList
