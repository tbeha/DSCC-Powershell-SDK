...
.PARAMETER Total
Number of storage container
.OUTPUTS

NetworkServicesVvolscs<PSCustomObject>
#>

function Initialize-NetworkServicesVvolscs {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => NetworkServicesVvolscs' | Write-Debug
...
Convert from JSON to NetworkServicesVvolscs<PSCustomObject>
...
NetworkServicesVvolscs<PSCustomObject>
#>
function ConvertFrom-JsonToNetworkServicesVvolscs {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => NetworkServicesVvolscs' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NetworkServicesVvolscs
