...
Arcusallocated<PSCustomObject>
#>

function Initialize-Arcusallocated {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => Arcusallocated' | Write-Debug
...
Convert from JSON to Arcusallocated<PSCustomObject>
...
Arcusallocated<PSCustomObject>
#>
function ConvertFrom-JsonToArcusallocated {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => Arcusallocated' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Arcusallocated
