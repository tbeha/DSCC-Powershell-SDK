...
NimbleNetworkInterfaceListItemsInner<PSCustomObject>
#>

function Initialize-NimbleNetworkInterfaceListItemsInner {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => NimbleNetworkInterfaceListItemsInner' | Write-Debug
...
Convert from JSON to NimbleNetworkInterfaceListItemsInner<PSCustomObject>
...
NimbleNetworkInterfaceListItemsInner<PSCustomObject>
#>
function ConvertFrom-JsonToNimbleNetworkInterfaceListItemsInner {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => NimbleNetworkInterfaceListItemsInner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NimbleNetworkInterfaceListItemsInner
        $AllProperties = ("array_id", "array_name_or_serial", "id", "mac", "associated_links", "consoleUri", "controller_id", "controller_name", "customerId", "generation", "ip_list", "is_present", "link_speed", "link_status", "max_link_speed", "mtu", "name", "nic_type", "port", "resourceUri", "slot", "type")
