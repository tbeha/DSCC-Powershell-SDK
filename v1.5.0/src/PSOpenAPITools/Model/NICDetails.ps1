...
function Initialize-NICDetails {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => NICDetails' | Write-Debug
...
Convert from JSON to NICDetails<PSCustomObject>
...
NICDetails<PSCustomObject>
#>
function ConvertFrom-JsonToNICDetails {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => NICDetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NICDetails
