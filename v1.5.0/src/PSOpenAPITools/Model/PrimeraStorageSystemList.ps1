...
PrimeraStorageSystemList<PSCustomObject>
#>

function Initialize-PrimeraStorageSystemList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PrimeraStorageSystemList' | Write-Debug
...
Convert from JSON to PrimeraStorageSystemList<PSCustomObject>
...
PrimeraStorageSystemList<PSCustomObject>
#>
function ConvertFrom-JsonToPrimeraStorageSystemList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PrimeraStorageSystemList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PrimeraStorageSystemList
