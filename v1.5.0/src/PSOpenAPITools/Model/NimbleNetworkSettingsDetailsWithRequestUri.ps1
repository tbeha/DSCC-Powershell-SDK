...
requestUri for detailed network setting object
.PARAMETER Id
...
NimbleNetworkSettingsDetailsWithRequestUri<PSCustomObject>
#>

function Initialize-NimbleNetworkSettingsDetailsWithRequestUri {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => NimbleNetworkSettingsDetailsWithRequestUri' | Write-Debug
...
Convert from JSON to NimbleNetworkSettingsDetailsWithRequestUri<PSCustomObject>
...
NimbleNetworkSettingsDetailsWithRequestUri<PSCustomObject>
#>
function ConvertFrom-JsonToNimbleNetworkSettingsDetailsWithRequestUri {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => NimbleNetworkSettingsDetailsWithRequestUri' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NimbleNetworkSettingsDetailsWithRequestUri
        $AllProperties = ("requestUri", "id", "name", "role", "active_since", "array_list", "associatedLinks", "consoleUri", "creation_time", "customerId", "generation", "group_leader_array", "iscsi_automatic_connection_method", "iscsi_connection_rebalancing", "last_active", "last_modified", "mgmt_ip", "resourceUri", "route_list", "secondary_mgmt_ip", "subnet_list", "type")
