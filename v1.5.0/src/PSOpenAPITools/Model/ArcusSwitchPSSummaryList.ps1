...
.PARAMETER Total
Number of switch powersupplies
.OUTPUTS

ArcusSwitchPSSummaryList<PSCustomObject>
#>

function Initialize-ArcusSwitchPSSummaryList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ArcusSwitchPSSummaryList' | Write-Debug
...
Convert from JSON to ArcusSwitchPSSummaryList<PSCustomObject>
...
ArcusSwitchPSSummaryList<PSCustomObject>
#>
function ConvertFrom-JsonToArcusSwitchPSSummaryList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ArcusSwitchPSSummaryList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ArcusSwitchPSSummaryList
