...
ArcussnapshotsList<PSCustomObject>
#>

function Initialize-ArcussnapshotsList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ArcussnapshotsList' | Write-Debug
...
Convert from JSON to ArcussnapshotsList<PSCustomObject>
...
ArcussnapshotsList<PSCustomObject>
#>
function ConvertFrom-JsonToArcussnapshotsList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ArcussnapshotsList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ArcussnapshotsList
