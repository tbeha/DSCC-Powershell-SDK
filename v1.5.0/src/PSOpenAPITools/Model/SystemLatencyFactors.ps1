...
SystemLatencyFactors<PSCustomObject>
#>

function Initialize-SystemLatencyFactors {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => SystemLatencyFactors' | Write-Debug
...
Convert from JSON to SystemLatencyFactors<PSCustomObject>
...
SystemLatencyFactors<PSCustomObject>
#>
function ConvertFrom-JsonToSystemLatencyFactors {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => SystemLatencyFactors' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in SystemLatencyFactors
