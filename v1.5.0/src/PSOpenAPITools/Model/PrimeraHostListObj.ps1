...
PrimeraHostListObj<PSCustomObject>
#>

function Initialize-PrimeraHostListObj {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PrimeraHostListObj' | Write-Debug
...
Convert from JSON to PrimeraHostListObj<PSCustomObject>
...
PrimeraHostListObj<PSCustomObject>
#>
function ConvertFrom-JsonToPrimeraHostListObj {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PrimeraHostListObj' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PrimeraHostListObj
