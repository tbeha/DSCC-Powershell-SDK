...
NimbleFolderFieldsWithSortKey<PSCustomObject>
#>

function Initialize-NimbleFolderFieldsWithSortKey {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => NimbleFolderFieldsWithSortKey' | Write-Debug
...
Convert from JSON to NimbleFolderFieldsWithSortKey<PSCustomObject>
...
NimbleFolderFieldsWithSortKey<PSCustomObject>
#>
function ConvertFrom-JsonToNimbleFolderFieldsWithSortKey {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => NimbleFolderFieldsWithSortKey' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NimbleFolderFieldsWithSortKey
