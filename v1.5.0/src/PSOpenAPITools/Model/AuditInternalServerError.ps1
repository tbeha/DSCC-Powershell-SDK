...
AuditInternalServerError<PSCustomObject>
#>

function Initialize-AuditInternalServerError {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => AuditInternalServerError' | Write-Debug
...
Convert from JSON to AuditInternalServerError<PSCustomObject>
...
AuditInternalServerError<PSCustomObject>
#>
function ConvertFrom-JsonToAuditInternalServerError {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => AuditInternalServerError' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in AuditInternalServerError
