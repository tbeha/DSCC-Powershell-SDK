...
ArcusStorageSystemList<PSCustomObject>
#>

function Initialize-ArcusStorageSystemList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ArcusStorageSystemList' | Write-Debug
...
Convert from JSON to ArcusStorageSystemList<PSCustomObject>
...
ArcusStorageSystemList<PSCustomObject>
#>
function ConvertFrom-JsonToArcusStorageSystemList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ArcusStorageSystemList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ArcusStorageSystemList
