...
CreateAppSetInput<PSCustomObject>
#>

function Initialize-CreateAppSetInput {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => CreateAppSetInput' | Write-Debug
...
Convert from JSON to CreateAppSetInput<PSCustomObject>
...
CreateAppSetInput<PSCustomObject>
#>
function ConvertFrom-JsonToCreateAppSetInput {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => CreateAppSetInput' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in CreateAppSetInput
