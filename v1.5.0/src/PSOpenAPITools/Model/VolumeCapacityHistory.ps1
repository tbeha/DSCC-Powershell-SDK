...
VolumeCapacityHistory<PSCustomObject>
#>

function Initialize-VolumeCapacityHistory {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => VolumeCapacityHistory' | Write-Debug
...
Convert from JSON to VolumeCapacityHistory<PSCustomObject>
...
VolumeCapacityHistory<PSCustomObject>
#>
function ConvertFrom-JsonToVolumeCapacityHistory {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => VolumeCapacityHistory' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in VolumeCapacityHistory
