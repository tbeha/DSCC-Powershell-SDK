...
ArcusStorageSystemDetail<PSCustomObject>
#>

function Initialize-ArcusStorageSystemDetail {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ArcusStorageSystemDetail' | Write-Debug
...
Convert from JSON to ArcusStorageSystemDetail<PSCustomObject>
...
ArcusStorageSystemDetail<PSCustomObject>
#>
function ConvertFrom-JsonToArcusStorageSystemDetail {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ArcusStorageSystemDetail' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ArcusStorageSystemDetail
