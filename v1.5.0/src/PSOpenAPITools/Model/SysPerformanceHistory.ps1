...
SysPerformanceHistory<PSCustomObject>
#>

function Initialize-SysPerformanceHistory {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => SysPerformanceHistory' | Write-Debug
...
Convert from JSON to SysPerformanceHistory<PSCustomObject>
...
SysPerformanceHistory<PSCustomObject>
#>
function ConvertFrom-JsonToSysPerformanceHistory {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => SysPerformanceHistory' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in SysPerformanceHistory
