...
ArcusportDetails<PSCustomObject>
#>

function Initialize-ArcusportDetails {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ArcusportDetails' | Write-Debug
...
Convert from JSON to ArcusportDetails<PSCustomObject>
...
ArcusportDetails<PSCustomObject>
#>
function ConvertFrom-JsonToArcusportDetails {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ArcusportDetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ArcusportDetails
        $AllProperties = ("associatedLinks", "cardType", "class", "class2", "config", "configMode", "connectionType", "consoleUri", "customerId", "devices", "displayname", "domain", "enclosureCardId", "enclosureCardPCIUid", "enclosureCardPCId", "enclosureCardUid", "enclosureId", "enclosureUid", "failoverStatus", "fcData", "fwVersion", "generation", "id", "initiatorPorts", "interruptCoalesce", "ipData", "iscsiData", "label", "manufacturing", "mode", "modeChange", "name", "nodeCardId", "nodeId", "partner", "portSfp", "portType", "position", "protocol", "requestUri", "resourceUri", "revision", "smartSAN", "speedActual", "speedConfigured", "speedMax", "speedMin", "state", "stateDescription", "systemId", "tgtModeWriteOpt", "type", "uniqueWWN", "vlans")
