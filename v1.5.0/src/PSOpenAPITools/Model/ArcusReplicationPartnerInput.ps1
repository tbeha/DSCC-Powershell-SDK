...
ArcusReplicationPartnerInput<PSCustomObject>
#>

function Initialize-ArcusReplicationPartnerInput {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ArcusReplicationPartnerInput' | Write-Debug
...
Convert from JSON to ArcusReplicationPartnerInput<PSCustomObject>
...
ArcusReplicationPartnerInput<PSCustomObject>
#>
function ConvertFrom-JsonToArcusReplicationPartnerInput {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ArcusReplicationPartnerInput' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ArcusReplicationPartnerInput
