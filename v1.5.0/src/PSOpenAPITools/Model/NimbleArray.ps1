...
NimbleArray<PSCustomObject>
#>

function Initialize-NimbleArray {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => NimbleArray' | Write-Debug
...
Convert from JSON to NimbleArray<PSCustomObject>
...
NimbleArray<PSCustomObject>
#>
function ConvertFrom-JsonToNimbleArray {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
