...
ArcusSwitchesSummaryList<PSCustomObject>
#>

function Initialize-ArcusSwitchesSummaryList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ArcusSwitchesSummaryList' | Write-Debug
...
Convert from JSON to ArcusSwitchesSummaryList<PSCustomObject>
...
ArcusSwitchesSummaryList<PSCustomObject>
#>
function ConvertFrom-JsonToArcusSwitchesSummaryList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ArcusSwitchesSummaryList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ArcusSwitchesSummaryList
