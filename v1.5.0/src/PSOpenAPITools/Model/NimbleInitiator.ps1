...
Access protocol used by the initiator. Possible values: 'iscsi', 'fc'. `Filter, Sort`
.PARAMETER Alias
...
generation
.PARAMETER Id
Identifier for initiator. A 42 digit hexadecimal number. `Filter`
.PARAMETER InitiatorGroupId
Identifier of the initiator group that this initiator is assigned to. A 42 digit hexadecimal number. `Filter, Sort`
.PARAMETER InitiatorGroupName
Name of the initiator group that this initiator is assigned to. String of up to 64 alphanumeric characters, - and . and : are allowed after first character `Filter, Sort`
.PARAMETER IpAddress
...
Forcibly add Fibre Channel initiator to initiator group by updating or removing conflicting Fibre Channel initiator aliases. (this argument is deprecated)
.PARAMETER ResourceUri
Link to the object URI
.PARAMETER ScHostInitiatorId
Host Service Initiator Id (this argument is deprecated)
.PARAMETER Type
type
.PARAMETER Wwpn
...
NimbleInitiator<PSCustomObject>
#>

function Initialize-NimbleInitiator {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => NimbleInitiator' | Write-Debug
...
Convert from JSON to NimbleInitiator<PSCustomObject>
...
NimbleInitiator<PSCustomObject>
#>
function ConvertFrom-JsonToNimbleInitiator {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => NimbleInitiator' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NimbleInitiator
        $AllProperties = ("access_protocol", "alias", "associated_links", "chapuser_id", "consoleUri", "creation_time", "customerId", "generation", "id", "initiator_group_id", "initiator_group_name", "ip_address", "iqn", "label", "last_modified", "override_existing_alias", "resourceUri", "sc_HostInitiatorId", "type", "wwpn")
