...
function Initialize-PortsList {
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PortsList' | Write-Debug
...
Convert from JSON to PortsList<PSCustomObject>
...
PortsList<PSCustomObject>
#>
function ConvertFrom-JsonToPortsList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
