...
SnapshotSetsSummaryList<PSCustomObject>
#>

function Initialize-SnapshotSetsSummaryList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => SnapshotSetsSummaryList' | Write-Debug
...
Convert from JSON to SnapshotSetsSummaryList<PSCustomObject>
...
SnapshotSetsSummaryList<PSCustomObject>
#>
function ConvertFrom-JsonToSnapshotSetsSummaryList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => SnapshotSetsSummaryList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in SnapshotSetsSummaryList
