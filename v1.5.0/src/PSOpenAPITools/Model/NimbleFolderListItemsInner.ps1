...
NimbleFolderListItemsInner<PSCustomObject>
#>

function Initialize-NimbleFolderListItemsInner {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => NimbleFolderListItemsInner' | Write-Debug
...
Convert from JSON to NimbleFolderListItemsInner<PSCustomObject>
...
NimbleFolderListItemsInner<PSCustomObject>
#>
function ConvertFrom-JsonToNimbleFolderListItemsInner {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => NimbleFolderListItemsInner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NimbleFolderListItemsInner
