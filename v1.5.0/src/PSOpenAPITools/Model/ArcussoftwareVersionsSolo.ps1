...
ArcussoftwareVersionsSolo<PSCustomObject>
#>

function Initialize-ArcussoftwareVersionsSolo {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ArcussoftwareVersionsSolo' | Write-Debug
...
Convert from JSON to ArcussoftwareVersionsSolo<PSCustomObject>
...
ArcussoftwareVersionsSolo<PSCustomObject>
#>
function ConvertFrom-JsonToArcussoftwareVersionsSolo {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ArcussoftwareVersionsSolo' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ArcussoftwareVersionsSolo
