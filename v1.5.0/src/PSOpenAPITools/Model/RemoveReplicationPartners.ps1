...
RemoveReplicationPartners<PSCustomObject>
#>

function Initialize-RemoveReplicationPartners {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => RemoveReplicationPartners' | Write-Debug
...
Convert from JSON to RemoveReplicationPartners<PSCustomObject>
...
RemoveReplicationPartners<PSCustomObject>
#>
function ConvertFrom-JsonToRemoveReplicationPartners {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => RemoveReplicationPartners' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in RemoveReplicationPartners
