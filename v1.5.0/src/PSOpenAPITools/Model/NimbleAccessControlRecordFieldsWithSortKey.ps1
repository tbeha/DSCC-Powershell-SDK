...
NimbleAccessControlRecordFieldsWithSortKey<PSCustomObject>
#>

function Initialize-NimbleAccessControlRecordFieldsWithSortKey {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => NimbleAccessControlRecordFieldsWithSortKey' | Write-Debug
...
Convert from JSON to NimbleAccessControlRecordFieldsWithSortKey<PSCustomObject>
...
NimbleAccessControlRecordFieldsWithSortKey<PSCustomObject>
#>
function ConvertFrom-JsonToNimbleAccessControlRecordFieldsWithSortKey {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => NimbleAccessControlRecordFieldsWithSortKey' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NimbleAccessControlRecordFieldsWithSortKey
