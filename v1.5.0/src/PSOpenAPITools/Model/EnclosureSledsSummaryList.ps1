...
EnclosureSledsSummaryList<PSCustomObject>
#>

function Initialize-EnclosureSledsSummaryList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => EnclosureSledsSummaryList' | Write-Debug
...
Convert from JSON to EnclosureSledsSummaryList<PSCustomObject>
...
EnclosureSledsSummaryList<PSCustomObject>
#>
function ConvertFrom-JsonToEnclosureSledsSummaryList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => EnclosureSledsSummaryList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in EnclosureSledsSummaryList
