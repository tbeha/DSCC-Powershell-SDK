...
page offset
.PARAMETER Total
Number of snmp managers
.OUTPUTS

ArcussnmpDetails<PSCustomObject>
#>

function Initialize-ArcussnmpDetails {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ArcussnmpDetails' | Write-Debug
...
Convert from JSON to ArcussnmpDetails<PSCustomObject>
...
ArcussnmpDetails<PSCustomObject>
#>
function ConvertFrom-JsonToArcussnmpDetails {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ArcussnmpDetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ArcussnmpDetails
