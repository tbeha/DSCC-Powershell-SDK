...
requestUri for primera Hostpath objects
.PARAMETER Total
Total number of host paths.
.OUTPUTS

PrimeraHostPathList<PSCustomObject>
#>

function Initialize-PrimeraHostPathList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PrimeraHostPathList' | Write-Debug
...
Convert from JSON to PrimeraHostPathList<PSCustomObject>
...
PrimeraHostPathList<PSCustomObject>
#>
function ConvertFrom-JsonToPrimeraHostPathList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PrimeraHostPathList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PrimeraHostPathList
