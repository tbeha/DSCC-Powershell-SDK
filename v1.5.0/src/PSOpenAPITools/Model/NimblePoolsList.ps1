...
requestUri for storage pool objects
.PARAMETER Total
Total number of pools.
.OUTPUTS

NimblePoolsList<PSCustomObject>
#>

function Initialize-NimblePoolsList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => NimblePoolsList' | Write-Debug
...
Convert from JSON to NimblePoolsList<PSCustomObject>
...
NimblePoolsList<PSCustomObject>
#>
function ConvertFrom-JsonToNimblePoolsList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => NimblePoolsList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NimblePoolsList
