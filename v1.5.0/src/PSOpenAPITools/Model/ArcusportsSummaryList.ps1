...
ArcusportsSummaryList<PSCustomObject>
#>

function Initialize-ArcusportsSummaryList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ArcusportsSummaryList' | Write-Debug
...
Convert from JSON to ArcusportsSummaryList<PSCustomObject>
...
ArcusportsSummaryList<PSCustomObject>
#>
function ConvertFrom-JsonToArcusportsSummaryList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ArcusportsSummaryList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ArcusportsSummaryList
