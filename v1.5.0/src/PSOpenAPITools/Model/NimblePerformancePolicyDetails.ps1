...
function ConvertFrom-JsonToNimblePerformancePolicyDetails {
    ...
    Process {
        ...
        $AllProperties = ("associated_links", "block_size", "consoleUri", "customerId", "dedupe_override_pools", "description", "full_name", "generation", "perfpolicy_creator_id", "perfpolicy_creator_name", "resourceUri", "search_name", "type", "volume_count")
