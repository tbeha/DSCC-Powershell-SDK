...
ArcusVvolscs<PSCustomObject>
#>

function Initialize-ArcusVvolscs {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ArcusVvolscs' | Write-Debug
...
Convert from JSON to ArcusVvolscs<PSCustomObject>
...
ArcusVvolscs<PSCustomObject>
#>
function ConvertFrom-JsonToArcusVvolscs {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ArcusVvolscs' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ArcusVvolscs
