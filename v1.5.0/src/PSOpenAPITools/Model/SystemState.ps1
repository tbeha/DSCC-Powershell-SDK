...
function Initialize-SystemState {
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => SystemState' | Write-Debug
...
Convert from JSON to SystemState<PSCustomObject>
...
SystemState<PSCustomObject>
#>
function ConvertFrom-JsonToSystemState {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => SystemState' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in SystemState
