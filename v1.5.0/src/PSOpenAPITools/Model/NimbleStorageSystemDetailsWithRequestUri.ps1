...
requestUri for detailed storage system object
.PARAMETER Id
...
NimbleStorageSystemDetailsWithRequestUri<PSCustomObject>
#>

function Initialize-NimbleStorageSystemDetailsWithRequestUri {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => NimbleStorageSystemDetailsWithRequestUri' | Write-Debug
...
Convert from JSON to NimbleStorageSystemDetailsWithRequestUri<PSCustomObject>
...
NimbleStorageSystemDetailsWithRequestUri<PSCustomObject>
#>
function ConvertFrom-JsonToNimbleStorageSystemDetailsWithRequestUri {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
