...
function Initialize-Allocation {
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => Allocation' | Write-Debug
...
Convert from JSON to Allocation<PSCustomObject>
...
Allocation<PSCustomObject>
#>
function ConvertFrom-JsonToAllocation {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => Allocation' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Allocation
