...
page offset
.PARAMETER Total
total number of cap data
.OUTPUTS

CappedObjData<PSCustomObject>
#>

function Initialize-CappedObjData {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => CappedObjData' | Write-Debug
...
Convert from JSON to CappedObjData<PSCustomObject>
...
CappedObjData<PSCustomObject>
#>
function ConvertFrom-JsonToCappedObjData {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => CappedObjData' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in CappedObjData
