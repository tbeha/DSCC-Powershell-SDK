...
ArcusReplicationPartnerList<PSCustomObject>
#>

function Initialize-ArcusReplicationPartnerList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ArcusReplicationPartnerList' | Write-Debug
...
Convert from JSON to ArcusReplicationPartnerList<PSCustomObject>
...
ArcusReplicationPartnerList<PSCustomObject>
#>
function ConvertFrom-JsonToArcusReplicationPartnerList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ArcusReplicationPartnerList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ArcusReplicationPartnerList
        $AllProperties = ("customerId", "displayName", "domain", "drState", "generation", "groupId", "groupLastSyncTime", "groupName", "groupObjectId", "id", "isProtectionPolicyConfigured", "isRemoteArraySupportReplication", "isSourceArraySupportReplication", "mode", "policies", "protectionType", "remoteRole", "remoteUsrCPG", "remoteVolumeSetName", "resourceUri", "role", "roleReversed", "snapFrequencySecs", "state", "syncPeriod", "systemId", "systemName", "systemWWN", "targetName", "type", "volumeCount")
