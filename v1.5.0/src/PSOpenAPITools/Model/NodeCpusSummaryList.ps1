...
NodeCpusSummaryList<PSCustomObject>
#>

function Initialize-NodeCpusSummaryList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => NodeCpusSummaryList' | Write-Debug
...
Convert from JSON to NodeCpusSummaryList<PSCustomObject>
...
NodeCpusSummaryList<PSCustomObject>
#>
function ConvertFrom-JsonToNodeCpusSummaryList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => NodeCpusSummaryList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NodeCpusSummaryList
