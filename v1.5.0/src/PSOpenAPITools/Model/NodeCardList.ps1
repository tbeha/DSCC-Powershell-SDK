...
NodeCardList<PSCustomObject>
#>

function Initialize-NodeCardList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => NodeCardList' | Write-Debug
...
Convert from JSON to NodeCardList<PSCustomObject>
...
NodeCardList<PSCustomObject>
#>
function ConvertFrom-JsonToNodeCardList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => NodeCardList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NodeCardList
        $AllProperties = ("associatedLinks", "customerId", "displayname", "domain", "fwVersion", "generation", "id", "locateEnabled", "manufacturing", "name", "nodeCardType", "nodeDeviceId", "nodeId", "resourceUri", "revision", "safeToRemove", "serviceLED", "slot", "systemId", "type")
