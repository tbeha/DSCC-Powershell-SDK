...
ArcusRemoveRemoteCopyLinksInput<PSCustomObject>
#>

function Initialize-ArcusRemoveRemoteCopyLinksInput {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ArcusRemoveRemoteCopyLinksInput' | Write-Debug
...
Convert from JSON to ArcusRemoveRemoteCopyLinksInput<PSCustomObject>
...
ArcusRemoveRemoteCopyLinksInput<PSCustomObject>
#>
function ConvertFrom-JsonToArcusRemoveRemoteCopyLinksInput {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ArcusRemoveRemoteCopyLinksInput' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ArcusRemoveRemoteCopyLinksInput
