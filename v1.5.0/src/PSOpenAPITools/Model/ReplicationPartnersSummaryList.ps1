...
ReplicationPartnersSummaryList<PSCustomObject>
#>

function Initialize-ReplicationPartnersSummaryList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ReplicationPartnersSummaryList' | Write-Debug
...
Convert from JSON to ReplicationPartnersSummaryList<PSCustomObject>
...
ReplicationPartnersSummaryList<PSCustomObject>
#>
function ConvertFrom-JsonToReplicationPartnersSummaryList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ReplicationPartnersSummaryList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ReplicationPartnersSummaryList
