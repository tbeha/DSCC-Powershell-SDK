...
ArcusHostListObj<PSCustomObject>
#>

function Initialize-ArcusHostListObj {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ArcusHostListObj' | Write-Debug
...
Convert from JSON to ArcusHostListObj<PSCustomObject>
...
ArcusHostListObj<PSCustomObject>
#>
function ConvertFrom-JsonToArcusHostListObj {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ArcusHostListObj' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ArcusHostListObj
