...
CreateRemoteCopyTargetInput<PSCustomObject>
#>

function Initialize-CreateRemoteCopyTargetInput {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => CreateRemoteCopyTargetInput' | Write-Debug
...
Convert from JSON to CreateRemoteCopyTargetInput<PSCustomObject>
...
CreateRemoteCopyTargetInput<PSCustomObject>
#>
function ConvertFrom-JsonToCreateRemoteCopyTargetInput {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => CreateRemoteCopyTargetInput' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in CreateRemoteCopyTargetInput
