...
NimbleDisk<PSCustomObject>
#>

function Initialize-NimbleDisk {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => NimbleDisk' | Write-Debug
...
Convert from JSON to NimbleDisk<PSCustomObject>
...
NimbleDisk<PSCustomObject>
#>
function ConvertFrom-JsonToNimbleDisk {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => NimbleDisk' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NimbleDisk
        $AllProperties = ("array_id", "array_name", "device_type", "id", "model", "serial", "shelf_id", "shelf_serial", "state", "associatedLinks", "bank", "block_type", "consoleUri", "customerId", "disk_internal_stat1", "firmware_version", "generation", "hba", "is_dfc", "path", "port", "raid_id", "raid_resync_average_speed", "raid_resync_current_speed", "raid_resync_percent", "raid_state", "resourceUri", "shelf_location", "shelf_location_id", "size", "slot", "smart_attribute_list", "type", "vendor", "vshelf_id")
