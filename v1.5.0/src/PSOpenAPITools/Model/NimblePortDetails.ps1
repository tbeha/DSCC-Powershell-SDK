...
function ConvertFrom-JsonToNimblePortDetails {
    ...
    Process {
        ...
        $AllProperties = ("array_id", "array_name_or_serial", "bus_location", "consoleUri", "controller_id", "controller_name", "fabric_info", "fc_port_id", "fc_port_name", "firmware_version", "id", "ip_list", "is_present", "link_info", "link_speed", "link_status", "logical_port_number", "mac", "max_link_speed", "mtu", "name", "nic_type", "online", "orientation", "partial_response_ok", "peerzone", "port", "slot", "wwnn", "wwpn")
