...
StoragePoolPerformanceHistory<PSCustomObject>
#>

function Initialize-StoragePoolPerformanceHistory {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => StoragePoolPerformanceHistory' | Write-Debug
...
Convert from JSON to StoragePoolPerformanceHistory<PSCustomObject>
...
StoragePoolPerformanceHistory<PSCustomObject>
#>
function ConvertFrom-JsonToStoragePoolPerformanceHistory {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => StoragePoolPerformanceHistory' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in StoragePoolPerformanceHistory
