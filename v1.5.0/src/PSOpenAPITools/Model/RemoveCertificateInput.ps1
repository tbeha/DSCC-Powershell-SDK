...
RemoveCertificateInput<PSCustomObject>
#>

function Initialize-RemoveCertificateInput {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => RemoveCertificateInput' | Write-Debug
...
Convert from JSON to RemoveCertificateInput<PSCustomObject>
...
RemoveCertificateInput<PSCustomObject>
#>
function ConvertFrom-JsonToRemoveCertificateInput {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => RemoveCertificateInput' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in RemoveCertificateInput
