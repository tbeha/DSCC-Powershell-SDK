...
ArcusPoolDetails<PSCustomObject>
#>

function Initialize-ArcusPoolDetails {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ArcusPoolDetails' | Write-Debug
...
Convert from JSON to ArcusPoolDetails<PSCustomObject>
...
ArcusPoolDetails<PSCustomObject>
#>
function ConvertFrom-JsonToArcusPoolDetails {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ArcusPoolDetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ArcusPoolDetails
