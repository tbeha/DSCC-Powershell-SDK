...
TasksInternalServerError<PSCustomObject>
#>

function Initialize-TasksInternalServerError {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => TasksInternalServerError' | Write-Debug
...
Convert from JSON to TasksInternalServerError<PSCustomObject>
...
TasksInternalServerError<PSCustomObject>
#>
function ConvertFrom-JsonToTasksInternalServerError {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => TasksInternalServerError' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in TasksInternalServerError
