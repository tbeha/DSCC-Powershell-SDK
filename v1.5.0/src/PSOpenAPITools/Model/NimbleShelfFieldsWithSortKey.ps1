...
NimbleShelfFieldsWithSortKey<PSCustomObject>
#>

function Initialize-NimbleShelfFieldsWithSortKey {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => NimbleShelfFieldsWithSortKey' | Write-Debug
...
Convert from JSON to NimbleShelfFieldsWithSortKey<PSCustomObject>
...
NimbleShelfFieldsWithSortKey<PSCustomObject>
#>
function ConvertFrom-JsonToNimbleShelfFieldsWithSortKey {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => NimbleShelfFieldsWithSortKey' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NimbleShelfFieldsWithSortKey
