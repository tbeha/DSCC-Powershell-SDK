...
TasksServiceUnavailable<PSCustomObject>
#>

function Initialize-TasksServiceUnavailable {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => TasksServiceUnavailable' | Write-Debug
...
Convert from JSON to TasksServiceUnavailable<PSCustomObject>
...
TasksServiceUnavailable<PSCustomObject>
#>
function ConvertFrom-JsonToTasksServiceUnavailable {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => TasksServiceUnavailable' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in TasksServiceUnavailable
