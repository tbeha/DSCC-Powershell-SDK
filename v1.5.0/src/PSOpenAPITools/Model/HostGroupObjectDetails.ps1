...
HostGroupObjectDetails<PSCustomObject>
#>

function Initialize-HostGroupObjectDetails {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => HostGroupObjectDetails' | Write-Debug
...
Convert from JSON to HostGroupObjectDetails<PSCustomObject>
...
HostGroupObjectDetails<PSCustomObject>
#>
function ConvertFrom-JsonToHostGroupObjectDetails {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => HostGroupObjectDetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in HostGroupObjectDetails
