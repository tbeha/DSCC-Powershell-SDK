...
PrimeraVolumeDetails<PSCustomObject>
#>

function Initialize-PrimeraVolumeDetails {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PrimeraVolumeDetails' | Write-Debug
...
Convert from JSON to PrimeraVolumeDetails<PSCustomObject>
...
PrimeraVolumeDetails<PSCustomObject>
#>
function ConvertFrom-JsonToPrimeraVolumeDetails {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PrimeraVolumeDetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PrimeraVolumeDetails
        $AllProperties = ("adminAllocationSettings", "adminSpace", "associatedLinks", "baseId", "comment", "compactEfficiency", "compressionEfficiency", "compressionPolicy", "consoleUri", "conversionType", "copiedMB", "copiedPerc", "copyOfID", "creationTime", "customerId", "dataReduction", "ddcSize", "ddsSize", "dedup", "dedupSavingsSize", "dedupWrittenSize", "devType", "displayname", "domain", "efficiencyUpdateTime", "expirationTime", "fullyProvisioned", "generation", "headsPerCylinder", "healthState", "hidden", "hostWrittenMiB", "hostWrittenToVirtualPercent", "id", "initiators", "name", "parentID", "physParentID", "physicalCopy", "policy", "provType", "raid", "rcopyStatus", "readOnly", "requestUri", "resourceUri", "retentionTime", "roChildID", "rwChildID", "sectorsPerTrack", "sharedParentId", "sizeMiB", "snapShotTier", "snapshotAllocLimit", "snapshotAllocWarning", "snapshotAllocationSettings", "snapshotCpgID", "snapshotCpgName", "snapshotSpace", "snapshotTdvvSize", "snapshotUsedToVirtualPercent", "spaceCalculationTime", "started", "state", "storageTier", "systemId", "thinProvisioned", "thinSavings", "totalRawReservedMiB", "totalReservedMiB", "totalSpaceMiB", "type", "unrefSpaceFreedTime", "usedCapacity", "usedSizeMiB", "userAllocLimit", "userAllocWarning", "userAllocationSettings", "userCpgID", "userCpgName", "userReservedToVirtualPercent", "userSpace", "userUsedToVirtualPercent", "vlunSectorSize", "volumeId", "volumePerformance", "volumeType", "wwn")
