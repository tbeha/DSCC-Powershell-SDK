...
EnclosurePowerDetails<PSCustomObject>
#>

function Initialize-EnclosurePowerDetails {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => EnclosurePowerDetails' | Write-Debug
...
Convert from JSON to EnclosurePowerDetails<PSCustomObject>
...
EnclosurePowerDetails<PSCustomObject>
#>
function ConvertFrom-JsonToEnclosurePowerDetails {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => EnclosurePowerDetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in EnclosurePowerDetails
        $AllProperties = ("acStatus", "associatedLinks", "consoleUri", "customerId", "dcStatus", "displayname", "domain", "elementStatusCode", "enclosureDeviceId", "enclosureId", "enclosureName", "enclosurePowerId", "enclosureType", "failIndicator", "failInput", "failOutput", "generation", "id", "locateEnabled", "manufacturing", "modelReadOnly", "name", "requestUri", "resourceUri", "safeToRemove", "state", "systemId", "type")
