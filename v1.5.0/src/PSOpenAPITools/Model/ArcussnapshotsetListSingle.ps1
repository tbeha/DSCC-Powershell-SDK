...
ArcussnapshotsetListSingle<PSCustomObject>
#>

function Initialize-ArcussnapshotsetListSingle {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ArcussnapshotsetListSingle' | Write-Debug
...
Convert from JSON to ArcussnapshotsetListSingle<PSCustomObject>
...
ArcussnapshotsetListSingle<PSCustomObject>
#>
function ConvertFrom-JsonToArcussnapshotsetListSingle {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ArcussnapshotsetListSingle' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ArcussnapshotsetListSingle
