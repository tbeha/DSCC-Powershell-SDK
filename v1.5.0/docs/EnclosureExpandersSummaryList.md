...
------------ | ------------- | ------------- | -------------
**Items** | [**EnclosureExpanderList[]**](EnclosureExpanderList.md) |  | [optional] 
...
```powershell
$EnclosureExpandersSummaryList = Initialize-PSOpenAPIToolsEnclosureExpandersSummaryList  -Items null `
 -PageLimit 1 `
 -PageOffset 1 `
...
```powershell
$EnclosureExpandersSummaryList | ConvertTo-JSON
```
