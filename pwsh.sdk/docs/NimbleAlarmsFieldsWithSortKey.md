...
**Activity** | **String** | Description of activity performed and recorded in alarm. String of 1-1476 printable characters. &#x60;Filter, Sort&#x60; | [optional] 
...
```powershell
$NimbleAlarmsFieldsWithSortKey = Initialize-PSOpenAPIToolsNimbleAlarmsFieldsWithSortKey  -AckTime 3400 `
...
```powershell
$NimbleAlarmsFieldsWithSortKey | ConvertTo-JSON
```
