...
# Post Network-Settings details for a storage system Primera / Alletra 9K
try {
    $Result = Invoke-DeviceType1NetworkSettingsAssociate -SystemId $SystemId -EditNetworkSettingsInput $EditNetworkSettingsInput
} catch {
    Write-Host ("Exception occurred when calling Invoke-DeviceType1NetworkSettingsAssociate: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a id="Invoke-DeviceType1PostCertificate"></a>
# **Invoke-DeviceType1PostCertificate**
> TaskResponse Invoke-DeviceType1PostCertificate<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-SystemId] <String><br>
...
# Create certificate on storage system Primera / Alletra 9K identified by {systemId}
try {
    $Result = Invoke-DeviceType1PostCertificate -SystemId $SystemId -CreateCertificateInput $CreateCertificateInput
} catch {
    Write-Host ("Exception occurred when calling Invoke-DeviceType1PostCertificate: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a id="Invoke-DeviceType1PutCertificateById"></a>
# **Invoke-DeviceType1PutCertificateById**
> TaskResponse Invoke-DeviceType1PutCertificateById<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-SystemId] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Id] <String><br>
...
# Import certificate identified by {id} on storage system Primera / Alletra 9K identified by {systemId}
try {
    $Result = Invoke-DeviceType1PutCertificateById -SystemId $SystemId -Id $Id -ImportCertificateInput $ImportCertificateInput
} catch {
    Write-Host ("Exception occurred when calling Invoke-DeviceType1PutCertificateById: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a id="Invoke-DeviceType1PutQuorumWitnessById"></a>
# **Invoke-DeviceType1PutQuorumWitnessById**
> TaskResponse Invoke-DeviceType1PutQuorumWitnessById<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-SystemId] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-ReplicationPartnerId] <String><br>
...
# Edit quorum witness identified by {replicationPartnerId} on storage system Primera / Alletra 9K identified by {systemId}
try {
    $Result = Invoke-DeviceType1PutQuorumWitnessById -SystemId $SystemId -ReplicationPartnerId $ReplicationPartnerId -EditQuorumWitnessInput $EditQuorumWitnessInput
} catch {
    Write-Host ("Exception occurred when calling Invoke-DeviceType1PutQuorumWitnessById: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a id="Invoke-DeviceType1PutReplicationPartnerById"></a>
# **Invoke-DeviceType1PutReplicationPartnerById**
> TaskResponse Invoke-DeviceType1PutReplicationPartnerById<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-SystemId] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-ReplicationPartnerId] <String><br>
...
# Edit replication partner identified by {replicationPartnerId} on Primera / Alletra 9K identified by {systemId}
try {
    $Result = Invoke-DeviceType1PutReplicationPartnerById -SystemId $SystemId -ReplicationPartnerId $ReplicationPartnerId -EditReplicationPartnerInput $EditReplicationPartnerInput
} catch {
    Write-Host ("Exception occurred when calling Invoke-DeviceType1PutReplicationPartnerById: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a id="Invoke-DeviceType1PutVCenterSettingsById"></a>
# **Invoke-DeviceType1PutVCenterSettingsById**
> TaskResponse Invoke-DeviceType1PutVCenterSettingsById<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-SystemId] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-VcenterSettingId] <String><br>
...
# Edit vCenter setting identified by {vcenterSettingId} on Primera / Alletra 9K identified by {systemId}
try {
    $Result = Invoke-DeviceType1PutVCenterSettingsById -SystemId $SystemId -VcenterSettingId $VcenterSettingId -EditVCenterSettingsInput $EditVCenterSettingsInput
} catch {
    Write-Host ("Exception occurred when calling Invoke-DeviceType1PutVCenterSettingsById: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a id="Invoke-DeviceType1RemoveCertificates"></a>
# **Invoke-DeviceType1RemoveCertificates**
> TaskResponse Invoke-DeviceType1RemoveCertificates<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-SystemId] <String><br>
...
# Delete certificates from storage system Primera / Alletra 9K identified by {systemId}
try {
    $Result = Invoke-DeviceType1RemoveCertificates -SystemId $SystemId -RemoveCertificatesInput $RemoveCertificatesInput
} catch {
    Write-Host ("Exception occurred when calling Invoke-DeviceType1RemoveCertificates: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a id="Invoke-DeviceType1RemoveTrustedCertificates"></a>
# **Invoke-DeviceType1RemoveTrustedCertificates**
> TaskResponse Invoke-DeviceType1RemoveTrustedCertificates<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-SystemId] <String><br>
...
# Delete trusted certificates from storage system Primera / Alletra 9K identified by {systemId}
try {
    $Result = Invoke-DeviceType1RemoveTrustedCertificates -SystemId $SystemId -RemoveTrustedCertificatesInput $RemoveTrustedCertificatesInput
} catch {
    Write-Host ("Exception occurred when calling Invoke-DeviceType1RemoveTrustedCertificates: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a id="Invoke-DeviceType1SupportSettingsAssociate"></a>
# **Invoke-DeviceType1SupportSettingsAssociate**
> TaskResponse Invoke-DeviceType1SupportSettingsAssociate<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-SystemId] <String><br>
...
# Add support settings for a storage system Primera / Alletra 9K
try {
    $Result = Invoke-DeviceType1SupportSettingsAssociate -SystemId $SystemId -SupportSettingsInput $SupportSettingsInput
} catch {
    Write-Host ("Exception occurred when calling Invoke-DeviceType1SupportSettingsAssociate: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a id="Invoke-DeviceType1SupportSettingsUpdate"></a>
# **Invoke-DeviceType1SupportSettingsUpdate**
> TaskResponse Invoke-DeviceType1SupportSettingsUpdate<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-SystemId] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-SupportSettingsInput] <PSCustomObject><br>
...
# Edit support settings for a storage system Primera / Alletra 9K
try {
    $Result = Invoke-DeviceType1SupportSettingsUpdate -SystemId $SystemId -SupportSettingsInput $SupportSettingsInput
} catch {
    Write-Host ("Exception occurred when calling Invoke-DeviceType1SupportSettingsUpdate: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a id="Invoke-DeviceType1SystemSettingsAssociate"></a>
# **Invoke-DeviceType1SystemSettingsAssociate**
> TaskResponse Invoke-DeviceType1SystemSettingsAssociate<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-SystemId] <String><br>
...
# Edit system settings configuration
try {
    $Result = Invoke-DeviceType1SystemSettingsAssociate -SystemId $SystemId -SystemConfigParamsEditInput $SystemConfigParamsEditInput
} catch {
    Write-Host ("Exception occurred when calling Invoke-DeviceType1SystemSettingsAssociate: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
<a id="Invoke-DeviceType1SystemSettingsUpdate"></a>
# **Invoke-DeviceType1SystemSettingsUpdate**
> TaskResponse Invoke-DeviceType1SystemSettingsUpdate<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-SystemId] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-SystemConfigParamsEditInput] <PSCustomObject><br>
...
# Edit system settings configuration
try {
    $Result = Invoke-DeviceType1SystemSettingsUpdate -SystemId $SystemId -SystemConfigParamsEditInput $SystemConfigParamsEditInput
} catch {
    Write-Host ("Exception occurred when calling Invoke-DeviceType1SystemSettingsUpdate: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
$CreateApplicationServer = Initialize-CreateApplicationServer -Description "99.9999% availability" -Hostname "nimble-appserver.com" -Metadata $AppKeyValue -Name "AppServer101" -Port 1048 -ServerType "vmware" -Username "user256" # CreateApplicationServer | 
...
# Add SMTP/Mail server settigs
try {
    $Result = Send-SettingsAssociate -SystemId $SystemId -ArcusmailsettingsInput $ArcusmailsettingsInput
} catch {
...
# Edit SMTP/Mail server settigs
try {
    $Result = Send-SettingsUpdate -SystemId $SystemId -ArcusmailsettingsInput $ArcusmailsettingsInput
} catch {
...
# Edit CIM network service configuration
try {
    $Result = Invoke-NetworkServiceCimUpdate -SystemId $SystemId -ArcusnwCimEdit $ArcusnwCimEdit
} catch {
...
# Add SNMP Manager settings
try {
    $Result = Invoke-NetworkServiceSnmpMgrCreate -SystemId $SystemId -ArcusnwAddSnmpMgr $ArcusnwAddSnmpMgr
} catch {
...
# Edit SNMP Manager settings for the specified Id
try {
    $Result = Invoke-NetworkServiceSnmpMgrUpdate -SystemId $SystemId -Id $Id -ArcusnwSnmpMgrEdit $ArcusnwSnmpMgrEdit
} catch {
...
# Post Network-Settings details for a storage system HPE Alletra Storage MP
try {
    $Result = Invoke-NetworkSettingsAssociate -SystemId $SystemId -ArcuseditNetworkSettingsInput $ArcuseditNetworkSettingsInput
} catch {
...
# Create certificate on storage system HPE Alletra Storage MP identified by {systemId}
try {
    $Result = Submit-Certificate -SystemId $SystemId -ArcusCreateCertificateInput $ArcusCreateCertificateInput
} catch {
...
# Import certificate identified by {id} on storage system HPE Alletra Storage MP identified by {systemId}
try {
    $Result = Send-Certificate -SystemId $SystemId -Id $Id -ArcusImportCertificateInput $ArcusImportCertificateInput
} catch {
...
# Delete certificates from storage system HPE Alletra Storage MP identified by {systemId}
try {
    $Result = Remove-Certificates -SystemId $SystemId -ArcusRemoveCertificatesInput $ArcusRemoveCertificatesInput
} catch {
...
# Add support settings for a storage system HPE Alletra Storage MP
try {
    $Result = Invoke-SupportSettingsAssociate -SystemId $SystemId -ArcussupportSettingsInput $ArcussupportSettingsInput
} catch {
...
# Edit support settings for a storage system HPE Alletra Storage MP
try {
    $Result = Invoke-SupportSettingsUpdate -SystemId $SystemId -ArcussupportSettingsInput $ArcussupportSettingsInput
} catch {
...
# Edit system settings configuration
try {
    $Result = Invoke-SystemSettingsAssociate -SystemId $SystemId -ArcussystemConfigParamsEditInput $ArcussystemConfigParamsEditInput
} catch {
...
# Edit system settings configuration
try {
    $Result = Invoke-SystemSettingsUpdate -SystemId $SystemId -ArcussystemConfigParamsEditInput $ArcussystemConfigParamsEditInput
} catch {
