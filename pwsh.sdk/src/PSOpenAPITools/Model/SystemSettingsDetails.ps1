...
SystemSettingsDetails<PSCustomObject>
#>

function Initialize-SystemSettingsDetails {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => SystemSettingsDetails' | Write-Debug
...
Convert from JSON to SystemSettingsDetails<PSCustomObject>
...
SystemSettingsDetails<PSCustomObject>
#>
function ConvertFrom-JsonToSystemSettingsDetails {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => SystemSettingsDetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in SystemSettingsDetails
        $AllProperties = ("associatedLinks", "authMode", "consoleUri", "customerId", "generation", "installationsites", "isFIPSEnabled", "name", "ntpServer", "remoteSyslogSettings", "srinfo", "supportcontact", "systemDate", "systemId", "systemParameters", "timezone", "type")
