...
function ConvertFrom-JsonToArcusReplicationPartnerList {
    ...
    Process {
        ...
        $AllProperties = ("customerId", "displayName", "domain", "generation", "groupId", "groupLastSyncTime", "groupName", "groupObjectId", "id", "isProtectionPolicyConfigured", "isRemoteArraySupportReplication", "isSourceArraySupportReplication", "mode", "policies", "protectionType", "remoteUsrCPG", "remoteVolumeSetName", "resourceUri", "roleReversed", "snapFrequencySecs", "state", "syncPeriod", "systemId", "systemName", "systemWWN", "targetName", "type", "volumeCount")
