...
AlertContactInput<PSCustomObject>
#>

function Initialize-AlertContactInput {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => AlertContactInput' | Write-Debug
...
Convert from JSON to AlertContactInput<PSCustomObject>
...
AlertContactInput<PSCustomObject>
#>
function ConvertFrom-JsonToAlertContactInput {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => AlertContactInput' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in AlertContactInput
