...
ArcusHostSetList<PSCustomObject>
#>

function Initialize-ArcusHostSetList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ArcusHostSetList' | Write-Debug
...
Convert from JSON to ArcusHostSetList<PSCustomObject>
...
ArcusHostSetList<PSCustomObject>
#>
function ConvertFrom-JsonToArcusHostSetList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ArcusHostSetList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ArcusHostSetList
