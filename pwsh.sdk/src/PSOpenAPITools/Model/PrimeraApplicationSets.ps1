...
PrimeraApplicationSets<PSCustomObject>
#>

function Initialize-PrimeraApplicationSets {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PrimeraApplicationSets' | Write-Debug
...
Convert from JSON to PrimeraApplicationSets<PSCustomObject>
...
PrimeraApplicationSets<PSCustomObject>
#>
function ConvertFrom-JsonToPrimeraApplicationSets {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PrimeraApplicationSets' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PrimeraApplicationSets
