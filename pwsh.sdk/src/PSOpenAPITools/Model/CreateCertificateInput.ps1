...
CreateCertificateInput<PSCustomObject>
#>

function Initialize-CreateCertificateInput {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => CreateCertificateInput' | Write-Debug
...
Convert from JSON to CreateCertificateInput<PSCustomObject>
...
CreateCertificateInput<PSCustomObject>
#>
function ConvertFrom-JsonToCreateCertificateInput {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => CreateCertificateInput' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in CreateCertificateInput
