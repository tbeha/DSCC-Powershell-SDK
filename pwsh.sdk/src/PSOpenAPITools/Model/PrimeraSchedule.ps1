...
PrimeraSchedule<PSCustomObject>
#>

function Initialize-PrimeraSchedule {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PrimeraSchedule' | Write-Debug
...
Convert from JSON to PrimeraSchedule<PSCustomObject>
...
PrimeraSchedule<PSCustomObject>
#>
function ConvertFrom-JsonToPrimeraSchedule {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PrimeraSchedule' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PrimeraSchedule
        $AllProperties = ("atTime", "customerId", "days", "daysOfMonth", "expireSecs", "generation", "id", "isAlertEnabled", "isPaused", "isRemote", "isSystemTask", "name", "nextRunTime", "period", "periodUnit", "retainSecs", "status", "systemWwn", "type", "untilTime", "user")
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "daysOfMonth"))) { #optional property not found
            $DaysOfMonth = $null
        } else {
            $DaysOfMonth = $JsonParameters.PSobject.Properties["daysOfMonth"].value
        }
