...
function ConvertFrom-JsonToArcusApplicationSetDetails {
    ...
    Process {
        ...
        $AllProperties = ("appSetBusinessUnit", "appSetComments", "appSetExcludeAIQoS", "appSetId", "appSetImportance", "appSetName", "appSetType", "associatedLinks", "comment", "consoleUri", "customerId", "displayName", "domain", "exportStatus", "generation", "id", "initiators", "isFailoverAllowed", "isOverrideAllowed", "isPrimary", "isSyncAllowed", "kvPairsPresent", "members", "name", "nonZeroRtoConfig", "remoteRecoveryPoint", "replicationPartner", "replicationState", "replicationTraffic", "replicationType", "requestUri", "serialNumber", "sizeMiB", "snapSetParentId", "snapSetParentName", "systemId", "type", "vvSetType", "zeroRtoConfig")
