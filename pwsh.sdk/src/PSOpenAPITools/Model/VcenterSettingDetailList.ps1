...
VcenterSettingDetailList<PSCustomObject>
#>

function Initialize-VcenterSettingDetailList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => VcenterSettingDetailList' | Write-Debug
...
Convert from JSON to VcenterSettingDetailList<PSCustomObject>
...
VcenterSettingDetailList<PSCustomObject>
#>
function ConvertFrom-JsonToVcenterSettingDetailList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => VcenterSettingDetailList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in VcenterSettingDetailList
