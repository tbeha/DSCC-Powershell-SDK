...
ArcusRcLinkPerformanceHistoryData<PSCustomObject>
#>

function Initialize-ArcusRcLinkPerformanceHistoryData {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ArcusRcLinkPerformanceHistoryData' | Write-Debug
...
Convert from JSON to ArcusRcLinkPerformanceHistoryData<PSCustomObject>
...
ArcusRcLinkPerformanceHistoryData<PSCustomObject>
#>
function ConvertFrom-JsonToArcusRcLinkPerformanceHistoryData {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ArcusRcLinkPerformanceHistoryData' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ArcusRcLinkPerformanceHistoryData
