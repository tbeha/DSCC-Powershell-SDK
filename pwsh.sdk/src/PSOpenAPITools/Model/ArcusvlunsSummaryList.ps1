...
ArcusvlunsSummaryList<PSCustomObject>
#>

function Initialize-ArcusvlunsSummaryList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ArcusvlunsSummaryList' | Write-Debug
...
Convert from JSON to ArcusvlunsSummaryList<PSCustomObject>
...
ArcusvlunsSummaryList<PSCustomObject>
#>
function ConvertFrom-JsonToArcusvlunsSummaryList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ArcusvlunsSummaryList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ArcusvlunsSummaryList
