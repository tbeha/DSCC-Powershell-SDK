...
.PARAMETER Total
Number of Snmp Users
.OUTPUTS

ArcusSnmpUsersList<PSCustomObject>
#>

function Initialize-ArcusSnmpUsersList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ArcusSnmpUsersList' | Write-Debug
...
Convert from JSON to ArcusSnmpUsersList<PSCustomObject>
...
ArcusSnmpUsersList<PSCustomObject>
#>
function ConvertFrom-JsonToArcusSnmpUsersList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ArcusSnmpUsersList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ArcusSnmpUsersList
