...
EnclosureCardsSummaryList<PSCustomObject>
#>

function Initialize-EnclosureCardsSummaryList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => EnclosureCardsSummaryList' | Write-Debug
...
Convert from JSON to EnclosureCardsSummaryList<PSCustomObject>
...
EnclosureCardsSummaryList<PSCustomObject>
#>
function ConvertFrom-JsonToEnclosureCardsSummaryList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => EnclosureCardsSummaryList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in EnclosureCardsSummaryList
