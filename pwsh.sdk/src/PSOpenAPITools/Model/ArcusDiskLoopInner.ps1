...
ArcusDiskLoopInner<PSCustomObject>
#>

function Initialize-ArcusDiskLoopInner {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ArcusDiskLoopInner' | Write-Debug
...
Convert from JSON to ArcusDiskLoopInner<PSCustomObject>
...
ArcusDiskLoopInner<PSCustomObject>
#>
function ConvertFrom-JsonToArcusDiskLoopInner {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ArcusDiskLoopInner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ArcusDiskLoopInner
