...
TrustedCertificateDetails<PSCustomObject>
#>

function Initialize-TrustedCertificateDetails {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => TrustedCertificateDetails' | Write-Debug
...
Convert from JSON to TrustedCertificateDetails<PSCustomObject>
...
TrustedCertificateDetails<PSCustomObject>
#>
function ConvertFrom-JsonToTrustedCertificateDetails {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => TrustedCertificateDetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in TrustedCertificateDetails
