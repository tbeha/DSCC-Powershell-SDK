...
EnclosurePowersList<PSCustomObject>
#>

function Initialize-EnclosurePowersList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => EnclosurePowersList' | Write-Debug
...
Convert from JSON to EnclosurePowersList<PSCustomObject>
...
EnclosurePowersList<PSCustomObject>
#>
function ConvertFrom-JsonToEnclosurePowersList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => EnclosurePowersList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in EnclosurePowersList
        $AllProperties = ("acStatus", "associatedLinks", "customerId", "dcStatus", "displayname", "domain", "elementStatusCode", "enclosureDeviceId", "enclosureId", "enclosureName", "enclosurePowerId", "enclosureType", "failIndicator", "failInput", "failOutput", "generation", "id", "locateEnabled", "manufacturing", "modelReadOnly", "name", "resourceUri", "safeToRemove", "state", "systemId", "type")
