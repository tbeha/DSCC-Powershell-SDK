...
requestUri for Events objects
.PARAMETER Total
Total number of Events.
.OUTPUTS

NimbleEventsList<PSCustomObject>
#>

function Initialize-NimbleEventsList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => NimbleEventsList' | Write-Debug
...
Convert from JSON to NimbleEventsList<PSCustomObject>
...
NimbleEventsList<PSCustomObject>
#>
function ConvertFrom-JsonToNimbleEventsList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => NimbleEventsList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NimbleEventsList
