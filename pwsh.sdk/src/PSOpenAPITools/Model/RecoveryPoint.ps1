...
function Initialize-RecoveryPoint {
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => RecoveryPoint' | Write-Debug
...
Convert from JSON to RecoveryPoint<PSCustomObject>
...
RecoveryPoint<PSCustomObject>
#>
function ConvertFrom-JsonToRecoveryPoint {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => RecoveryPoint' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in RecoveryPoint
        $AllProperties = ("ms", "tz")
