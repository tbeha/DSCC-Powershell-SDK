...
ArcususerAllocationSettingsSingle<PSCustomObject>
#>

function Initialize-ArcususerAllocationSettingsSingle {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ArcususerAllocationSettingsSingle' | Write-Debug
...
Convert from JSON to ArcususerAllocationSettingsSingle<PSCustomObject>
...
ArcususerAllocationSettingsSingle<PSCustomObject>
#>
function ConvertFrom-JsonToArcususerAllocationSettingsSingle {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ArcususerAllocationSettingsSingle' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ArcususerAllocationSettingsSingle
