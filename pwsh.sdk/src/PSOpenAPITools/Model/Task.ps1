...
function Initialize-Task {
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => Task' | Write-Debug
...
Task<PSCustomObject>
#>
function ConvertFrom-JsonToTask {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => Task' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Task
        $AllProperties = ("customerId", "generation", "id", "name", "resourceUri", "type", "additionalDetails", "associatedResources", "childTasks", "createdAt", "displayName", "endedAt", "error", "estimatedRunningDurationMinutes", "healthStatus", "logMessages", "parentTask", "progressPercent", "recommendations", "sourceResource", "startedAt", "state", "suggestedPollingIntervalSeconds", "updatedAt", "userId")
