...
SystemPerformance<PSCustomObject>
#>

function Initialize-SystemPerformance {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => SystemPerformance' | Write-Debug
...
Convert from JSON to SystemPerformance<PSCustomObject>
...
SystemPerformance<PSCustomObject>
#>
function ConvertFrom-JsonToSystemPerformance {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => SystemPerformance' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in SystemPerformance
