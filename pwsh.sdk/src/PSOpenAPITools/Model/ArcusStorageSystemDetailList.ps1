...
.PARAMETER OverallState
overallState state derived from enclosure, disk and node state For deviceType1 State derived from ports, enclosure, disk and node state. For deviceType2 state is state reported by deviceType2 array. For deviceType4 state is derived from ports,enclosures,disks,nodes and enclosure-cards.`Filter, Sort`
.PARAMETER OverallStateDescription
...
ArcusStorageSystemDetailList<PSCustomObject>
#>

function Initialize-ArcusStorageSystemDetailList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ArcusStorageSystemDetailList' | Write-Debug
        ...
        $PSO = [PSCustomObject]@{
            ...
            "overallStateDescription" = ${OverallStateDescription}
...
Convert from JSON to ArcusStorageSystemDetailList<PSCustomObject>
...
ArcusStorageSystemDetailList<PSCustomObject>
#>
function ConvertFrom-JsonToArcusStorageSystemDetailList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ArcusStorageSystemDetailList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ArcusStorageSystemDetailList
        $AllProperties = ("associatedLinks", "centerplaneType", "chunkletSizeMiB", "clusterLED", "customerId", "descriptors", "deviceId", "deviceType", "displayname", "domain", "generation", "id", "inClusterNodes", "isFIPSEnabled", "locateEnabled", "maintenanceMode", "manufacturing", "masterNode", "minimumPasswordLength", "name", "networkMasterNode", "nodeMemory", "nodesCount", "nodesPresent", "onlineNodes", "overallState", "overallStateDescription", "parameters", "resourceUri", "safeToRemove", "softwareVersions", "state", "sysLogStatus", "systemDate", "systemWWN", "timezone", "type", "uptime", "version")
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "overallState"))) { #optional property not found
            $OverallState = $null
        } else {
            $OverallState = $JsonParameters.PSobject.Properties["overallState"].value
        }

        if (!([bool]($JsonParameters.PSobject.Properties.name -match "overallStateDescription"))) { #optional property not found
            $OverallStateDescription = $null
        } else {
            $OverallStateDescription = $JsonParameters.PSobject.Properties["overallStateDescription"].value
        }
