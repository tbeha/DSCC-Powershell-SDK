...
SnapshotsSummaryList<PSCustomObject>
#>

function Initialize-SnapshotsSummaryList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => SnapshotsSummaryList' | Write-Debug
...
Convert from JSON to SnapshotsSummaryList<PSCustomObject>
...
SnapshotsSummaryList<PSCustomObject>
#>
function ConvertFrom-JsonToSnapshotsSummaryList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => SnapshotsSummaryList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in SnapshotsSummaryList
