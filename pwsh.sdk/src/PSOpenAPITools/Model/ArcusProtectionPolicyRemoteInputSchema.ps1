...
ArcusProtectionPolicyRemoteInputSchema<PSCustomObject>
#>

function Initialize-ArcusProtectionPolicyRemoteInputSchema {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ArcusProtectionPolicyRemoteInputSchema' | Write-Debug
...
Convert from JSON to ArcusProtectionPolicyRemoteInputSchema<PSCustomObject>
...
ArcusProtectionPolicyRemoteInputSchema<PSCustomObject>
#>
function ConvertFrom-JsonToArcusProtectionPolicyRemoteInputSchema {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ArcusProtectionPolicyRemoteInputSchema' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ArcusProtectionPolicyRemoteInputSchema
