...
PortISCSI<PSCustomObject>
#>

function Initialize-PortISCSI {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PortISCSI' | Write-Debug
...
Convert from JSON to PortISCSI<PSCustomObject>
...
PortISCSI<PSCustomObject>
#>
function ConvertFrom-JsonToPortISCSI {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PortISCSI' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PortISCSI
