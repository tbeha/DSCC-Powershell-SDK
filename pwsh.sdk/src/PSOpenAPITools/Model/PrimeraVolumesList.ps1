...
PrimeraVolumesList<PSCustomObject>
#>

function Initialize-PrimeraVolumesList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PrimeraVolumesList' | Write-Debug
...
Convert from JSON to PrimeraVolumesList<PSCustomObject>
...
PrimeraVolumesList<PSCustomObject>
#>
function ConvertFrom-JsonToPrimeraVolumesList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PrimeraVolumesList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PrimeraVolumesList
