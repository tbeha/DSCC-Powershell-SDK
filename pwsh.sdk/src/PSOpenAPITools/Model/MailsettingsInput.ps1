...
MailsettingsInput<PSCustomObject>
#>

function Initialize-MailsettingsInput {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => MailsettingsInput' | Write-Debug
...
Convert from JSON to MailsettingsInput<PSCustomObject>
...
MailsettingsInput<PSCustomObject>
#>
function ConvertFrom-JsonToMailsettingsInput {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => MailsettingsInput' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in MailsettingsInput
