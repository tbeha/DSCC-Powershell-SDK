...
requestUri for detailed disks object
.PARAMETER Total
Number of disks
.OUTPUTS

ArcusdisksSummaryList<PSCustomObject>
#>

function Initialize-ArcusdisksSummaryList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ArcusdisksSummaryList' | Write-Debug
...
Convert from JSON to ArcusdisksSummaryList<PSCustomObject>
...
ArcusdisksSummaryList<PSCustomObject>
#>
function ConvertFrom-JsonToArcusdisksSummaryList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ArcusdisksSummaryList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ArcusdisksSummaryList
