...
VIPPoolCreateRequest<PSCustomObject>
#>

function Initialize-VIPPoolCreateRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => VIPPoolCreateRequest' | Write-Debug
...
Convert from JSON to VIPPoolCreateRequest<PSCustomObject>
...
VIPPoolCreateRequest<PSCustomObject>
#>
function ConvertFrom-JsonToVIPPoolCreateRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => VIPPoolCreateRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in VIPPoolCreateRequest
        $AllProperties = ("gateway", "ipRanges", "name", "nodeNames", "role", "subnetCidr", "vipPoolDomainName", "vlan")
