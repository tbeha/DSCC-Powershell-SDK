...
ArcusservicePorts<PSCustomObject>
#>

function Initialize-ArcusservicePorts {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ArcusservicePorts' | Write-Debug
...
Convert from JSON to ArcusservicePorts<PSCustomObject>
...
ArcusservicePorts<PSCustomObject>
#>
function ConvertFrom-JsonToArcusservicePorts {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ArcusservicePorts' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ArcusservicePorts
