...
Syscapacity<PSCustomObject>
#>

function Initialize-Syscapacity {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => Syscapacity' | Write-Debug
...
Convert from JSON to Syscapacity<PSCustomObject>
...
Syscapacity<PSCustomObject>
#>
function ConvertFrom-JsonToSyscapacity {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => Syscapacity' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Syscapacity
