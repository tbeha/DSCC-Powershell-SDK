...
ArcusenclosureCardPciDetails<PSCustomObject>
#>

function Initialize-ArcusenclosureCardPciDetails {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ArcusenclosureCardPciDetails' | Write-Debug
...
Convert from JSON to ArcusenclosureCardPciDetails<PSCustomObject>
...
ArcusenclosureCardPciDetails<PSCustomObject>
#>
function ConvertFrom-JsonToArcusenclosureCardPciDetails {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ArcusenclosureCardPciDetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ArcusenclosureCardPciDetails
        $AllProperties = ("customerId", "displayname", "domain", "enclosureCardId", "enclosureCardUid", "enclosureId", "enclosureUid", "fwVersion", "generation", "id", "manufacturing", "portCount", "revision", "slot", "systemId", "type")
