...
PortsSummaryList<PSCustomObject>
#>

function Initialize-PortsSummaryList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PortsSummaryList' | Write-Debug
...
Convert from JSON to PortsSummaryList<PSCustomObject>
...
PortsSummaryList<PSCustomObject>
#>
function ConvertFrom-JsonToPortsSummaryList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PortsSummaryList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PortsSummaryList
