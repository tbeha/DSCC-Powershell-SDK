...
NimbleFolderDetailsWithRequestUri<PSCustomObject>
#>

function Initialize-NimbleFolderDetailsWithRequestUri {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => NimbleFolderDetailsWithRequestUri' | Write-Debug
...
Convert from JSON to NimbleFolderDetailsWithRequestUri<PSCustomObject>
...
NimbleFolderDetailsWithRequestUri<PSCustomObject>
#>
function ConvertFrom-JsonToNimbleFolderDetailsWithRequestUri {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
