...
StorageTypes<PSCustomObject>
#>

function Initialize-StorageTypes {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => StorageTypes' | Write-Debug
...
Convert from JSON to StorageTypes<PSCustomObject>
...
StorageTypes<PSCustomObject>
#>
function ConvertFrom-JsonToStorageTypes {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => StorageTypes' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in StorageTypes
