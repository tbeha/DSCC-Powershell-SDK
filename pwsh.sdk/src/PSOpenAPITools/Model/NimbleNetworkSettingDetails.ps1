...
NimbleNetworkSettingDetails<PSCustomObject>
#>

function Initialize-NimbleNetworkSettingDetails {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => NimbleNetworkSettingDetails' | Write-Debug
...
Convert from JSON to NimbleNetworkSettingDetails<PSCustomObject>
...
NimbleNetworkSettingDetails<PSCustomObject>
#>
function ConvertFrom-JsonToNimbleNetworkSettingDetails {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => NimbleNetworkSettingDetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NimbleNetworkSettingDetails
        $AllProperties = ("active_since", "array_list", "associatedLinks", "consoleUri", "creation_time", "customerId", "generation", "group_leader_array", "iscsi_automatic_connection_method", "iscsi_connection_rebalancing", "last_active", "last_modified", "mgmt_ip", "resourceUri", "route_list", "secondary_mgmt_ip", "subnet_list", "type")
