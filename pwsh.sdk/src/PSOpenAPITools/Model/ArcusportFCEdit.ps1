...
ArcusportFCEdit<PSCustomObject>
#>

function Initialize-ArcusportFCEdit {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ArcusportFCEdit' | Write-Debug
...
Convert from JSON to ArcusportFCEdit<PSCustomObject>
...
ArcusportFCEdit<PSCustomObject>
#>
function ConvertFrom-JsonToArcusportFCEdit {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ArcusportFCEdit' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ArcusportFCEdit
