...
EnclosureDiskDetails<PSCustomObject>
#>

function Initialize-EnclosureDiskDetails {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => EnclosureDiskDetails' | Write-Debug
...
Convert from JSON to EnclosureDiskDetails<PSCustomObject>
...
EnclosureDiskDetails<PSCustomObject>
#>
function ConvertFrom-JsonToEnclosureDiskDetails {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => EnclosureDiskDetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in EnclosureDiskDetails
        $AllProperties = ("associatedLinks", "consoleUri", "customerId", "dc4data", "dcsdata", "displayname", "domain", "enclosureDeviceId", "enclosureId", "enclosureName", "enclosureType", "generation", "id", "loopA", "loopB", "manufacturing", "name", "position", "requestUri", "resourceUri", "systemId", "temperature", "type", "wwn")
