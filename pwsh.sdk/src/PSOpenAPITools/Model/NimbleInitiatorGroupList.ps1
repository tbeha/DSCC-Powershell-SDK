...
.PARAMETER Total
Total number of initiator groups.
.OUTPUTS

NimbleInitiatorGroupList<PSCustomObject>
#>

function Initialize-NimbleInitiatorGroupList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => NimbleInitiatorGroupList' | Write-Debug
...
Convert from JSON to NimbleInitiatorGroupList<PSCustomObject>
...
NimbleInitiatorGroupList<PSCustomObject>
#>
function ConvertFrom-JsonToNimbleInitiatorGroupList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => NimbleInitiatorGroupList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NimbleInitiatorGroupList
