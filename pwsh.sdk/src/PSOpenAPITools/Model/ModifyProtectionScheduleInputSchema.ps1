...
ModifyProtectionScheduleInputSchema<PSCustomObject>
#>

function Initialize-ModifyProtectionScheduleInputSchema {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ModifyProtectionScheduleInputSchema' | Write-Debug
...
Convert from JSON to ModifyProtectionScheduleInputSchema<PSCustomObject>
...
ModifyProtectionScheduleInputSchema<PSCustomObject>
#>
function ConvertFrom-JsonToModifyProtectionScheduleInputSchema {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ModifyProtectionScheduleInputSchema' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ModifyProtectionScheduleInputSchema
