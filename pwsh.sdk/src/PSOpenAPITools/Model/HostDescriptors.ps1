...
HostDescriptors<PSCustomObject>
#>

function Initialize-HostDescriptors {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => HostDescriptors' | Write-Debug
...
Convert from JSON to HostDescriptors<PSCustomObject>
...
HostDescriptors<PSCustomObject>
#>
function ConvertFrom-JsonToHostDescriptors {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => HostDescriptors' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in HostDescriptors
