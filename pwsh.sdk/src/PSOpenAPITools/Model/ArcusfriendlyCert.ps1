...
ArcusfriendlyCert<PSCustomObject>
#>

function Initialize-ArcusfriendlyCert {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ArcusfriendlyCert' | Write-Debug
...
Convert from JSON to ArcusfriendlyCert<PSCustomObject>
...
ArcusfriendlyCert<PSCustomObject>
#>
function ConvertFrom-JsonToArcusfriendlyCert {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ArcusfriendlyCert' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ArcusfriendlyCert
