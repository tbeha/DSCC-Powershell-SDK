...
WitnessDetails<PSCustomObject>
#>

function Initialize-WitnessDetails {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => WitnessDetails' | Write-Debug
...
Convert from JSON to WitnessDetails<PSCustomObject>
...
WitnessDetails<PSCustomObject>
#>
function ConvertFrom-JsonToWitnessDetails {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => WitnessDetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in WitnessDetails
