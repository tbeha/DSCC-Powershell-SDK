...
ResourceReference<PSCustomObject>
#>

function Initialize-ResourceReference {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ResourceReference' | Write-Debug
...
Convert from JSON to ResourceReference<PSCustomObject>
...
ResourceReference<PSCustomObject>
#>
function ConvertFrom-JsonToResourceReference {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ResourceReference' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ResourceReference
