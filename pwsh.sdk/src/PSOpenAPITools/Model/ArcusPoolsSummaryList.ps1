...
ArcusPoolsSummaryList<PSCustomObject>
#>

function Initialize-ArcusPoolsSummaryList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ArcusPoolsSummaryList' | Write-Debug
...
Convert from JSON to ArcusPoolsSummaryList<PSCustomObject>
...
ArcusPoolsSummaryList<PSCustomObject>
#>
function ConvertFrom-JsonToArcusPoolsSummaryList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ArcusPoolsSummaryList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ArcusPoolsSummaryList
