...
function Initialize-Uptime {
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => Uptime' | Write-Debug
...
Convert from JSON to Uptime<PSCustomObject>
...
Uptime<PSCustomObject>
#>
function ConvertFrom-JsonToUptime {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => Uptime' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Uptime
        $AllProperties = ("ms", "tz")
