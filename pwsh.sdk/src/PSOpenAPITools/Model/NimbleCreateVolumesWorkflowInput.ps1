...
function ConvertFrom-JsonToNimbleCreateVolumesWorkflowInput {
    ...
    Process {
        ...
        $AllProperties = ("agent_type", "app_uuid", "count", "dedupe_enabled", "downstreamPartner", "downstreamPartnerId", "folder_id", "host_groups", "limit", "limit_iops", "limit_mbps", "name", "perfpolicy", "perfpolicy_id", "pool_id", "protectionPolicyId", "protectionPolicySchedules", "replicationStartTime", "size", "suffix", "volColId", "volColName", "warn_level")
