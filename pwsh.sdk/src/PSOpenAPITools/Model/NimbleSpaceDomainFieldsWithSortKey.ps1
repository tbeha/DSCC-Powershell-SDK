...
NimbleSpaceDomainFieldsWithSortKey<PSCustomObject>
#>

function Initialize-NimbleSpaceDomainFieldsWithSortKey {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => NimbleSpaceDomainFieldsWithSortKey' | Write-Debug
...
Convert from JSON to NimbleSpaceDomainFieldsWithSortKey<PSCustomObject>
...
NimbleSpaceDomainFieldsWithSortKey<PSCustomObject>
#>
function ConvertFrom-JsonToNimbleSpaceDomainFieldsWithSortKey {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => NimbleSpaceDomainFieldsWithSortKey' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NimbleSpaceDomainFieldsWithSortKey
