...
function Initialize-Witness {
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => Witness' | Write-Debug
...
Convert from JSON to Witness<PSCustomObject>
...
Witness<PSCustomObject>
#>
function ConvertFrom-JsonToWitness {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => Witness' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Witness
