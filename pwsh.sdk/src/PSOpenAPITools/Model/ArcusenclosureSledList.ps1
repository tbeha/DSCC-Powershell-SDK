...
ArcusenclosureSledList<PSCustomObject>
#>

function Initialize-ArcusenclosureSledList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ArcusenclosureSledList' | Write-Debug
...
Convert from JSON to ArcusenclosureSledList<PSCustomObject>
...
ArcusenclosureSledList<PSCustomObject>
#>
function ConvertFrom-JsonToArcusenclosureSledList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ArcusenclosureSledList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ArcusenclosureSledList
        $AllProperties = ("associatedLinks", "customerId", "dc4data", "diskCount", "displayname", "domain", "elementStatusCode", "enclosureId", "enclosureName", "enclosureType", "enclosureUid", "failIndicator", "generation", "id", "locateEnabled", "manufacturing", "name", "okIndicator", "portBypassA", "portBypassB", "power", "predFailIndicator", "protocol", "resourceUri", "safeToRemove", "sledId", "stateLoopA", "stateLoopB", "systemId", "temperature", "type", "wwn")
