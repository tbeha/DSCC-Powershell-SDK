...
ArcusPortPosAndLinkInput<PSCustomObject>
#>

function Initialize-ArcusPortPosAndLinkInput {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ArcusPortPosAndLinkInput' | Write-Debug
...
Convert from JSON to ArcusPortPosAndLinkInput<PSCustomObject>
...
ArcusPortPosAndLinkInput<PSCustomObject>
#>
function ConvertFrom-JsonToArcusPortPosAndLinkInput {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ArcusPortPosAndLinkInput' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ArcusPortPosAndLinkInput
