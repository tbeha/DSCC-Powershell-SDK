...
PrimeraHostPaths<PSCustomObject>
#>

function Initialize-PrimeraHostPaths {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PrimeraHostPaths' | Write-Debug
...
Convert from JSON to PrimeraHostPaths<PSCustomObject>
...
PrimeraHostPaths<PSCustomObject>
#>
function ConvertFrom-JsonToPrimeraHostPaths {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PrimeraHostPaths' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PrimeraHostPaths
