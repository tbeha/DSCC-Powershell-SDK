...
ArcusApplicationSetsList<PSCustomObject>
#>

function Initialize-ArcusApplicationSetsList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ArcusApplicationSetsList' | Write-Debug
...
Convert from JSON to ArcusApplicationSetsList<PSCustomObject>
...
ArcusApplicationSetsList<PSCustomObject>
#>
function ConvertFrom-JsonToArcusApplicationSetsList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ArcusApplicationSetsList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ArcusApplicationSetsList
