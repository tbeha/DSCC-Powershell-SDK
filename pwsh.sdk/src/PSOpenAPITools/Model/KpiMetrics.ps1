...
KpiMetrics<PSCustomObject>
#>

function Initialize-KpiMetrics {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => KpiMetrics' | Write-Debug
...
Convert from JSON to KpiMetrics<PSCustomObject>
...
KpiMetrics<PSCustomObject>
#>
function ConvertFrom-JsonToKpiMetrics {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => KpiMetrics' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in KpiMetrics
