...
EnclosureFanDetails<PSCustomObject>
#>

function Initialize-EnclosureFanDetails {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => EnclosureFanDetails' | Write-Debug
...
Convert from JSON to EnclosureFanDetails<PSCustomObject>
...
EnclosureFanDetails<PSCustomObject>
#>
function ConvertFrom-JsonToEnclosureFanDetails {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => EnclosureFanDetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in EnclosureFanDetails
        $AllProperties = ("associatedLinks", "consoleUri", "customerId", "displayname", "domain", "elementStatusCode", "enclosureCoolingFanId", "enclosureDeviceId", "enclosureId", "enclosureName", "enclosureType", "failIndicator", "generation", "id", "locateEnabled", "manufacturing", "name", "partNumber", "protocol", "psId", "requestUri", "resourceUri", "safeToRemove", "speed", "speedRpm", "state", "systemId", "type", "wwn")
