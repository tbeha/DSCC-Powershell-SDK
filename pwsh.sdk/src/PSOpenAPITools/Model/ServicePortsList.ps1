...
ServicePortsList<PSCustomObject>
#>

function Initialize-ServicePortsList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ServicePortsList' | Write-Debug
...
Convert from JSON to ServicePortsList<PSCustomObject>
...
ServicePortsList<PSCustomObject>
#>
function ConvertFrom-JsonToServicePortsList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ServicePortsList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ServicePortsList
