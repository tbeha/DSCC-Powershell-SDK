...
TasksForbidden<PSCustomObject>
#>

function Initialize-TasksForbidden {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => TasksForbidden' | Write-Debug
...
Convert from JSON to TasksForbidden<PSCustomObject>
...
TasksForbidden<PSCustomObject>
#>
function ConvertFrom-JsonToTasksForbidden {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => TasksForbidden' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in TasksForbidden
