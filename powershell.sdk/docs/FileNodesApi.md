# PSOpenAPITools.PSOpenAPITools\Api.FileNodesApi

All URIs are relative to *https://eu1.data.cloud.hpe.com*

Method | HTTP request | Description
------------- | ------------- | -------------
[**Invoke-DeviceType6GetNodeById**](FileNodesApi.md#Invoke-DeviceType6GetNodeById) | **GET** /api/v1/storage-systems/device-type6/{systemUuid}/nodes/{nodeUuid} | File Server Node GET operation
[**Invoke-DeviceType6GetNodes**](FileNodesApi.md#Invoke-DeviceType6GetNodes) | **GET** /api/v1/storage-systems/device-type6/{systemUuid}/nodes | File Server Node GET operation


<a id="Invoke-DeviceType6GetNodeById"></a>
# **Invoke-DeviceType6GetNodeById**
> GetNodeResponse Invoke-DeviceType6GetNodeById<br>
...
$NodeUuid = "8UW0002928" # String | Unique identifier for fileserver node

# File Server Node GET operation
try {
    $Result = Invoke-DeviceType6GetNodeById -SystemUuid $SystemUuid -NodeUuid $NodeUuid
} catch {
    Write-Host ("Exception occurred when calling Invoke-DeviceType6GetNodeById: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
 ...
 **NodeUuid** | **String**| Unique identifier for fileserver node | 

### Return type

[**GetNodeResponse**](GetNodeResponse.md) (PSCustomObject)
...
<a id="Invoke-DeviceType6GetNodes"></a>
# **Invoke-DeviceType6GetNodes**
> DeviceType6GetNodes200Response Invoke-DeviceType6GetNodes<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-SystemUuid] <String><br>
...
# File Server Node GET operation
try {
    $Result = Invoke-DeviceType6GetNodes -SystemUuid $SystemUuid -Limit $Limit -Offset $Offset -Filter $Filter -Sort $Sort
} catch {
    Write-Host ("Exception occurred when calling Invoke-DeviceType6GetNodes: {0}" -f ($_.ErrorDetails | ConvertFrom-Json))
    Write-Host ("Response headers: {0}" -f ($_.Exception.Response.Headers | ConvertTo-Json))
}
```
...
[**DeviceType6GetNodes200Response**](DeviceType6GetNodes200Response.md) (PSCustomObject)
