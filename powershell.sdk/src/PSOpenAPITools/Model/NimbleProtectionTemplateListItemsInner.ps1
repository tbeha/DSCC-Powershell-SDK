...
NimbleProtectionTemplateListItemsInner<PSCustomObject>
#>

function Initialize-NimbleProtectionTemplateListItemsInner {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => NimbleProtectionTemplateListItemsInner' | Write-Debug
...
Convert from JSON to NimbleProtectionTemplateListItemsInner<PSCustomObject>
...
NimbleProtectionTemplateListItemsInner<PSCustomObject>
#>
function ConvertFrom-JsonToNimbleProtectionTemplateListItemsInner {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
