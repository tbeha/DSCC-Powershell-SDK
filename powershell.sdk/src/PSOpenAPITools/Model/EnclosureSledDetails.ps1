...
EnclosureSledDetails<PSCustomObject>
#>

function Initialize-EnclosureSledDetails {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => EnclosureSledDetails' | Write-Debug
...
Convert from JSON to EnclosureSledDetails<PSCustomObject>
...
EnclosureSledDetails<PSCustomObject>
#>
function ConvertFrom-JsonToEnclosureSledDetails {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => EnclosureSledDetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in EnclosureSledDetails
        $AllProperties = ("associatedLinks", "consoleUri", "customerId", "dc4data", "diskCount", "displayname", "domain", "elementStatusCode", "enclosureDeviceId", "enclosureId", "enclosureName", "enclosureType", "failIndicator", "generation", "id", "locateEnabled", "manufacturing", "name", "okIndicator", "portBypassA", "portBypassB", "power", "predFailIndicator", "protocol", "requestUri", "resourceUri", "safeToRemove", "sledId", "stateLoopA", "stateLoopB", "systemId", "temperature", "type", "wwn")
