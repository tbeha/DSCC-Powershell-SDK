...
EnclosuresSummaryList<PSCustomObject>
#>

function Initialize-EnclosuresSummaryList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => EnclosuresSummaryList' | Write-Debug
...
Convert from JSON to EnclosuresSummaryList<PSCustomObject>
...
EnclosuresSummaryList<PSCustomObject>
#>
function ConvertFrom-JsonToEnclosuresSummaryList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => EnclosuresSummaryList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in EnclosuresSummaryList
