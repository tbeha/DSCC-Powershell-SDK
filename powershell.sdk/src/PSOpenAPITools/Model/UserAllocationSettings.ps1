...
UserAllocationSettings<PSCustomObject>
#>

function Initialize-UserAllocationSettings {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => UserAllocationSettings' | Write-Debug
...
Convert from JSON to UserAllocationSettings<PSCustomObject>
...
UserAllocationSettings<PSCustomObject>
#>
function ConvertFrom-JsonToUserAllocationSettings {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => UserAllocationSettings' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in UserAllocationSettings
