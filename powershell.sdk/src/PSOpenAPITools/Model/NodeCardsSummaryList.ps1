...
NodeCardsSummaryList<PSCustomObject>
#>

function Initialize-NodeCardsSummaryList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => NodeCardsSummaryList' | Write-Debug
...
Convert from JSON to NodeCardsSummaryList<PSCustomObject>
...
NodeCardsSummaryList<PSCustomObject>
#>
function ConvertFrom-JsonToNodeCardsSummaryList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => NodeCardsSummaryList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NodeCardsSummaryList
