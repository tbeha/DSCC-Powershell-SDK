...
PortRCIPPing<PSCustomObject>
#>

function Initialize-PortRCIPPing {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PortRCIPPing' | Write-Debug
...
Convert from JSON to PortRCIPPing<PSCustomObject>
...
PortRCIPPing<PSCustomObject>
#>
function ConvertFrom-JsonToPortRCIPPing {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PortRCIPPing' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PortRCIPPing
