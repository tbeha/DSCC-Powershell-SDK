...
Time when the drive was inserted
...
function Initialize-Calendar {
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => Calendar' | Write-Debug
...
Convert from JSON to Calendar<PSCustomObject>
...
Calendar<PSCustomObject>
#>
function ConvertFrom-JsonToCalendar {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => Calendar' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Calendar
        $AllProperties = ("ms", "tz")
