...
ArcusnwSnmpMgrEdit<PSCustomObject>
#>

function Initialize-ArcusnwSnmpMgrEdit {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ArcusnwSnmpMgrEdit' | Write-Debug
...
Convert from JSON to ArcusnwSnmpMgrEdit<PSCustomObject>
...
ArcusnwSnmpMgrEdit<PSCustomObject>
#>
function ConvertFrom-JsonToArcusnwSnmpMgrEdit {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ArcusnwSnmpMgrEdit' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ArcusnwSnmpMgrEdit
