...
VcenterSettingDetail<PSCustomObject>
#>

function Initialize-VcenterSettingDetail {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => VcenterSettingDetail' | Write-Debug
...
Convert from JSON to VcenterSettingDetail<PSCustomObject>
...
VcenterSettingDetail<PSCustomObject>
#>
function ConvertFrom-JsonToVcenterSettingDetail {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => VcenterSettingDetail' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in VcenterSettingDetail
