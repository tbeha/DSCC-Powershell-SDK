...
ArcusalertContacts<PSCustomObject>
#>

function Initialize-ArcusalertContacts {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ArcusalertContacts' | Write-Debug
...
Convert from JSON to ArcusalertContacts<PSCustomObject>
...
ArcusalertContacts<PSCustomObject>
#>
function ConvertFrom-JsonToArcusalertContacts {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ArcusalertContacts' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ArcusalertContacts
