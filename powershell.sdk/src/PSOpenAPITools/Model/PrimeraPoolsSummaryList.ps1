...
PrimeraPoolsSummaryList<PSCustomObject>
#>

function Initialize-PrimeraPoolsSummaryList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PrimeraPoolsSummaryList' | Write-Debug
...
Convert from JSON to PrimeraPoolsSummaryList<PSCustomObject>
...
PrimeraPoolsSummaryList<PSCustomObject>
#>
function ConvertFrom-JsonToPrimeraPoolsSummaryList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PrimeraPoolsSummaryList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PrimeraPoolsSummaryList
