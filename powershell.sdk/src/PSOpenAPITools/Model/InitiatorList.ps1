...
InitiatorList<PSCustomObject>
#>

function Initialize-InitiatorList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => InitiatorList' | Write-Debug
...
Convert from JSON to InitiatorList<PSCustomObject>
...
InitiatorList<PSCustomObject>
#>
function ConvertFrom-JsonToInitiatorList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => InitiatorList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in InitiatorList
