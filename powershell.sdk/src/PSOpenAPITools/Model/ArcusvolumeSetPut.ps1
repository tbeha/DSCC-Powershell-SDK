...
ArcusvolumeSetPut<PSCustomObject>
#>

function Initialize-ArcusvolumeSetPut {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ArcusvolumeSetPut' | Write-Debug
...
Convert from JSON to ArcusvolumeSetPut<PSCustomObject>
...
ArcusvolumeSetPut<PSCustomObject>
#>
function ConvertFrom-JsonToArcusvolumeSetPut {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ArcusvolumeSetPut' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ArcusvolumeSetPut
        $AllProperties = ("addMembers", "appSetBusinessUnit", "appSetComments", "appSetName", "appSetType", "customAppType", "removeMembers")
