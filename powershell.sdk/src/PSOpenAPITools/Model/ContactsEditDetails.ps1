...
ContactsEditDetails<PSCustomObject>
#>

function Initialize-ContactsEditDetails {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ContactsEditDetails' | Write-Debug
...
Convert from JSON to ContactsEditDetails<PSCustomObject>
...
ContactsEditDetails<PSCustomObject>
#>
function ConvertFrom-JsonToContactsEditDetails {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ContactsEditDetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ContactsEditDetails
