...
PortIP<PSCustomObject>
#>

function Initialize-PortIP {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PortIP' | Write-Debug
...
Convert from JSON to PortIP<PSCustomObject>
...
PortIP<PSCustomObject>
#>
function ConvertFrom-JsonToPortIP {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PortIP' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PortIP
