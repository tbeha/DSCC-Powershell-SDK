...
requestUri for nimble initiator objects
.PARAMETER Total
Total number of initiators.
.OUTPUTS

NimbleInitiatorsList<PSCustomObject>
#>

function Initialize-NimbleInitiatorsList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => NimbleInitiatorsList' | Write-Debug
...
Convert from JSON to NimbleInitiatorsList<PSCustomObject>
...
NimbleInitiatorsList<PSCustomObject>
#>
function ConvertFrom-JsonToNimbleInitiatorsList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => NimbleInitiatorsList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NimbleInitiatorsList
