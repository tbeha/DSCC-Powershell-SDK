...
requestUri for detailed health status object
.PARAMETER ArrayId
...
NimbleHealthStatusDetailsWithRequestUri<PSCustomObject>
#>

function Initialize-NimbleHealthStatusDetailsWithRequestUri {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => NimbleHealthStatusDetailsWithRequestUri' | Write-Debug
...
Convert from JSON to NimbleHealthStatusDetailsWithRequestUri<PSCustomObject>
...
NimbleHealthStatusDetailsWithRequestUri<PSCustomObject>
#>
function ConvertFrom-JsonToNimbleHealthStatusDetailsWithRequestUri {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => NimbleHealthStatusDetailsWithRequestUri' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NimbleHealthStatusDetailsWithRequestUri
        $AllProperties = ("requestUri", "array_id", "context", "ctrlr_id", "id", "scope", "associatedLinks", "customerId", "element_result", "generation", "on_demand", "resourceUri")
