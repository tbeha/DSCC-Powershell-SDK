...
requestUri for detailed controller object
.PARAMETER ArrayId
...
NimbleControllerDetailsWithRequestUri<PSCustomObject>
#>

function Initialize-NimbleControllerDetailsWithRequestUri {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => NimbleControllerDetailsWithRequestUri' | Write-Debug
...
Convert from JSON to NimbleControllerDetailsWithRequestUri<PSCustomObject>
...
NimbleControllerDetailsWithRequestUri<PSCustomObject>
#>
function ConvertFrom-JsonToNimbleControllerDetailsWithRequestUri {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
