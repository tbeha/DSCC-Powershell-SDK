...
generation
.PARAMETER Id
UUID string uniquely identifying the node object.
.PARAMETER JedecId
JEDEC ID
...
requestUri for detailed node memory object
...
NodeMemoryDetails<PSCustomObject>
#>

function Initialize-NodeMemoryDetails {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => NodeMemoryDetails' | Write-Debug
...
Convert from JSON to NodeMemoryDetails<PSCustomObject>
...
NodeMemoryDetails<PSCustomObject>
#>
function ConvertFrom-JsonToNodeMemoryDetails {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => NodeMemoryDetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NodeMemoryDetails
        $AllProperties = ("associatedLinks", "cacheType", "casLatency", "consoleUri", "customerId", "displayname", "domain", "generation", "id", "jedecId", "manufacturing", "name", "nodeDeviceId", "nodeId", "nodeMemoryType", "partNumber", "requestUri", "resourceUri", "revision", "riser", "size", "slot", "slotId", "systemId", "type")
