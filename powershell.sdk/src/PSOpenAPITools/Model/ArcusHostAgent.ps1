...
ArcusHostAgent<PSCustomObject>
#>

function Initialize-ArcusHostAgent {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ArcusHostAgent' | Write-Debug
...
Convert from JSON to ArcusHostAgent<PSCustomObject>
...
ArcusHostAgent<PSCustomObject>
#>
function ConvertFrom-JsonToArcusHostAgent {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ArcusHostAgent' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ArcusHostAgent
