...
requestUri for folder objects
.PARAMETER Total
Total number of folders.
.OUTPUTS

NimbleFolderList<PSCustomObject>
#>

function Initialize-NimbleFolderList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => NimbleFolderList' | Write-Debug
...
Convert from JSON to NimbleFolderList<PSCustomObject>
...
NimbleFolderList<PSCustomObject>
#>
function ConvertFrom-JsonToNimbleFolderList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => NimbleFolderList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NimbleFolderList
