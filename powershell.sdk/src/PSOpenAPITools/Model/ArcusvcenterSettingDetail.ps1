...
requestUri for vcenter setting details per system 
...
ArcusvcenterSettingDetail<PSCustomObject>
#>

function Initialize-ArcusvcenterSettingDetail {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ArcusvcenterSettingDetail' | Write-Debug
...
Convert from JSON to ArcusvcenterSettingDetail<PSCustomObject>
...
ArcusvcenterSettingDetail<PSCustomObject>
#>
function ConvertFrom-JsonToArcusvcenterSettingDetail {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ArcusvcenterSettingDetail' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ArcusvcenterSettingDetail
        $AllProperties = ("consoleUri", "customerId", "description", "friendlyCert", "generation", "id", "inetaddress", "name", "port", "requestUri", "resourceUri", "status", "systemId", "type", "username", "vmManagerType")
