...
SnapSpace<PSCustomObject>
#>

function Initialize-SnapSpace {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => SnapSpace' | Write-Debug
...
Convert from JSON to SnapSpace<PSCustomObject>
...
SnapSpace<PSCustomObject>
#>
function ConvertFrom-JsonToSnapSpace {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => SnapSpace' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in SnapSpace
