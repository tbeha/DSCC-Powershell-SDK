...
requestUri for shelf objects
.PARAMETER Total
Total number of shelves.
.OUTPUTS

NimbleShelfList<PSCustomObject>
#>

function Initialize-NimbleShelfList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => NimbleShelfList' | Write-Debug
...
Convert from JSON to NimbleShelfList<PSCustomObject>
...
NimbleShelfList<PSCustomObject>
#>
function ConvertFrom-JsonToNimbleShelfList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => NimbleShelfList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NimbleShelfList
