...
function Initialize-Parameters {
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => Parameters' | Write-Debug
...
Convert from JSON to Parameters<PSCustomObject>
...
Parameters<PSCustomObject>
#>
function ConvertFrom-JsonToParameters {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => Parameters' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Parameters
