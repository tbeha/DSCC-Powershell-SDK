...
overallState state derived from enclosure, disk and node state For deviceType1 State derived from ports, enclosure, disk and node state for deviceType2 state is state reported by deviceType2 array `Filter, Sort`
...
PrimeraStorageSystemDetailList<PSCustomObject>
#>

function Initialize-PrimeraStorageSystemDetailList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PrimeraStorageSystemDetailList' | Write-Debug
...
Convert from JSON to PrimeraStorageSystemDetailList<PSCustomObject>
...
PrimeraStorageSystemDetailList<PSCustomObject>
#>
function ConvertFrom-JsonToPrimeraStorageSystemDetailList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PrimeraStorageSystemDetailList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PrimeraStorageSystemDetailList
        $AllProperties = ("associatedLinks", "centerplaneType", "chunkletSizeMiB", "clusterLED", "customerId", "descriptors", "deviceId", "deviceType", "displayname", "domain", "generation", "id", "inClusterNodes", "isFIPSEnabled", "locateEnabled", "maintenanceMode", "manufacturing", "masterNode", "minimumPasswordLength", "name", "networkMasterNode", "nodeMemory", "nodesCount", "nodesPresent", "onlineNodes", "overallState", "parameters", "resourceUri", "safeToRemove", "softwareVersions", "state", "sysLogStatus", "systemDate", "systemHeadroom", "systemWWN", "timezone", "type", "uptime", "version")
