...
requestUri for detailed node Drive object
.PARAMETER Total
Number of node Drives.
.OUTPUTS

NodeDrivesSummaryList<PSCustomObject>
#>

function Initialize-NodeDrivesSummaryList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => NodeDrivesSummaryList' | Write-Debug
...
Convert from JSON to NodeDrivesSummaryList<PSCustomObject>
...
NodeDrivesSummaryList<PSCustomObject>
#>
function ConvertFrom-JsonToNodeDrivesSummaryList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => NodeDrivesSummaryList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NodeDrivesSummaryList
