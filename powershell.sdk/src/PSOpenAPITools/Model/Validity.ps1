...
function Initialize-Validity {
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => Validity' | Write-Debug
...
Convert from JSON to Validity<PSCustomObject>
...
Validity<PSCustomObject>
#>
function ConvertFrom-JsonToValidity {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => Validity' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Validity
        $AllProperties = ("ms", "tz")
