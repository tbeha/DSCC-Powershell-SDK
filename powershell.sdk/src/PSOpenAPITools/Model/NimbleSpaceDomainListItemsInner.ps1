...
NimbleSpaceDomainListItemsInner<PSCustomObject>
#>

function Initialize-NimbleSpaceDomainListItemsInner {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => NimbleSpaceDomainListItemsInner' | Write-Debug
...
Convert from JSON to NimbleSpaceDomainListItemsInner<PSCustomObject>
...
NimbleSpaceDomainListItemsInner<PSCustomObject>
#>
function ConvertFrom-JsonToNimbleSpaceDomainListItemsInner {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => NimbleSpaceDomainListItemsInner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NimbleSpaceDomainListItemsInner
