...
requestUri for  Network Interfaces
.PARAMETER Total
Total number of Network Interfaces.
.OUTPUTS

NimbleNetworkInterfaceList<PSCustomObject>
#>

function Initialize-NimbleNetworkInterfaceList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => NimbleNetworkInterfaceList' | Write-Debug
...
Convert from JSON to NimbleNetworkInterfaceList<PSCustomObject>
...
NimbleNetworkInterfaceList<PSCustomObject>
#>
function ConvertFrom-JsonToNimbleNetworkInterfaceList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => NimbleNetworkInterfaceList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NimbleNetworkInterfaceList
