...
ArcusperformanceHistoryDataHistoryData<PSCustomObject>
#>

function Initialize-ArcusperformanceHistoryDataHistoryData {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ArcusperformanceHistoryDataHistoryData' | Write-Debug
...
Convert from JSON to ArcusperformanceHistoryDataHistoryData<PSCustomObject>
...
ArcusperformanceHistoryDataHistoryData<PSCustomObject>
#>
function ConvertFrom-JsonToArcusperformanceHistoryDataHistoryData {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ArcusperformanceHistoryDataHistoryData' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ArcusperformanceHistoryDataHistoryData
