...
ArcusReplicationPartnerCommonFields<PSCustomObject>
#>

function Initialize-ArcusReplicationPartnerCommonFields {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ArcusReplicationPartnerCommonFields' | Write-Debug
...
Convert from JSON to ArcusReplicationPartnerCommonFields<PSCustomObject>
...
ArcusReplicationPartnerCommonFields<PSCustomObject>
#>
function ConvertFrom-JsonToArcusReplicationPartnerCommonFields {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
