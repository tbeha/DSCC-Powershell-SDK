...
FriendlyCertificate<PSCustomObject>
#>

function Initialize-FriendlyCertificate {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => FriendlyCertificate' | Write-Debug
...
Convert from JSON to FriendlyCertificate<PSCustomObject>
...
FriendlyCertificate<PSCustomObject>
#>
function ConvertFrom-JsonToFriendlyCertificate {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => FriendlyCertificate' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in FriendlyCertificate
