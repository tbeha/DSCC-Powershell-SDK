...
function Initialize-Partner {
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => Partner' | Write-Debug
...
Convert from JSON to Partner<PSCustomObject>
...
Partner<PSCustomObject>
#>
function ConvertFrom-JsonToPartner {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => Partner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Partner
