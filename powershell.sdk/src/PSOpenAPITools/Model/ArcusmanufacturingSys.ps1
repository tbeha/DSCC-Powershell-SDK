...
ArcusmanufacturingSys<PSCustomObject>
#>

function Initialize-ArcusmanufacturingSys {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ArcusmanufacturingSys' | Write-Debug
...
Convert from JSON to ArcusmanufacturingSys<PSCustomObject>
...
ArcusmanufacturingSys<PSCustomObject>
#>
function ConvertFrom-JsonToArcusmanufacturingSys {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ArcusmanufacturingSys' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ArcusmanufacturingSys
