...
requestUri for detailed external key manager objects
.PARAMETER Id
...
ExternalKeyManagerDetails<PSCustomObject>
#>

function Initialize-ExternalKeyManagerDetails {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ExternalKeyManagerDetails' | Write-Debug
...
Convert from JSON to ExternalKeyManagerDetails<PSCustomObject>
...
ExternalKeyManagerDetails<PSCustomObject>
#>
function ConvertFrom-JsonToExternalKeyManagerDetails {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ExternalKeyManagerDetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ExternalKeyManagerDetails
        $AllProperties = ("requestUri", "id", "name", "active", "consoleUri", "description", "hostname", "port", "protocol", "resourceUri", "status", "username")
