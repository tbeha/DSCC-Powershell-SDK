...
Arcusrecommendation<PSCustomObject>
#>

function Initialize-Arcusrecommendation {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => Arcusrecommendation' | Write-Debug
...
Convert from JSON to Arcusrecommendation<PSCustomObject>
...
Arcusrecommendation<PSCustomObject>
#>
function ConvertFrom-JsonToArcusrecommendation {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => Arcusrecommendation' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Arcusrecommendation
