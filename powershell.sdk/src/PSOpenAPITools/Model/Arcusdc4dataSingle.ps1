...
Arcusdc4dataSingle<PSCustomObject>
#>

function Initialize-Arcusdc4dataSingle {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => Arcusdc4dataSingle' | Write-Debug
...
Convert from JSON to Arcusdc4dataSingle<PSCustomObject>
...
Arcusdc4dataSingle<PSCustomObject>
#>
function ConvertFrom-JsonToArcusdc4dataSingle {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => Arcusdc4dataSingle' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Arcusdc4dataSingle
