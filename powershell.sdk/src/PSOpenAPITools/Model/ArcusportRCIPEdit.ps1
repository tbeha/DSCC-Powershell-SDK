...
ArcusportRCIPEdit<PSCustomObject>
#>

function Initialize-ArcusportRCIPEdit {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ArcusportRCIPEdit' | Write-Debug
...
Convert from JSON to ArcusportRCIPEdit<PSCustomObject>
...
ArcusportRCIPEdit<PSCustomObject>
#>
function ConvertFrom-JsonToArcusportRCIPEdit {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ArcusportRCIPEdit' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ArcusportRCIPEdit
