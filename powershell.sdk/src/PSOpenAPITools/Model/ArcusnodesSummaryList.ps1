...
ArcusnodesSummaryList<PSCustomObject>
#>

function Initialize-ArcusnodesSummaryList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ArcusnodesSummaryList' | Write-Debug
...
Convert from JSON to ArcusnodesSummaryList<PSCustomObject>
...
ArcusnodesSummaryList<PSCustomObject>
#>
function ConvertFrom-JsonToArcusnodesSummaryList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ArcusnodesSummaryList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ArcusnodesSummaryList
