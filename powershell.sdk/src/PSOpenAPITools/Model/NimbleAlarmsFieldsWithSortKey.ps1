...
.PARAMETER Activity
Description of activity performed and recorded in alarm. String of 1-1476 printable characters. `Filter, Sort`
.PARAMETER Array
...
NimbleAlarmsFieldsWithSortKey<PSCustomObject>
#>

function Initialize-NimbleAlarmsFieldsWithSortKey {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => NimbleAlarmsFieldsWithSortKey' | Write-Debug
...
Convert from JSON to NimbleAlarmsFieldsWithSortKey<PSCustomObject>
...
NimbleAlarmsFieldsWithSortKey<PSCustomObject>
#>
function ConvertFrom-JsonToNimbleAlarmsFieldsWithSortKey {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => NimbleAlarmsFieldsWithSortKey' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NimbleAlarmsFieldsWithSortKey
        $AllProperties = ("ack_time", "activity", "array", "category", "curr_onset_event_id", "id", "next_notification_time", "object_id", "object_name", "object_type", "onset_time", "remind_every", "remind_every_unit", "severity", "status", "user_full_name", "user_id", "user_name")
