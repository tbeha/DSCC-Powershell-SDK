...
ArcusContactsDetails<PSCustomObject>
#>

function Initialize-ArcusContactsDetails {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ArcusContactsDetails' | Write-Debug
...
Convert from JSON to ArcusContactsDetails<PSCustomObject>
...
ArcusContactsDetails<PSCustomObject>
#>
function ConvertFrom-JsonToArcusContactsDetails {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ArcusContactsDetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ArcusContactsDetails
