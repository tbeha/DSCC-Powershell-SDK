...
Request Uri for witness objects
.PARAMETER Total
Total number of witnesses.
.OUTPUTS

NimbleWitnessesList<PSCustomObject>
#>

function Initialize-NimbleWitnessesList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => NimbleWitnessesList' | Write-Debug
...
Convert from JSON to NimbleWitnessesList<PSCustomObject>
...
NimbleWitnessesList<PSCustomObject>
#>
function ConvertFrom-JsonToNimbleWitnessesList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => NimbleWitnessesList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NimbleWitnessesList
