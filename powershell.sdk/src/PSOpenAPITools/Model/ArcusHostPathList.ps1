...
requestUri for HPE Alletra Storage MP Hostpath objects
.PARAMETER Total
Total number of host paths.
.OUTPUTS

ArcusHostPathList<PSCustomObject>
#>

function Initialize-ArcusHostPathList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ArcusHostPathList' | Write-Debug
...
Convert from JSON to ArcusHostPathList<PSCustomObject>
...
ArcusHostPathList<PSCustomObject>
#>
function ConvertFrom-JsonToArcusHostPathList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ArcusHostPathList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ArcusHostPathList
