...
ArcusvlunsList<PSCustomObject>
#>

function Initialize-ArcusvlunsList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ArcusvlunsList' | Write-Debug
...
Convert from JSON to ArcusvlunsList<PSCustomObject>
...
ArcusvlunsList<PSCustomObject>
#>
function ConvertFrom-JsonToArcusvlunsList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ArcusvlunsList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ArcusvlunsList
