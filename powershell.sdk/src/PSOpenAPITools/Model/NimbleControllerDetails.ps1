...
NimbleControllerDetails<PSCustomObject>
#>

function Initialize-NimbleControllerDetails {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => NimbleControllerDetails' | Write-Debug
...
Convert from JSON to NimbleControllerDetails<PSCustomObject>
...
NimbleControllerDetails<PSCustomObject>
#>
function ConvertFrom-JsonToNimbleControllerDetails {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => NimbleControllerDetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NimbleControllerDetails
        $AllProperties = ("associated_links", "asup_time", "consoleUri", "ctrlr_side", "customerId", "fan_status", "fans", "generation", "hostname", "nvme_cards", "nvme_cards_enabled", "partial_response_ok", "partition_status", "power_status", "power_supplies", "resourceUri", "state", "support_address", "support_netmask", "support_nic", "temperature_sensors", "temperature_status", "type", "update_end_time", "update_error_code", "update_progress_msg", "update_start_time", "update_state", "version_current", "version_rollback", "version_target")
