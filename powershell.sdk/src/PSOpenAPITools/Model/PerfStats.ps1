...
PerfStats<PSCustomObject>
#>

function Initialize-PerfStats {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PerfStats' | Write-Debug
...
Convert from JSON to PerfStats<PSCustomObject>
...
PerfStats<PSCustomObject>
#>
function ConvertFrom-JsonToPerfStats {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PerfStats' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PerfStats
