...
CreateCloneVolumeInput<PSCustomObject>
#>

function Initialize-CreateCloneVolumeInput {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => CreateCloneVolumeInput' | Write-Debug
...
Convert from JSON to CreateCloneVolumeInput<PSCustomObject>
...
CreateCloneVolumeInput<PSCustomObject>
#>
function ConvertFrom-JsonToCreateCloneVolumeInput {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => CreateCloneVolumeInput' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in CreateCloneVolumeInput
