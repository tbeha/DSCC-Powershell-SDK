...
NimbleNewArrayList<PSCustomObject>
#>

function Initialize-NimbleNewArrayList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => NimbleNewArrayList' | Write-Debug
...
Convert from JSON to NimbleNewArrayList<PSCustomObject>
...
NimbleNewArrayList<PSCustomObject>
#>
function ConvertFrom-JsonToNimbleNewArrayList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => NimbleNewArrayList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NimbleNewArrayList
