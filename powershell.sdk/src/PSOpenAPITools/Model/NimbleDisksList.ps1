...
requestUri for disk objects
.PARAMETER Total
Total number of disks.
.OUTPUTS

NimbleDisksList<PSCustomObject>
#>

function Initialize-NimbleDisksList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => NimbleDisksList' | Write-Debug
...
Convert from JSON to NimbleDisksList<PSCustomObject>
...
NimbleDisksList<PSCustomObject>
#>
function ConvertFrom-JsonToNimbleDisksList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => NimbleDisksList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NimbleDisksList
