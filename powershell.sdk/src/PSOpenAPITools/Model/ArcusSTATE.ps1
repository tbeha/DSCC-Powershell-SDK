...
Arcusstate<PSCustomObject>
#>

function Initialize-Arcusstate {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => Arcusstate' | Write-Debug
...
Convert from JSON to Arcusstate<PSCustomObject>
...
Arcusstate<PSCustomObject>
#>
function ConvertFrom-JsonToArcusstate {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => Arcusstate' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Arcusstate
