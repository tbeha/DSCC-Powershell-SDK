...
FcPortSfp<PSCustomObject>
#>

function Initialize-FcPortSfp {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => FcPortSfp' | Write-Debug
...
Convert from JSON to FcPortSfp<PSCustomObject>
...
FcPortSfp<PSCustomObject>
#>
function ConvertFrom-JsonToFcPortSfp {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => FcPortSfp' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in FcPortSfp
