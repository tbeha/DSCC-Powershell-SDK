...
function ConvertFrom-JsonToNimbleHostSummaryDetails {
    ...
    Process {
        ...
        $AllProperties = ("access_protocol", "acr_id", "apply_to", "chap_user_id", "chap_user_name", "fc_initiators", "fc_target_ports", "host_type", "id", "initiator_group_id", "iscsi_initiators", "lun", "name", "num_connections", "sc_host_id", "snap_id")
