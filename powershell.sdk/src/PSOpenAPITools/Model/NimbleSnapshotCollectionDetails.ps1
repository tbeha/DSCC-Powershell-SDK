...
NimbleSnapshotCollectionDetails<PSCustomObject>
#>

function Initialize-NimbleSnapshotCollectionDetails {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => NimbleSnapshotCollectionDetails' | Write-Debug
...
Convert from JSON to NimbleSnapshotCollectionDetails<PSCustomObject>
...
NimbleSnapshotCollectionDetails<PSCustomObject>
#>
function ConvertFrom-JsonToNimbleSnapshotCollectionDetails {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
