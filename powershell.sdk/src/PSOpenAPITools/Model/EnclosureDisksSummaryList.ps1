...
EnclosureDisksSummaryList<PSCustomObject>
#>

function Initialize-EnclosureDisksSummaryList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => EnclosureDisksSummaryList' | Write-Debug
...
Convert from JSON to EnclosureDisksSummaryList<PSCustomObject>
...
EnclosureDisksSummaryList<PSCustomObject>
#>
function ConvertFrom-JsonToEnclosureDisksSummaryList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => EnclosureDisksSummaryList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in EnclosureDisksSummaryList
