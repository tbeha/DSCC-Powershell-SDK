...
ArcusPoolList<PSCustomObject>
#>

function Initialize-ArcusPoolList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ArcusPoolList' | Write-Debug
...
Convert from JSON to ArcusPoolList<PSCustomObject>
...
ArcusPoolList<PSCustomObject>
#>
function ConvertFrom-JsonToArcusPoolList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ArcusPoolList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ArcusPoolList
