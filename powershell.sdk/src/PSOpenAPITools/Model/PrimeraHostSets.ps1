...
PrimeraHostSets<PSCustomObject>
#>

function Initialize-PrimeraHostSets {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PrimeraHostSets' | Write-Debug
...
Convert from JSON to PrimeraHostSets<PSCustomObject>
...
PrimeraHostSets<PSCustomObject>
#>
function ConvertFrom-JsonToPrimeraHostSets {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PrimeraHostSets' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PrimeraHostSets
