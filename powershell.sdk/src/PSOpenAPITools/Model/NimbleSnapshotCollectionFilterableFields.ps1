...
NimbleSnapshotCollectionFilterableFields<PSCustomObject>
#>

function Initialize-NimbleSnapshotCollectionFilterableFields {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => NimbleSnapshotCollectionFilterableFields' | Write-Debug
...
Convert from JSON to NimbleSnapshotCollectionFilterableFields<PSCustomObject>
...
NimbleSnapshotCollectionFilterableFields<PSCustomObject>
#>
function ConvertFrom-JsonToNimbleSnapshotCollectionFilterableFields {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => NimbleSnapshotCollectionFilterableFields' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NimbleSnapshotCollectionFilterableFields
