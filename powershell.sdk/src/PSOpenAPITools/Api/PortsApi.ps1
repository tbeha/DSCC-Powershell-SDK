...
TaskResponse
#>
function Invoke-DeviceType1InitialisePorts {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Invoke-DeviceType1InitialisePorts' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        if (!$SystemId) {
            throw "Error! The required parameter `SystemId` missing when calling deviceType1InitialisePorts."
        }
        $LocalVarUri = $LocalVarUri.replace('{systemId}', [System.Web.HTTPUtility]::UrlEncode($SystemId))
        if (!$Id) {
            throw "Error! The required parameter `Id` missing when calling deviceType1InitialisePorts."
        }
        $LocalVarUri = $LocalVarUri.replace('{id}', [System.Web.HTTPUtility]::UrlEncode($Id))
...
TaskResponse
#>
function Invoke-DeviceType1PortEnableById {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Invoke-DeviceType1PortEnableById' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        if (!$SystemId) {
            throw "Error! The required parameter `SystemId` missing when calling deviceType1PortEnableById."
        }
        $LocalVarUri = $LocalVarUri.replace('{systemId}', [System.Web.HTTPUtility]::UrlEncode($SystemId))
        if (!$Id) {
            throw "Error! The required parameter `Id` missing when calling deviceType1PortEnableById."
        }
        $LocalVarUri = $LocalVarUri.replace('{id}', [System.Web.HTTPUtility]::UrlEncode($Id))

        if (!$PortEnableInput) {
            throw "Error! The required parameter `PortEnableInput` missing when calling deviceType1PortEnableById."
        }
...
function Invoke-PortEnable {
    ...
    Process {
        ...
        if (!$ArcusportEnableInput) {
            throw "Error! The required parameter `ArcusportEnableInput` missing when calling portEnable."
        }
